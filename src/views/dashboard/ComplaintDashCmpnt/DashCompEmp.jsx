...
import { getAssistRectifybasedOnEmp, getTotalcomplaints, getPendingOnholdbasedOnEmp } from 'src/redux/actions/ComplaintDashboard.action';
...
const DashCompEmp = ({ profileData }) => {
    ...
    const dasharrayEmp = [
        ...
        { slno: 10, name: "Onhold/Pending Complaints", count: pendingOnhold.length, status: loadingStatus }
    ]
        ...
        <Fragment>
            ...
            <Paper square elevation={2} sx={{ p: 0.5, mb: 2 }}   >
                <Box sx={{
                    ...
                    {
                        dasharrayEmp && dasharrayEmp.map((val) => {
