...
const TotalInpatientList = () => {
    ...
    const [column] = useState([
        ...
        { headerName: "Ip No", field: "ip_no", filter: "true", autoHeight: true, wrapText: true, width: 150 },
        ...
        { headerName: "Ip Date", field: "ipd_date", filter: "true", autoHeight: true, wrapText: true, width: 180 },
    ...
    return (
        ...
        <CardCloseOnly
            title='Total In_pateint List'
            close={backToSetting}
        >
            <Box sx={{ p: 1 }}>
                <CusAgGridForMain
                    columnDefs={column}
                    tableData={TotalIpPatient}
                />
            </Box>
        </CardCloseOnly>
    )
