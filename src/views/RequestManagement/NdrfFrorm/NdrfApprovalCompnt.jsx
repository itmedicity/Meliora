...
const NdrfApprovalCompnt = ({ heading, approve, reject, updateApprove, updateReject, remark,
    updateRemark, updatePending, pending }) => {
    return (
        <Fragment>
            <Box sx={{ width: "100%", }}>
                <Box sx={{ pt: 0.5 }}>
                ...
                <Box sx={{
                    ...
                    <CssVarsProvider>
                        <Typography sx={{ fontSize: 15, fontWeight: 600 }} >Remark </Typography>
                    </CssVarsProvider>
                    <CustomTextarea
                        required
                        type="text"
...
export default memo(NdrfApprovalCompnt)