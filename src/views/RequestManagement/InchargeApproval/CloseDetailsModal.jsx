        ...
        <CssVarsProvider>
            <Modal aria-labelledby="modal-title"
                ...
                <Sheet
                    variant="outlined"
                    sx={{
                        minWidth: "30%", borderRadius: 'md', p: 3, boxShadow: 'lg', minHeight: 200,
                        maxWidth: 300, maxHeight: 700,
                    }}
                >
                    <Box sx={{
                        width: '100%', flex: 1, borderRadius: 1,
                        border: '0.1px solid #454545', minHeight: 200, margin: "auto",
                        height: window.innerHeight - 500, overflowX: "auto", '::-webkit-scrollbar': { display: "none" }
                    }}>
                        <Box sx={{ pt: 0.5 }}>
                            <CssVarsProvider>
