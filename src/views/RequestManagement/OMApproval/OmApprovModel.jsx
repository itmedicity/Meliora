...
const OmApprovModel = ({ open, setOpen, datas, count, setCount }) => {
    ...
    }, [patchdataOm, count, setCount, remark, closeCrf, Closeremark, detailAnalis,
                                        ...
                                        <Box sx={{
                                            ...
                                            <Box sx={{
                                                ...
                                                <Box
                                                    sx={{ pr: 9 }}>
                                                    <CssVarsProvider>
                                                        <Typography sx={{ pl: 1, fontWeight: 900, fontSize: 14, color: TypoHeadColor }} >Department Approval</Typography>
                                                    </CssVarsProvider>
                                                </Box>
