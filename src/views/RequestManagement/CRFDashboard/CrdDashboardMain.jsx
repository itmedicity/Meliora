                    ...
                    subDaFlag === 3 ? <NonClinicalCrfDash setClinicalCrfFlag={setClinicalCrfFlag} data={NonClinicalCRFPending} /> :
                        subDaFlag === 4 ? <NonClinicalCrfDash setClinicalCrfFlag={setClinicalCrfFlag} data={NonClinicalNDRFPending} /> :
                            < Box
                                ...
                                <CssVarsProvider>
                                    <Typography ml={2} sx={{ fontSize: 20, px: 1, pb: 0.4, mt: 1, textAlign: "center" }}
                                        color="primary" variant="none"> Clinical
                                    </Typography></CssVarsProvider>
                                <Paper variant='none' sx={{
                                    mt: 1, width: "30%", ml: 70, border: 1, borderColor: taskColor.indigoDark,
                                    // alignItems: "center",
                                    // justifyItems: "center",
                                    ...
                                    <Box sx={{
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >{ClinicalCRFPending.length}</Typography>
                                            </Box>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >{ClinicalNDRFPending.length}</Typography>
                                            </Box>
                                ...
                                <CssVarsProvider>
                                    <Typography ml={2} sx={{ fontSize: 20, px: 1, pb: 0.4, mt: 1, textAlign: "center" }}
                                        color="primary" variant="none">Non Clinical
                                    </Typography></CssVarsProvider>
                                <Paper variant='none' sx={{
                                    mt: 1, width: "30%", ml: 70, border: 1, borderColor: taskColor.indigoDark,
                                    // alignItems: "center",
                                    ...
                                    <Box sx={{
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >{NonClinicalCRFPending.length}</Typography>
                                            </Box>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >{NonClinicalNDRFPending.length}</Typography>
                                            </Box>
