...
const NdrfSMODashTable = ({ subDaFlag, tabledata, count, setCount }) => {
    ...
    const [columnClinical] = useState([
        ...
        { headerName: "NDRF GM.Status", field: "ndrfCOO", autoHeight: true, wrapText: true, minWidth: 250, filter: "true" },
    ...
    return (
        <Fragment>
            {smoApproveModalFlag === 1 ? <NdrfSMODashModal
                open={smoApproveModal} setOpen={setsmoapprovModall}
                datas={smoApproveData} count={count} setCount={setCount}
            /> : null}
            {
                subDaFlag === 2 ?
                    <Box sx={{ pt: 1 }}>
