...
import NdrfSMODashModal from './NdrfSMODashModal'
import { Typography } from '@mui/joy'

const NdrfSMODashTable = ({ subDaFlag, tabledata, count, setCount }) => {
...
export default memo(NdrfSMODashTable)
