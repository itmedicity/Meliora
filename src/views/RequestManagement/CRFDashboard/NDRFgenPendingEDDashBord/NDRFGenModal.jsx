...
const NDRFGenModal = ({ open, setOpen, datas, count, setCount }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, location, dept_name, req_userdeptsec,
        ...
        ed_approve_remarks, ed_detial_analysis, md_user, ed_approve_date, ndactual_requirement, ndneeded,
        request_dept_slno, request_deptsec_slno, ed, rm_ndrf, ed_user,
    } = datas[0]
...
export default memo(NDRFGenModal)