...
import CrfDMSDashModal from './CrfDMSDashModal';
import { Box } from '@mui/material'
import { Typography } from '@mui/joy'

const CrfDMSDashTable = ({ subDaFlag, tabledata, count, setCount }) => {
    ...
    return (
        <Fragment>
            {dmsApproveModalFlag === 1 ? <CrfDMSDashModal
                open={dmsApproveModal} setOpen={setDmsapprovModall}
                datas={dmsApproveData} count={count} setCount={setCount}
            /> : null}
            {
                subDaFlag === 1 ?
                    <Box sx={{ pt: 1 }}>
                        <Typography sx={{ fontSize: 15, pl: 2, color: "#D0A2F7", fontWeight: 700 }}>
                            Table For DMS Pending :</Typography>
                        <CusAgGridForMain
...
export default memo(CrfDMSDashTable)