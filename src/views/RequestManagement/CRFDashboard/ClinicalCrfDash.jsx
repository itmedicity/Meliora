            ...
            {wherePending === 1 ?
                ...
                : wherePending === 2 ?
                    <Box>
                        ...
                        <Box>
                            <CrfDMSDashTable subDaFlag={subDaFlag} tabledata={DMSPending}
                                count={count} setCount={setCount} />
                        </Box> : wherePending === 4 ?
                            <Box>
                                <CrfMSDashTable subDaFlag={subDaFlag} tabledata={MSPending}
                                    count={count} setCount={setCount} />
                            </Box> : wherePending === 5 ?
                                <Box>
