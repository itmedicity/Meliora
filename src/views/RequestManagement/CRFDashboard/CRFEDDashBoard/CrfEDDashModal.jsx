...
const CrfEDDashModal = ({ open, setOpen, datas, count, setCount }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, location, dept_name, req_userdeptsec,
        ...
        md_approve, md, md_approve_remarks, md_detial_analysis, md_approve_date, ed_approve,
        ed_approve_remarks, ed_detial_analysis, md_user
    } = datas[0]
    ...
    useEffect(() => {
        if (ed_approve !== null) {
            ...
            setDetailAnalis(ed_approve === 1 ? ed_detial_analysis : null)
        }
        else {
            setRemark('')
            setPending(false)
    ...
    }, [ed_approve, req_slno, ed_approve_remarks, ed_detial_analysis])
    ...
    const patchdataED = useMemo(() => {
        return {
            ...
            ed_approve_remarks: reject === true || pending === true || approve === true ? remark : null,
    ...
    const submit = useCallback((e) => {
        ...
        const updateEDApproval = async (patchdataED) => {
    ...
    }, [patchdataED, setCount, count, remark, detailAnalis,
...
export default memo(CrfEDDashModal)