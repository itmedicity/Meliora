...
const CrfInchargeDshModal = ({ open, setOpen, datas, count, setCount }) => {
    ...
    }, [incharge_approve, inch_detial_analysis, incharge_remark])
    ...
    const submit = useCallback((e) => {
        ...
        req_approv_slno, count, setCount, setOpen, id])
...
export default memo(CrfInchargeDshModal)