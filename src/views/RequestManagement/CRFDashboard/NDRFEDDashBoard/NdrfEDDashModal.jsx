...
const NdrfEDDashModal = ({ open, setOpen, datas, count, setCount }) => {
  const {
    req_slno,
    reqcreate,
    ndrf_mast_slno,
              ...
              <Paper variant="outlined" sx={{ mt: 1 }}>
                ...
                >
                  {ndrf_cao_approve !== null ? (
                    <Box>
                      ...
                      {ndrf_cao_approve === 1 ? (
                        <Box sx={{ width: '100%', pl: 1 }}>
                          <CssVarsProvider>
                            <Typography sx={{ fontSize: 15, fontWeight: 600 }}>
                              Detail Justification/ Requirement Approval:{' '}
                            </Typography>
                            <Typography ml={10} sx={{ fontSize: 15 }}>
                              {ndrf_cao_approve_remarks}{' '}
                            </Typography>
                    ...
                    <CssVarsProvider>
                      <Typography sx={{ fontSize: 15, fontWeight: 600, pl: 1 }}>
                        NDRF COO/CAO Approval not done
                      </Typography>
                    </CssVarsProvider>
                  )}
                </Box>
...
export default memo(NdrfEDDashModal)
