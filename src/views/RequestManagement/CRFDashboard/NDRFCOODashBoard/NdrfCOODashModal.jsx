...
const NdrfCOODashModal = ({ open, setOpen, datas, count, setCount }) => {
  const {
    req_slno,
    reqcreate,
    ndrf_mast_slno,
  ...
  const submit = useCallback(
    ...
    [patchdataCAO, setCount, count, ModalClose, approve, reject, pending, remark]
  )
...
export default memo(NdrfCOODashModal)
