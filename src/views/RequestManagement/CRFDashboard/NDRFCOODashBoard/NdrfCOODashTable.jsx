...
import NdrfCOODashModal from './NdrfCOODashModal'
import { Typography } from '@mui/joy'

const NdrfCOODashTable = ({ subDaFlag, tabledata, count, setCount }) => {
      ...
      {subDaFlag === 2 ? (
        <Box sx={{ pt: 1 }}>
          <Typography sx={{ fontSize: 15, pl: 2, color: '#D0A2F7', fontWeight: 700 }}>
            Table For GM Pending :
          </Typography>
          <CusAgGridForMain columnDefs={columnClinical} tableData={cooData} />
        </Box>
      ) : subDaFlag === 4 ? (
        <Box sx={{ pt: 1 }}>
          <Typography sx={{ fontSize: 15, pl: 2, color: '#D0A2F7', fontWeight: 700 }}>
          ...
          <CusAgGridForMain columnDefs={columnNonClinical} tableData={cooData} />{' '}
        </Box>
      ) : null}
    </Fragment>
  )
...
export default memo(NdrfCOODashTable)
