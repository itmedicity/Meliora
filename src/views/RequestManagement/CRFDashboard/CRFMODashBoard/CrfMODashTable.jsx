...
import CrfMODashModal from './CrfMODashModal';
import { Box } from '@mui/material'
import { Typography } from '@mui/joy'

const CrfMODashTable = ({ subDaFlag, tabledata, count, setCount }) => {
    ...
    return (
        <Fragment>
            {omApproveModalFlag === 1 ? <CrfMODashModal
                open={omApproveModal} setOpen={setomapprovModall}
                datas={omApproveData} count={count} setCount={setCount}
            /> : null}
            {
                subDaFlag === 1 ?
                    <Box sx={{ pt: 1 }}>
...
export default memo(CrfMODashTable)