                  ...
                  {ndrf_om_approv !== null ? (
                    ...
                    <CssVarsProvider>
                      <Typography sx={{ fontSize: 15, fontWeight: 600, pl: 1 }}>
                        Operation Manager Approval not done
                      </Typography>
                    </CssVarsProvider>
                  )}
                </Box>
              ...
              <Paper variant="outlined" sx={{ mt: 1 }}>
                ...
                >
                  {ndrf_smo_approv !== null ? (
                    ...
                    <CssVarsProvider>
                      <Typography sx={{ fontSize: 15, fontWeight: 600, pl: 1 }}>
                        Senior Operation Manager Approval not done
                      </Typography>
                    </CssVarsProvider>
                  )}
                </Box>
            ...
            {ndrf_po_close === 1 ? (
              <Box sx={{ width: '100%', mt: 0 }}>
                <Paper variant="outlined" sx={{ mt: 1 }}>
                  ...
                  {podetailFlag === 1 ? (
                    <Box sx={{ width: '50%', pl: 5, pb: 2 }}>
                      {' '}
                      Addded PO
                      <ReqRegistItemCmpt columnDefs={column} tableData={getpoDetaildata} />
                    </Box>
                  ) : null}
                </Paper>
              </Box>
                  ...
                  >
                    ...
                    >
                      ...
                      {poDetlDis === 1 ? (
                        <Box sx={{ width: '50%', pl: 5, pb: 2 }}>
                          Multiple added PO
                          <ReqRegistItemCmpt columnDefs={column} tableData={podetailData} />
                        </Box>
                      ) : null}
