...
const MDNdrfModal = ({ open, setOpen, datas, count, setCount }) => {
    const { req_slno, reqdate, actual_requirement, needed, location, expdate, req_deptsec, req_dept,
        ...
        cao_approv_date, cao_approve_remarks, ndrfuser, ndrf_cao_approve, ndrf_cao,
        cao_approve, incharge_approve, manag_operation_approv, ed_approve, ed_detial_analysis,
        inch_detial_analysis, hod_detial_analysis, incharge_req, hod_approve, ndrf_smo,
        ndrf_ed_approve, ndrf_ed_approve_remarks,
    ...
    const ndrfsmodate = ndrf_som_aprrov_date !== null ? format(new Date(ndrf_som_aprrov_date), 'dd-MM-yyyy hh:mm:ss') : null
    const ndrfcaodate = ndrf_cao_approv_date !== null ? format(new Date(ndrf_cao_approv_date), 'dd-MM-yyyy hh:mm:ss') : null//redux for geting login id
    ...
    useEffect(() => {
        if (ndrf_ed_approve !== null) {
            setRemark(ndrf_ed_approve_remarks)
            setApprove(ndrf_ed_approve === 1 ? true : false)
            setReject(ndrf_ed_approve === 2 ? true : false)
            setPending(ndrf_ed_approve === 3 ? true : false)
                                        ...
                                        <Box
                                            ...
                                            </CssVarsProvider>
                                            {
                                                ndrfsmodate !== null ? <Box
                                                    ...
                                                    <CssVarsProvider>
                                                        <Typography ml={2} mb={0.5} variant="outlined" color="primary" sx={{ fontSize: 13, px: 1, pb: 0.4, borderRadius: 5, }}>{ndrfsmodate !== null ? ndrfsmodate : "Not Update"}</Typography>
                                                        <Typography ml={2} sx={{ fontSize: 15 }} >/ </Typography>
                                                        <Typography ml={2} mb={0.5} variant="outlined" color="primary" sx={{ fontSize: 13, px: 1, pb: 0.4, borderRadius: 5, textTransform: "capitalize" }}>{ndrf_smo !== null ? ndrf_smo.toLowerCase() : null} </Typography>
                                                    </CssVarsProvider>   </Box> : null
                                            }

                                        </Box>
                                        {
                                            ndrf_smo_approv === 1 ? <Box sx={{ width: "100%" }}>
                                                <CssVarsProvider>
                                                    <Typography sx={{ fontSize: 15, fontWeight: 600 }} >Approval Remark: </Typography>
                                                ...
                                                ndrf_smo_approv === 2 ? <Box sx={{ width: "100%" }}>
                                                    <CssVarsProvider>
                                                        <Typography sx={{ fontSize: 15 }} > Reject Remark: </Typography>
                                                        <Typography ml={10} sx={{ fontSize: 15, fontWeight: 600 }} >{ndrf_smo_remarks} </Typography>
                                                    </CssVarsProvider>
                                                </Box> :
                                        ...
                                        <Box
                                            ...
                                            </CssVarsProvider>
                                            {
                                                ndrfcaodate !== null ? <Box
                                                    ...
                                                    <CssVarsProvider>
                                                        <Typography ml={2} mb={0.5} variant="outlined" color="primary" sx={{ fontSize: 13, px: 1, pb: 0.4, borderRadius: 5, }}>{ndrfcaodate !== null ? ndrfcaodate : "Not Update"}</Typography>
                                                        <Typography ml={2} sx={{ fontSize: 15 }} >/ </Typography>
                                                        <Typography ml={2} mb={0.5} variant="outlined" color="primary" sx={{ fontSize: 13, px: 1, pb: 0.4, borderRadius: 5, textTransform: "capitalize" }}>{ndrf_cao !== null ? ndrf_cao.toLowerCase() : null} </Typography>
                                                    </CssVarsProvider>   </Box> : null
                                            }

                                        </Box>
                                        {
                                            ndrf_cao_approve === 1 ? <Box sx={{ width: "100%" }}>
                                                <CssVarsProvider>
                                                    <Typography sx={{ fontSize: 15, fontWeight: 600 }} >Approval Remark: </Typography>
                                                ...
                                                ndrf_cao_approve === 2 ? <Box sx={{ width: "100%" }}>
                                                    <CssVarsProvider>
                                                        <Typography sx={{ fontSize: 15 }} > Reject Remark: </Typography>
                                                        <Typography ml={10} sx={{ fontSize: 15, fontWeight: 600 }} >{ndrf_cao_approve_remarks} </Typography>
                                                    </CssVarsProvider>
                                                </Box> :
