...
const SMOApprovalModel = ({ open, setOpen, datas, count, setCount }) => {
    ...
    useEffect(() => {
        if (senior_manage_approv !== null) {
            ...
            setDetailAnalis(senior_manage_approv === 1 ? smo_detial_analysis : '')
        }
        else {
            setRemark('')
            setPending(false)
        ...
        if (closeCrf === true) {
            if (Closeremark !== "") {
                const crfClosePatch = {
                    ...
                    crf_close_user: id,
                    crf_closed_one: "Senior Manager Operation",
    ...
    }, [patchdataSMO, count, setCount, remark, detailAnalis, closeCrf, Closeremark,
