...
// import NdrfHigherAppDone from '../OMApproval/NdrfHigherAppDone'
...
const SmoApproval = () => {
  ...
  useEffect(() => {
    ...
    //             mdrfSMO: val.ndrf_smo_approv === 1 ? "Approved" : val.ndrf_smo_approv === 2 ? "Reject" :
    ...
    //             mdrfCOO: val.ndrf_cao_approve === 1 ? "Approved" : val.ndrf_cao_approve === 2 ? "Reject" :
    ...
    //             mdrfED: val.ndrf_ed_approve === 1 ? "Approved" : val.ndrf_ed_approve === 2 ? "Reject" :
    ...
    //             mdrfMD: val.ndrf_md_approve === 1 ? "Approved" : val.ndrf_md_approve === 2 ? "Reject" :
  ...
  const [column] = useState([
    {
      ...
      cellRenderer: params => {
        ...
        } else if (params.data.cao_approve !== null) {
          return (
            <IconButton onClick={() => HigherDone(params)} sx={{ color: editicon, paddingY: 0.5 }}>
              <CustomeToolTip title="COO Approval done so you cant edit">
                <DescriptionIcon />
              </CustomeToolTip>
            </IconButton>
          )
  ...
  //         cellRenderer: params => {
  //             if ((params.data.ndrf_cao_approve !== null)
  ...
  // const [smoNdrfModal, setSmoNdrfModal] = useState(false)
  // const [smoNdrfModalFlag, setSmoNdrfModalFlag] = useState(0)
  // const [smoNdrfModalData, setSmoNdrfModalData] = useState([])

  // const [smoNdrfAppModal, setSmoNdrfAppModal] = useState(false)
  // const [smoNdrfAppModalFlag, setSmoNdrfAppModalFlag] = useState(0)
  // const [smoNdrfAppModalData, setSmoNdrfAppModalData] = useState([])
  ...
  //     const data = params.api.getSelectedRows()
  //     setSmoNdrfModal(true)
  //     setSmoNdrfModalFlag(1)
  //     setSmoNdrfModalData(data)
  // }, [])
  ...
  //     const data = params.api.getSelectedRows()
  //     setSmoNdrfAppModal(true)
  //     setSmoNdrfAppModalFlag(1);
  //     setSmoNdrfAppModalData(data)
  // }, [])
  ...
  return (
    <CardCloseOnly title="Senior Manager Operation Verification" close={backtoSetting}>
      {CloseModalFlag === 1 ? (
        <CloseDetailsModal
          open={CloseModal}
      ...
      {/* {
                smoNdrfModalFlag === 1 ? <NdrfModel
                    open={smoNdrfModal}
                    setOpen={setSmoNdrfModal}
                    datas={smoNdrfModalData}
                    count={count}
                    setCount={setCount}
      ...
      {/* {
                smoNdrfAppModalFlag === 1 ?
                    <NdrfModelsmo
                        open={smoNdrfAppModal}
                        setOpen={setSmoNdrfAppModal}
                        datas={smoNdrfAppModalData}
                        count={count}
                        setCount={setCount}
      ...
      <Box sx={{ p: 1 }}>
        <CusAgGridForMain columnDefs={column} tableData={smoData} getRowStyle={getRowStyle} />
      </Box>
