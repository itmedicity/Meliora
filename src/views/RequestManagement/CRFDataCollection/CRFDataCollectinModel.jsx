                  ...
                  >
                    {tableOrginal === 1 ? (
                      ...
                      >
                        ...
                        <CRFDataItemOrginal dataPost={orginal} />
                        <Box sx={{ pr: 9 }}>
                          <CssVarsProvider>
                            <Typography sx={{ fontSize: 15 }}>Data Enter For Collection</Typography>
                          </CssVarsProvider>
                        </Box>
                        <CRFDataItemEditCmnt reqslno={req_slno} />
                      </Box>
                    ) : null}
                  </Box>
                </Box>
                              ...
                              >
                                <CssVarsProvider>
                                  <Typography
                                    ...
                                    sx={{ fontSize: 13, px: 1, pb: 0.4, borderRadius: 5 }}
                                  >
                                    {inchadate !== null ? inchadate : 'Not Update'}
                                  </Typography>
                                  ...
                                  >
                                    {' '}
                                    {inch_user !== null ? inch_user.toLowerCase() : null}{' '}
                                  </Typography>
                                </CssVarsProvider>{' '}
                              </Box>
                            ) : null}
                            ...
                            >
                              <CssVarsProvider>
                                <Typography
                                  ...
                                  sx={{ fontSize: 13, px: 1, pb: 0.4, borderRadius: 5 }}
                                >
                                  {hoddate !== null ? hoddate : 'Not Update'}
                                </Typography>
                                <Typography ml={2} sx={{ fontSize: 15 }}>
                                  /{' '}
                                </Typography>
                                ...
                                >
                                  {' '}
                                  {hod_user !== null ? hod_user.toLowerCase() : null}{' '}
                                </Typography>
                              </CssVarsProvider>{' '}
                            </Box>
                          ) : null}
