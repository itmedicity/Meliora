...
export const ndrfpdfdownloadwithouttable = (
  data,
  inchargesign,
  hodsign,
  omsign,
        ...
        table: {
          ...
          body: [
            ...
            [
              {
                text: [
                  { text: 'Approximate Amount ', bold: true, fontSize: 8, font: 'Roboto' },
                  {
            ...
            [
              {
                colSpan: 4,
                text: [
                  { text: ' NDRF MD Status: ', bold: true, fontSize: 8, font: 'Roboto' },
                  {
            ...
            [
              {
                colSpan: 4,
                text: [
                  { text: ' NDRF ED Status: ', bold: true, fontSize: 8, font: 'Roboto' },
                  {
