...
const EDApprovalModel = ({ open, setOpen, datas, count, setCount }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, location, expected_date,
        ...
        approve_hod, manag_operation_approv,
        manag_operation_remarks, senior_manage_approv, senior_manage_remarks, cao_approve, cao_approve_remarks } = datas[0]
                                ...
                                <Box sx={{ p: 2 }}>
                                    <Grid item xl={12} lg={12} md={12} sm={12}>
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xl={6} lg={6} >
                                                <Typography>{manag_operation_approv}</Typography>
                                            </Grid>
                                            <Grid item xl={6} lg={6} >
                                            ...
                                            <Grid item xl={6} lg={6} >
                                                <Typography>{senior_manage_approv}</Typography>
                                            </Grid>
                                            <Grid item xl={6} lg={6} >
                                            ...
                                            <Grid item xl={6} lg={6} >
                                                <Typography>CEO/COO/MS Status:</Typography>
                                            </Grid>
                                            <Grid item xl={6} lg={6} >
                                                <Typography>{cao_approve}</Typography>
                                            </Grid>
                                            <Grid item xl={6} lg={6} >
                                                <Typography>CEO/COO/MS Remark:</Typography>
                                            </Grid>
                                            <Grid item xl={6} lg={6} >
                                                <Typography>{cao_approve_remarks}</Typography>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                </Box>
