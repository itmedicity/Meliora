...
const EDNdrfAppModel = ({ open, setOpen, datas, count, setCount }) => {
    const { req_slno, reqdate, actual_requirement, needed, location, expdate, req_deptsec, req_dept,
        approve_incharge, incharge_remarks, hod_remarks, ndrf_date, ndrf_mast_slno,
        approve_hod, manag_operation_approvs, manag_operation_remarks, senior_manage_approvs,
        senior_manage_remarks, category, incharge_apprv_date, om_approv_date, cao_user,
        hod_approve_date, som_aprrov_date, inch_user, hod_user, om_user, smo_user, cao_approves,
        cao_approv_date, cao_approve_remarks } = datas[0]
    ...
    }, [approve, reject, pending, remark, ndrf_mast_slno])
            ...
            >
                ...
                >
                    < DialogContentText id="alert-dialog-slide-descriptiona">
                        NNew Demad Request Form Approval
                    </DialogContentText>
