...
const NdrfModelCao = ({ open, setOpen, datas, count, setCount }) => {
    const { req_slno, reqdate, actual_requirement, needed, location, expdate, req_deptsec, req_dept,
        ...
        ndrf_smo_approv, ndrf_smo_remarks, ndrf_som_aprrov_date, cao_approv_date, cao_approve_remarks, ndrfuser,
    ...
    }, [patchdataCAO, setCount, count, setOpen])
    // reset 
                        ...
                        <Paper variant='outlined' sx={{ mt: 1 }} >
                            <Box sx={{
                                ...
                                <Box
                                    ...
                                    <NdrfApprovalCompnt
                                        heading="NDRF Approval CAO/COO/MS"
                                        approve={approve}
                                        reject={reject}
                                        pending={pending}
                                        remark={remark}
