...
const CAOApprovalModel = ({ open, setOpen, datas, count, setCount }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, location, dept_name, req_userdeptsec,
        ...
        cao_approve, cao_approve_remarks, ceo_detial_analysis, ed_approve_req, md_approve_req,
    } = datas[0]
    ...
    useEffect(() => {
        if (cao_approve !== null) {
            ...
            setDetailAnalis(cao_approve === 1 ? ceo_detial_analysis : '')
            setedapprov(ed_approve_req === 1 ? true : md_approve_req === 1 ? true : false)
        }
        else {
            setRemark('')
            setPending(false)
    ...
    const submit = useCallback((e) => {
        ...
        const updateCOOApproval = async (patchdataCOO) => {
            const result = await axioslogin.patch('/requestRegister/approval/ceo', patchdataCOO);
    ...
    }, [patchdataCOO, count, setCount, remark, detailAnalis, closeCrf, Closeremark,
...
export default memo(CAOApprovalModel)