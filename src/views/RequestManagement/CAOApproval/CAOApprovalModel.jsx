...
const CEOApprovalModel = ({ open, setOpen, datas, count, setCount }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, location, expected_date, approve_incharge,
        ...
        som_aprrov_date, inch_user, hod_user, om_user, smo_user, incharge_approve, manag_operation_approv,
    ...
    useEffect(() => {
        if (cao_approve !== null) {
            ...
            setRejectRemark(cao_approve === 2 ? cao_approve_remarks : null)
            setHoldRemark(cao_approve === 3 ? cao_approve_remarks : null)
            setDetailAnalis(cao_approve === 1 ? ceo_detial_analysis : null)
        }
        else {
            setRemark('')
            setPending(false)
    ...
    }, [cao_approve, req_slno, cao_approve_remarks, ed_approve_req, ceo_detial_analysis])
    ...
    const patchdataCEO = useMemo(() => {
        return {
            ...
            cao_approve_remarks: approve === true ? remark : reject === true ? rejectremark : pending === true ? holdremark : null,
    ...
    }, [approve, remark, reject, pending, req_slno, rejectremark, holdremark, req_approv_slno, detailAnalis, edapprov, id])
