...
const ReqRegisterTable = ({ count, rowSelect, isIncharge }) => {
  ...
  const [columnIncharge] = useState([
    ...
    { headerName: 'GM.Remark', field: 'cao_approve_remarks', minWidth: 150, wrapText: true },
  ...
  return (
    <Fragment>
      <Box sx={{ pt: 1 }}>
        {isIncharge === 1 ? (
          <CusAgGridMast columnDefs={columnIncharge} tableData={disData} />
        ) : (
          <CusAgGridMast columnDefs={column} tableData={disData} />
        )}
      </Box>
    </Fragment>
  )
