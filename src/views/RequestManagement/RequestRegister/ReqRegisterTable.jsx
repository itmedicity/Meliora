...
const ReqRegisterTable = ({ count, rowSelect, isIncharge }) => {
    ...
    const [columnIncharge] = useState([
        ...
        { headerName: "NDRF GM Status", field: "ndrf_coo", minWidth: 180, wrapText: true, filter: "true" },
        { headerName: "NDRF GM.Remark", field: "ndrf_coo_remarks", autoHeight: true, minWidth: 250, wrapText: true, },
        { headerName: "NDRF MD  Status", field: "ndrf_md", autoHeight: true, minWidth: 150, wrapText: true, filter: "true" },
        { headerName: "NDRF MD.Remark", field: "ndrf_md_remarks", autoHeight: true, minWidth: 250, wrapText: true, },
        { headerName: "NDRF ED  Status", field: "ndrf_ed", minWidth: 150, wrapText: true, filter: "true" },
        { headerName: "NDRF ED.Remark", field: "ndrf_ed_approve_remarks", autoHeight: true, minWidth: 250, wrapText: true, },
    ])
