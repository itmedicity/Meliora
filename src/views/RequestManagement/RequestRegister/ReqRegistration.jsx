          ...
          <Box sx={{ width: '100%' }}>
            ...
            >
              ...
              >
                    ...
                    selectFile.map((val, index) => {
                      return (
                        ...
                        >
                          ...
                          <Box sx={{ ml: 0.3 }}>
                            <CloseIcon
                              sx={{ height: '18px', width: '20px', cursor: 'pointer' }}
                ...
                {imgFlag === 1 ? (
                  <Box sx={{ display: 'flex', width: '10%', height: 55, pt: 3 }}>
                    <Button onClick={ViewImage} variant="contained" size="small" color="primary">
                      View Image
                    </Button>
                  </Box>
                ) : null}
