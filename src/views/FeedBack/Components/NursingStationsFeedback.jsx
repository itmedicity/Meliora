...
const NursingStationsFeedback = () => {
    ...
    return (
        <Fragment>
            {listFlag === 1 ? <PatientDetailsView nsName={nsName} setListFlag={setListFlag} /> :
                <>
                            ...
                            <Grid container spacing={2}>
                                {nurstation.map((val, index) => (
                                    <Grid key={index} xs={12} sm={4} md={3} lg={2}>
                                        <Paper sx={{
                                            padding: 2, bgcolor: '#E3F2FD', display: 'flex', alignItems: 'center', height: 100,
                                            cursor: 'pointer', ':hover': { bgcolor: '#E3EFF9' }
                                        }}
