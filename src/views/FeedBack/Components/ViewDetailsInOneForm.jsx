...
const ViewDetailsInOneForm = ({ ptDetails, nsName }) => {
    ...
    const departments = [{ id: 1, dpt: 'BIOMEDICAL' },
    ...
    const [complaintView, setComplaintView] = useState({
        selectedDepartment: '', typeNo: '', description: '', checkHic: false, priority: false
    })
    ...
    useEffect(() => {
        ...
        const namedata = {
            bystandNameIn: 'Anu', bystandNameOut: '', staffNameIn: 'Ajmi', staffNameOut: '', bystandSignIn: '',
            bystandSignOut: '', staffSignIn: '', staffSignOut: ''
        }
                                ...
                                <CssVarsProvider>
                                    <Table aria-label="table with sticky header" borderAxis="both" padding="none" stickyHeader size="sm">
                                        <thead style={{ alignItems: 'center' }}>
                                            <tr style={{ height: 0.5 }}>
                                                <th size="sm" style={{ width: 100, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}> PATIENT NAME </th>
                                                <th size="sm" style={{ width: 150, fontSize: 14, }}>&nbsp;&nbsp;{capitalizeWords(ptname)}</th>
                                                <th size="sm" style={{ width: 100, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>MRD NO.</th>
                                                <th size="sm" style={{ width: 150, fontSize: 14 }}>&nbsp;&nbsp; {ptid}</th>
                                            </tr>
                                            <tr style={{ height: 0.5 }}>
                                                <th size="sm" style={{ width: 100, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>ROOM NO. </th>
                                                <th size="sm" style={{ width: 50, fontSize: 14, }}>&nbsp;&nbsp;{bed}</th>
                                                <th size="sm" style={{ width: 50, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>DOCTOR NAME</th>
                                                <th size="sm" style={{ width: 100, fontSize: 14 }}>&nbsp;&nbsp;{"Dr. " + capitalizeWords(doctor)}</th>
                                            </tr>
                                        </thead>
                                    </Table>
                                </CssVarsProvider>
                            ...
                            <Box variant="outlined" sx={{ overflow: 'auto', '&::-webkit-scrollbar': { height: 8 }, my: 0.5 }}>
                                <CssVarsProvider>
                                    <Table aria-label="table with sticky header" borderAxis="both" padding="none" stickyHeader size="sm">
                                        <thead style={{ alignItems: 'center' }}>
                                            <tr style={{ height: 0.5 }}>
                                                <th size="sm" style={{ width: 100, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>NAME </th>
                                                <th size="sm" style={{ width: 50, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>IN</th>
                                                <th size="sm" style={{ width: 50, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>OUT</th>
                                                <th size="sm" style={{ width: 100, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>SIGNATURE </th>
                                                <th size="sm" style={{ width: 50, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>IN</th>
                                                <th size="sm" style={{ width: 50, fontSize: 14, textAlign: 'center', backgroundColor: '#eceff1' }}>OUT</th>
                                            </tr>
                                            <tr style={{ height: 0.5 }}>
                            ...
                            <Paper variant='outlined' square sx={{ display: 'flex', flexWrap: 'wrap', pb: 1 }} >
                                    ...
                                    <Grid item xs={2} sm={4} md={4} lg={2} xl={3} >
                                        <Box sx={{ py: 0.5, }}>
                                            <Typography sx={{ opacity: 0.6, fontWeight: 550, fontFamily: 'system-ui', }}>
                                                LOCATION OF INCIDENT</Typography>
                                        </Box>
                                ...
                                <Box sx={{ flex: 1, pl: 1, '@media screen and (max-width: 768px)': { pr: 1 } }}>
                                    <Grid item xs={2} sm={4} md={4} lg={2} xl={3} >
                                        <Box sx={{ py: 0.5, }}>
                                            <Typography sx={{ opacity: 0.6, fontWeight: 550, fontFamily: 'system-ui', }}>
                                                DATE & TIME OF INCIDENT</Typography>
                                        </Box>
                                        <Input
                                            disabled
