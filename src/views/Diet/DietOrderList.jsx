    ...
    useEffect(() => {
        const getSearch = async () => {
            if (search1 !== 0) {
                ...
                const typeslno = dietcrct && dietcrct.map((val) => {
                    return val.type_slno
                })
                const dmenuslno = dietcrct && dietcrct.map((val) => {
        ...
        <Fragment>
            <Box sx={{ width: "100%", pl: 1, pt: 1, pr: 1, pb: 1 }}>
                <Paper square elevation={3}
                    sx={{ pl: 1, pt: 1, pr: 1, pb: 1 }}
                > <Box sx={{
                    width: "100%", backgroundColor: "#f0f3f5", p: 0.2
                }}>Diet Order</Box>
                    <Box sx={{
                        width: "100%",
            ...
            {
                search === 1 ? <DietOrderSearch dietdetail={dietdetail} dietcrct={dietcrct} slno={slno} setDietdetail={setDietdetail} /> : null
            }
        </Fragment>
