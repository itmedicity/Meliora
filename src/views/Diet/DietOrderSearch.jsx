                    ...
                    <Box sx={{
                        ...
                        <TableContainer sx={{ maxHeight: 400 }}>
                            <Table sx={{ minWidth: 100 }} size="small"
                                ...
                                <TableBody>
                                    {
                                        dietcrct && dietcrct.map((val, index) => {
                                            return <TableRow key={val.type_slno
                                            }>
                                                <TableCell sx={{ borderbottom: "1px solid #ddd" }}>{val.type_desc}</TableCell>
                                                {
                                                    slno && slno.map((value, index) => {
                                                        return <TableRow key={value.type_slno}>
                                                            <TableCell sx={{ width: 250, borderbottom: "1px solid #ddd" }}>{value.item_name}</TableCell>
