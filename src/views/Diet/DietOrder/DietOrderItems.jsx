...
import React, { useState, memo, Fragment, useMemo, useEffect } from 'react'
import { axioslogin } from 'src/views/Axios/Axios'
import { infoNotify } from 'src/views/Common/CommonCode'
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ textAlign: 'center' }}>Choose</th>
            </tr>
          </thead>

          <tbody>
            {items?.map(val => (
              <tr key={val.ddetl_slno}>
                <td style={{ textAlign: 'center' }}>{val.group_name}</td>
                <td style={{ textAlign: 'center' }}>{val.item_name}</td>
                <td style={{ textAlign: 'center' }}>
                  <Checkbox
                    variant="outlined"
                    checked={check === val.ddetl_slno}
                    onChange={e =>
                      setCheck(e.target.checked ? val.ddetl_slno : null)
                    }
                  />
                </td>
              </tr>
