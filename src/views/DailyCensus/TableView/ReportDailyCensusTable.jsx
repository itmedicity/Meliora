...
const ReportDailyCensusTable = ({ tableData, calculateTotal }) => {
    ...
    const { totYesterday, totAdmission, totDischarge, totTransIn, totTransOut, totDeath, totalcensus,
        oraYesttotal, oraTotAdm, oraTotDis, oraTotDeath, oraTotal, oraDamaTot, oraLamaTot } = calculateTotal
    return (
        <Fragment>
                    ...
                    <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' stickyFooter hoverRow >
                        <thead style={{ alignItems: 'center' }}>
                            <tr style={{ height: 0.5 }}>
                                ...
                                <th size='sm' style={{ width: 120, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>HIS Yesterday</th>
