...
const ReportDailyCensusTable = ({ tableData, calculateTotal }) => {
    ...
    const { totYesterday, totAdmission, totDischarge, totTransIn, totTransOut, totDeath, totalcensus,
        oraYesttotal, oraTotAdm, oraTotDis, oraTotDeath, oraTotal, } = calculateTotal
    return (
        <Fragment>
                    ...
                    <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' stickyFooter hoverRow >
                        <thead>
                            <tr style={{ height: 0.5 }}>
                                ...
                                <th size='sm' style={{ width: 150, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>Nursing Station</th>
                                <th size='sm' style={{ width: 100, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>Yesterday Census</th>
                                <th size='sm' style={{ width: 90, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>Admissions</th>
                                ...
                                <th size='sm' style={{ width: 80, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>Transfer In</th>
                                <th size='sm' style={{ width: 80, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>Transfer Out</th>
                                <th size='sm' style={{ width: 55, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>Death</th>
                                <th size='sm' style={{ width: 50, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>Total</th>
                                <th size='sm' style={{ width: 120, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>HIS Yesterday Census</th>
                                <th size='sm' style={{ width: 100, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>HIS Admissions</th>
                                <th size='sm' style={{ width: 100, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>HIS Discharge</th>
                                <th size='sm' style={{ width: 80, borderRight: '1px solid white', textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>HIS Death</th>
                                <th size='sm' style={{ width: 70, textAlign: 'center', color: 'white', backgroundColor: '#757575', fontSize: 15 }}>HIS Total</th>
                            </tr>
                        </thead>
                            ...
                            {tableData?.map((val, index) => {
                                return (
                                    < tr key={index} size='small'
                                        ...
                                        <td size='sm' style={{ textAlign: 'center', fontSize: 14, height: 15 }}>{val.ora_yesterday}</td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td style={{ textAlign: 'center', fontSize: 15, color: '#424242', backgroundColor: '#e0e0e0', fontWeight: 'bold' }}>{oraYesttotal}</td>
