...
import { getRequestToRectfyList } from 'src/redux/actions/RequestToRectifyList.action';

const RequestToRectifctn = () => {
    ...
    const getDataList = useSelector((state) => {
        return state.getRequestToRectfyList.RequestToRectfyList
    })
    ...
    const [columnDefs] = useState([
        ...
        { headerName: "Request Receiving Time ", field: "reqstTime", autoHeight: true, wrapText: true, minWidth: 150, filter: "true" },
    ...
    return (
        <CardCloseOnly
            title='Request To Rectify TAT Report'
            close={backToSetting}
        >
            <Box
                sx={{
...
export default memo(RequestToRectifctn)