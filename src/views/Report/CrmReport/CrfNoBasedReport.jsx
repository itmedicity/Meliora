                ...
                if (success === 1) {
                    ...
                    const crfDetails = data
                        ...
                        .map((val) => ({
                            ...
                            expected_date: val.expected_date !== null ? format(new Date(val.expected_date), 'dd-MM-yyyy') : 'Not Updated',
                            ...
                            incharge_apprv_date: val.incharge_apprv_date !== null ? format(new Date(val.incharge_apprv_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            hod_approve_date: val.hod_approve_date !== null ? format(new Date(val.hod_approve_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            dms_approve_date: val.dms_approve_date !== null ? format(new Date(val.dms_approve_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            ms_approve_date: val.ms_approve_date !== null ? format(new Date(val.ms_approve_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            om_approv_date: val.om_approv_date !== null ? format(new Date(val.om_approv_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            som_aprrov_date: val.som_aprrov_date !== null ? format(new Date(val.som_aprrov_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            gm_approv_date: val.gm_approv_date !== null ? format(new Date(val.gm_approv_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            md_approve_date: val.md_approve_date !== null ? format(new Date(val.md_approve_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            ed_approve_date: val.ed_approve_date !== null ? format(new Date(val.ed_approve_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            managing_director_approve_date: val.managing_director_approve_date !== null ? format(new Date(val.managing_director_approve_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            quatation_calling_date: val.quatation_calling_date !== null ? format(new Date(val.quatation_calling_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            quatation_negotiation_date: val.quatation_negotiation_date !== null ? format(new Date(val.quatation_negotiation_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            quatation_fixing_date: val.quatation_fixing_date !== null ? format(new Date(val.quatation_fixing_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            quatation_fixuser: val.quatation_fixuser,
                            po_prepartion: val.po_prepartion,
                            po_complete: val.po_complete,
                            po_complete_date: val.po_complete_date !== null ? format(new Date(val.po_complete_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            pocomplete_user: val.pocomplete_user,
                            po_to_supplier: val.po_to_supplier,
                            po_to_supplier_date: val.po_to_supplier_date !== null ? format(new Date(val.po_to_supplier_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            ...
                            user_ack_date: val.user_ack_date !== null ? format(new Date(val.user_ack_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            user_acknldge_remarks: val.user_acknldge_remarks === null ? 'nil' : val.user_acknldge_remarks,
                            store_receive_date: val.store_receive_date !== null ? format(new Date(val.store_receive_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                            store_receive: val.store_receive,
                            crs_user: val.crs_user,
                            store_user: val.store_user,
                            substore_ack_date: val.substore_ack_date !== null ? format(new Date(val.substore_ack_date), 'dd-MM-yyyy hh:mm a') : 'Not Updated',
                        })).sort((a, b) => {
    ...
    return (
        <Fragment>
            ...
            <Box sx={{ height: window.innerHeight - 80, flexWrap: 'wrap', bgcolor: 'white', }}>
                                ...
                                <CssVarsProvider>
                                    <IconButton
                                        sx={{
                                            ...
                                            fontSize: 13, height: 34, lineHeight: '1.2', color: '#1D617A',
                ...
                {disFlag === 1 ?
                    <Box sx={{ height: window.innerHeight - 200, flexWrap: 'wrap', bgcolor: 'white', overflow: 'auto' }}>
                        <Paper variant="outlined" sx={{ flexWrap: 'wrap' }}>
                            <Box sx={{ padding: 1, borderRadius: 2, }}>
                                <Typography sx={{ fontWeight: 'bold', marginBottom: 0.5, color: '#145DA0', fontSize: 14 }}>
                                    CRF/TMC/{tableData.req_slno}</Typography>
                            </Box>
                            ...
                            <Box sx={{ display: 'flex', pl: 1 }}>
                                ...
                                <Box sx={{ pt: 0.5, flex: 2, pl: 0.3 }}>
                                    <Typography sx={{ fontSize: 13, pt: 0.5, pr: 1 }}>{tableData.actual_requirement === null ? 'nil' : capitalizeWords(tableData.actual_requirement)}</Typography>
                                </Box>
                            </Box>
                            <Box sx={{ display: 'flex', pl: 1 }}>
                                ...
                                <Typography sx={{ pt: 0.7 }}>  :&nbsp;</Typography>
                                <Box sx={{ pt: 0.5, flex: 2, pl: 0.3 }}>
                                    <Typography sx={{ fontSize: 13, pt: 0.5, pr: 1 }}>{tableData.needed === null ? 'nil' : capitalizeWords(tableData.needed)}</Typography>
                                </Box>
                            </Box>
                                                            ...
                                                            <Box sx={{ flex: 1, display: 'flex' }}>
                                                                ...
                                                                <Box sx={{ py: 0.4, pl: 1 }}>
                                                                    <Chip size="md" variant="outlined" sx={{
                                                                        color: (tableData.incharge_approve === 1 ? '#2e7d32' : tableData.incharge_approve === 2 ? '#bf360c'
                                                                            : tableData.incharge_approve === 3 ? '#FF9800' : '#607D8B'), height: 25, pb: 0.5,
                                                                ...
                                                                <Box sx={{ pt: 0.5 }}>
                                                                    <Box sx={{ display: 'flex' }}>
                                                                        ...
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                            {tableData.incharge_remarks === null ? 'Not Updated' : tableData.incharge_remarks}</Typography>
                                                                    </Box>
                                                                    <Box sx={{ display: 'flex', pt: 1 }}>
                                                                        <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                        <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                            {tableData.inch_detial_analysis === null ? 'Not Updated' : tableData.inch_detial_analysis}</Typography>
                                                                    </Box>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', py: 1 }}>
                                                                        ...
                                                                        <Box sx={{ display: 'flex', flex: 1 }}>
                                                                            ...
                                                                            <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                                {capitalizeWords(tableData.incharge_user)}</Typography>
                                                                            <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                                {tableData.incharge_apprv_date}</Typography>
                                                                        </Box>
                                                                    </Box>
                                                                    : null}
                                                        </Box>
                                                ...
                                                <Paper variant="outlined" sx={{
                                                    ...
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.hod_approve === 1 ? '#2e7d32' : tableData.hod_approve === 2 ? '#bf360c'
                                                                    : tableData.hod_approve === 3 ? '#FF9800' : '#607D8B'),
                                                        ...
                                                        {tableData.hod_approve === 1 && tableData.hod_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.hod_remarks === null ? 'Not Updated' : tableData.hod_remarks} </Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.hod_detial_analysis === null ? 'Not Updated' : tableData.hod_detial_analysis}</Typography>
                                                                </Box>
                                                            </Box>
                                                            :
                                                            ...
                                                            tableData.hod_approve_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        ...
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.hod_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.hod_approve_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.dms_approve === 1 ? '#2e7d32' : tableData.dms_approve === 2 ? '#bf360c' :
                                                                    tableData.dms_approve === 3 ? '#FF9800' : tableData.dms_approve === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.dms}
                                                            </Chip>
                                                        ...
                                                        {tableData.dms_approve === 1 && tableData.dms_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.dms_remarks === null ? 'Not Updated' : tableData.dms_remarks}</Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.dms_detail_analysis === null ? 'Not Updated' : tableData.dms_detail_analysis}</Typography>
                                                                </Box>
                                                            ...
                                                            tableData.dms_approve_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography sx={{}} >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.dms_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.dms_approve_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.ms_approve === 1 ? '#2e7d32' : tableData.ms_approve === 2 ? '#bf360c'
                                                                    : tableData.ms_approve === 3 ? '#FF9800' : tableData.ms_approve === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.ms}
                                                            </Chip>
                                                        ...
                                                        {tableData.ms_approve === 1 && tableData.ms_approve_remark !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.ms_approve_remark === null ? 'Not Updated' : tableData.ms_approve_remark}</Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.ms_detail_analysis === null ? 'Not Updated' : tableData.ms_detail_analysis}</Typography>
                                                                </Box>
                                                            ...
                                                            tableData.ms_approve_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography sx={{}} >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.ms_approve_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.ms_approve_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.manag_operation_approv === 1 ? '#2e7d32' : tableData.manag_operation_approv === 2 ? '#bf360c' : tableData.manag_operation_approv === 3 ? '#FF9800'
                                                                    : tableData.manag_operation_approv === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.om}
                                                            </Chip>
                                                        ...
                                                        {tableData.manag_operation_approv === 1 && tableData.manag_operation_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.manag_operation_remarks === null ? 'Not Updated' : tableData.manag_operation_remarks} </Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.om_detial_analysis === null ? 'Not Updated' : tableData.om_detial_analysis}  {tableData.om_detial_analysis}</Typography>
                                                                </Box>
                                                            </Box>
                                                            :
                                                            ...
                                                            tableData.om_approv_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.manag_operation_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.om_approv_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.senior_manage_approv === 1 ? '#2e7d32' : tableData.senior_manage_approv === 2 ? '#bf360c'
                                                                    : tableData.senior_manage_approv === 3 ? '#FF9800' : tableData.senior_manage_approv === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.smo}
                                                            </Chip>
                                                        ...
                                                        {tableData.senior_manage_approv === 1 && tableData.senior_manage_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.senior_manage_remarks === null ? 'Not Updated' : tableData.senior_manage_remarks}</Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.smo_detial_analysis === null ? 'Not Updated' : tableData.smo_detial_analysis}</Typography>
                                                                </Box>
                                                            </Box>
                                                            :
                                                            ...
                                                            tableData.som_aprrov_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography sx={{}} >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.senior_manage_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.som_aprrov_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.gm_approve === 1 ? '#2e7d32' : tableData.gm_approve === 2 ? '#bf360c'
                                                                    : tableData.gm_approve === 3 ? '#FF9800' : tableData.gm_approve === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.gm}
                                                            </Chip>
                                                        ...
                                                        {tableData.gm_approve === 1 && tableData.gm_approve_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.gm_approve_remarks === null ? 'Not Updated' : tableData.gm_approve_remarks}  </Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.gm_detial_analysis === null ? 'Not Updated' : tableData.gm_detial_analysis}</Typography>
                                                                </Box>
                                                            </Box>
                                                            :
                                                            ...
                                                            tableData.gm_approv_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography sx={{}} >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.gm_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.gm_approv_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.md_approve === 1 ? '#2e7d32' : tableData.md_approve === 2 ? '#bf360c'
                                                                    : tableData.md_approve === 3 ? '#FF9800' : tableData.md_approve === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.md}
                                                            </Chip>
                                                        ...
                                                        {tableData.md_approve === 1 && tableData.md_approve_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.md_approve_remarks === null ? 'Not Updated' : tableData.md_approve_remarks} </Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.md_detial_analysis === null ? 'Not Updated' : tableData.md_detial_analysis}</Typography>
                                                                </Box>
                                                            </Box>
                                                            :
                                                            ...
                                                            tableData.md_approve_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.md_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.md_approve_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.ed_approve === 1 ? '#2e7d32' : tableData.ed_approve === 2 ? '#bf360c'
                                                                    : tableData.ed_approve === 3 ? '#FF9800' : tableData.ed_approve === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.ed}
                                                            </Chip>
                                                        ...
                                                        {tableData.ed_approve === 1 && tableData.ed_approve_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    ...
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.ed_approve_remarks === null ? 'Not Updated' : tableData.ed_approve_remarks}</Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.ed_detial_analysis === null ? 'Not Updated' : tableData.ed_detial_analysis}</Typography>
                                                                </Box>
                                                            </Box>
                                                            :
                                                            ...
                                                            tableData.ed_approve_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography  >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.ed_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.ed_approve_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap' }}>
                                                    <Box sx={{ display: 'flex', pt: 0.5, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, py: 0.4, ml: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.managing_director_approve === 1 ? '#2e7d32' :
                                                                    tableData.managing_director_approve === 2 ? '#bf360c' : tableData.managing_director_approve === 3 ? '#FF9800'
                                                                        : tableData.managing_director_approve === 4 ? '#009688' : '#607D8B'),
                                                                height: 25, pb: 0.5, fontSize: 12, fontWeight: 550,
                                                            }}>
                                                                {tableData.managing}
                                                            </Chip>
                                                    ...
                                                    <Box sx={{ pt: 0.1 }}>
                                                        {tableData.managing_director_approve === 1 && tableData.managing_director_remarks !== null ?
                                                            <Box sx={{ pt: 0.5 }}>
                                                                <Box sx={{ display: 'flex' }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Justification/ Requirement Description </Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.managing_director_remarks === null ? 'Not Updated' : tableData.managing_director_remarks}</Typography>
                                                                </Box>
                                                                <Box sx={{ display: 'flex', pt: 1 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Detailed Analysis of Requirement</Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        {tableData.managing_director_analysis === null ? 'Not Updated' : tableData.managing_director_analysis}</Typography>
                                                                </Box>
                                                            </Box>
                                                            :
                                                            tableData.managing_director_approve === 2 && tableData.managing_director_remarks !== null ?
                                                                <Box sx={{ display: 'flex', pt: 0.5 }}>
                                                                    <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Justification for Reject </Typography>
                                                                    <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                ...
                                                                : tableData.managing_director_approve === 3 && tableData.managing_director_remarks !== null ?
                                                                    <Box sx={{ display: 'flex', pt: 0.5 }}>
                                                                        <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Justification for On-Hold</Typography>
                                                                        <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                    ...
                                                                    : tableData.managing_director_approve === 4 && tableData.managing_director_remarks !== null ?
                                                                        <Box sx={{ display: 'flex', pt: 0.5 }}>
                                                                            <Typography sx={{ pl: 1, fontSize: 14, flex: 0.4 }}>Remarks</Typography>
                                                                            <Typography sx={{ pl: 0.5 }} >  :&nbsp;</Typography>
                                                                            <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                                                                        ...
                                                                        </Box> : null}
                                                        {
                                                            tableData.managing_director_approve_date !== null ?
                                                                <Box sx={{ display: 'flex', py: 1 }}>
                                                                    {(tableData.managing_director_approve === 1 || tableData.managing_director_approve === 4) ?
                                                                        <Typography sx={{ pl: 1, fontSize: 13, flex: 0.4 }}>Approved by </Typography>
                                                                    ...
                                                                    <Box sx={{ display: 'flex', flex: 1 }}>
                                                                        <Typography  >  :&nbsp;</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pt: 0.3, pl: 0.2 }}>
                                                                            {capitalizeWords(tableData.managing_director_user)}</Typography>
                                                                        <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                                                                            {tableData.managing_director_approve_date}</Typography>
                                                                    </Box>
                                                                </Box>
                                                                : null}
                                                    </Box>
                                            ...
                                            <Grid xs={12} sm={12} md={12} lg={12} xl={12} sx={{ pl: 0.5 }}>
                                                <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap', height: 135 }}>
                                                    <Box sx={{ display: 'flex', py: 0.2, borderBottom: '1px solid lightgrey' }}>
                                                        ...
                                                        <Box sx={{ flex: 1, pl: 2 }}>
                                                            <Chip size="md" variant="outlined" sx={{
                                                                color: (tableData.crf_close === 1 ? '#d50000' : '#ff3d00'), height: 25,
                                                                fontSize: 12, fontWeight: 550, px: 2
                                                            }}>
                                                                Closed
                                                            </Chip>
                                                        </Box>
                                                        ...
                                                        <Box sx={{ display: 'flex', mx: 0.3, p: 1 }}>
                                                            ...
                                                            <Box sx={{ flex: 1, display: 'flex' }}>
                                                                ...
                                                                <Typography sx={{ fontSize: 13, flex: 1, fontWeight: 550, pt: 0.2 }}>
                                                                    {tableData.ack_remarks === null ? 'Not Updated' : tableData.ack_remarks}</Typography>
                                                                <Typography sx={{
                                                                    display: 'flex', flex: 0.3, justifyContent: 'flex-end', fontSize: 13,
                                                                    textTransform: 'capitalize', fontWeight: 550, pr: 1, pt: 0.2
                                                                }}>{capitalizeWords(tableData.purchase_ackuser)}&nbsp; /</Typography>
                                                                <Typography sx={{ pr: 2, display: 'flex', justifyContent: 'flex-start', fontSize: 13, fontWeight: 550, pt: 0.2 }}>
                                                                    {tableData.ack_date}</Typography >
                                                            </Box>
                                                        </Box>
                                                    </Paper>
                                                </Grid>
                                                        ...
                                                        <Box sx={{ display: 'flex', mx: 0.3, p: 1 }}>
                                                            ...
                                                            <Box sx={{ flex: 1, display: 'flex' }}>
                                                                ...
                                                                <Typography sx={{ fontSize: 12, flex: 1, fontWeight: 550, pt: 0.2 }}>
                                                                    {tableData.quatation_calling_remarks === null ? 'Not Updated'
                                                                        : tableData.quatation_calling_remarks}</Typography>
                                                                <Typography sx={{
                                                                    display: 'flex', flex: 0.3, justifyContent: 'flex-end', fontSize: 12,
                                                                    textTransform: 'capitalize', fontWeight: 550, pr: 1, pt: 0.2
                                                                }}>{capitalizeWords(tableData.quatation_user)}&nbsp; /</Typography>
                                                                <Typography sx={{
                                                                    pr: 2, display: 'flex', justifyContent: 'flex-start', fontSize: 12, fontWeight: 550,
                                                                    pt: 0.2
                                                                }}>
                                                                    {tableData.quatation_calling_date}</Typography >
                                                            </Box>
                                                        </Box>
                                                    </Paper>
                                                </Grid>
                                                    ...
                                                    <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap', }}>
                                                        ...
                                                        <Box sx={{ display: 'flex', mx: 0.3, p: 1 }}>
                                                            ...
                                                            <Box sx={{ flex: 1, display: 'flex' }}>
                                                                <Typography sx={{}} >  :&nbsp;</Typography>
                                                                <Typography sx={{ fontSize: 12, flex: 1, fontWeight: 550, pt: 0.2 }}>
                                                                    {tableData.quatation_negotiation_remarks === null ? 'Not Updated'
                                                                        : tableData.quatation_negotiation_remarks}</Typography>
                                                                <Typography sx={{
                                                                    display: 'flex', flex: 0.3, justifyContent: 'flex-end', fontSize: 12,
                                                                    textTransform: 'capitalize', fontWeight: 550, pr: 1, pt: 0.2
                                                                }}>{capitalizeWords(tableData.quatation_neguser)}&nbsp; /</Typography>
                                                                <Typography sx={{ pr: 2, display: 'flex', justifyContent: 'flex-start', fontSize: 12, fontWeight: 550, pt: 0.2 }}>
                                                                    {tableData.quatation_negotiation_date}</Typography >
                                                            </Box>
                                                        </Box>
                                                    </Paper>
                                                </Grid>
                                                    ...
                                                    <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap', }}>
                                                        ...
                                                        <Box sx={{ display: 'flex', mx: 0.3, p: 1 }}>
                                                            ...
                                                            <Box sx={{ flex: 1, display: 'flex' }}>
                                                                <Typography sx={{}} >  :&nbsp;</Typography>
                                                                <Typography sx={{ fontSize: 12, flex: 1, fontWeight: 550, pt: 0.2 }}>
                                                                    {tableData.quatation_fixing_remarks === null ? 'Not Updated' : tableData.quatation_fixing_remarks}</Typography>
                                                                <Typography sx={{
                                                                    display: 'flex', flex: 0.3, justifyContent: 'flex-end', fontSize: 12,
                                                                    textTransform: 'capitalize', fontWeight: 550, pr: 1, pt: 0.2
                                                                }}>{capitalizeWords(tableData.quatation_fixuser)}&nbsp; /</Typography>
                                                                <Typography sx={{ pr: 2, display: 'flex', justifyContent: 'flex-start', fontSize: 12, fontWeight: 550, pt: 0.2 }}>
                                                                    {tableData.quatation_fixing_date}</Typography >
                                                            </Box>
                                                        </Box>
                                                    </Paper>
                                                </Grid>
                                        ...
                                        {tableData.po_complete === 1 ?
                                            <Box sx={{ display: 'flex', pt: 0.5, }}>
                                                ...
                                                : &nbsp;        <Box sx={{ flex: 1, display: 'flex' }}>
                                                    ...
                                                    }}>{capitalizeWords(tableData.pocomplete_user)}&nbsp; /</Typography>
                                                    <Typography sx={{ height: 30, fontSize: 12, fontWeight: 550, pl: 1, pt: 0.4 }}>
                                                        {tableData.po_complete_date}</Typography>
                                                </Box>
                                            </Box>
                                            : null
                                        }
                                            ...
                                            < Box sx={{ display: 'flex', pt: 0.5, }}>
                                                ...
                                                <Box sx={{ flex: 1, display: 'flex' }}>
                                                    <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 0.5, pt: 0.4, color: '#1b5e20' }}>
                                                        {tableData.approval_level === 1 ? "Purchase Dpt Approved" :
                                                            tableData.approval_level === 2 ? "Purchase Department Approved, Purchase Manager Approved" :
                                                                tableData.approval_level === 3 ? "Purchase Department Approved, Purchase Manager Approved, Directors Approved" : null} </Typography>
                                                </Box>
                                            </Box>
                                            :
                                            < Box sx={{ display: 'flex', pt: 0.5, }}>
                                            ...
                                            <Box sx={{ display: 'flex', pt: 0.5, }}>
                                                ...
                                                : &nbsp;      <Box sx={{ flex: 1, display: 'flex' }}>
                                                    ...
                                                    <Typography sx={{ height: 30, fontSize: 12, fontWeight: 550, pl: 2, pt: 0.4 }}>
                                                        {tableData.po_to_supplier_date}</Typography>
                                                </Box>
                                            </Box>
                                            : null
                                        }
                                                    ...
                                                    {tableData.store_receive === 1 ?
                                                        <>
                                                            <Typography sx={{
                                                                display: 'flex', justifyContent: 'flex-end', fontSize: 12,
                                                                textTransform: 'capitalize', fontWeight: 550, pl: 2, pt: 0.4
                                                            }}>{capitalizeWords(tableData.crs_user)}&nbsp; /</Typography>
                                                            <Typography sx={{ height: 30, fontSize: 12, fontWeight: 550, pl: 1, pt: 0.4 }}>
                                                                {tableData.store_receive_date}</Typography>
                                                        </> :
                                                        (tableData.store_receive === 0 && (tableData.store_recieve === 0 || tableData.store_recieve === 1)) ?
                                            ...
                                            <Box sx={{ display: 'flex', pt: 0.5, }}>
                                                ...
                                                : &nbsp;     <Box sx={{ flex: 1, display: 'flex' }}>
                                                    ...
                                                    <Typography sx={{
                                                        display: 'flex', justifyContent: 'flex-end', fontSize: 12,
                                                        textTransform: 'capitalize', fontWeight: 550, pl: 2, pt: 0.4
                                                    }}>{capitalizeWords(tableData.store_user)}&nbsp; /</Typography>
                                                    <Typography sx={{ height: 30, fontSize: 12, fontWeight: 550, pl: 1, pt: 0.4 }}>
                                                        {tableData.substore_ack_date}</Typography>
                                                </Box>
                                            </Box>
                                            : null
                                        }
