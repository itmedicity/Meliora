...
const AllCRFReport = () => {
    ...
    const [columnDefForTable] = useState([
        ...
        { headerName: 'Expected Date', field: 'expected_date', autoHeight: true, wrapText: true, minWidth: 70 },
        { headerName: 'Emergency Tye', field: 'emer_type_name', autoHeight: true, wrapText: true, minWidth: 60 },
        { headerName: 'Emergency remarks', field: 'emergeny_remarks', autoHeight: true, wrapText: true, minWidth: 70 },
        ...
        { headerName: 'Req.Status', field: 'approved_status', autoHeight: true, wrapText: true, minWidth: 90 },
