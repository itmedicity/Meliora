...
const UserNotAckldgedList = () => {
    ...
    const [columnDefForTable] = useState([
        ...
        { headerName: 'Emergency remarks', field: 'emergeny_remarks', autoHeight: true, wrapText: true, minWidth: 60 },
        { headerName: 'Req.DeptSec', field: 'user_deptsection', autoHeight: true, wrapText: true, minWidth: 50 },
        { headerName: 'Req.User', field: 'req_user', autoHeight: true, wrapText: true, minWidth: 50 },
    ])
