...
const CrfTatReport = () => {
    ...
    const searchCRFDetails = useCallback(
        async e => {
            ...
            const getdataUserAcknldged = async postdata => {
                const result = await axioslogin.post('/CrfReports/getCrfTat', postdata)
    ...
    const [columnDefForTable] = useState([
        ...
        {
            headerName: 'Incharge Approve Date',
            field: 'incharge_apprv_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'HOD Approve Date',
            field: 'hod_approve_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'DMS Approve Date',
            field: 'dms_approve_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'MS Approve Date',
            field: 'ms_approve_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'MO Approve Date',
            field: 'om_approv_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        ...
        {
            headerName: 'GM Approve Date',
            field: 'gm_approv_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'MD Approve Date',
            field: 'md_approve_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'ED Approve Date',
            field: 'ed_approve_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'PO Complete Date',
            field: 'po_complete_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'Po_To_Supplier_Date',
            field: 'po_to_supplier_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'Quatation_Calling_Date',
            field: 'quatation_calling_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        ...
        {
            headerName: 'Quatation_Fixing_Date',
            field: 'quatation_fixing_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'Quatation_Negotiation_Date',
            field: 'quatation_negotiation_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'Store_Receive_Date',
            field: 'store_receive_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'Substore_Ack_Date',
            field: 'substore_ack_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        {
            headerName: 'User_Ack_Date',
            field: 'user_ack_date',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        ...
        {
            headerName: 'Crf_Close_Remark',
            field: 'crf_close_remark',
            autoHeight: true,
            wrapText: true,
            minWidth: 80
        },
        ...
        <Fragment>
            ...
            <Box sx={{ height: window.innerHeight - 80, flexWrap: 'wrap', bgcolor: 'white', width: '100%' }}>
                <Box sx={{ border: '1px solid #B4F5F0' }}>
                    <Box sx={{ display: 'flex' }}>
                        <Box sx={{ fontWeight: 550, flex: 1, pl: 1, pt: 0.5, color: '#385E72' }}>Crf Tat Report</Box>
