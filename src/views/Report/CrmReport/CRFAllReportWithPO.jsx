...
const CRFAllReportWithPO = () => {
    ...
    const [columnDefForTable] = useState([
        ...
        { headerName: 'Expected Delivery date', field: 'expected_delivery', autoHeight: true, wrapText: true, minWidth: 90 },
        { headerName: 'Supplier', field: 'supplier_name', autoHeight: true, wrapText: true, minWidth: 90 },
        { headerName: 'Store', field: 'main_store', autoHeight: true, wrapText: true, minWidth: 90 },
        { headerName: 'Substore', field: 'sub_store_name', autoHeight: true, wrapText: true, minWidth: 90 },
    ])
