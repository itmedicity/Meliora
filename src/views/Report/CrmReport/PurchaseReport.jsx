...
const PurchaseReport = () => {
    ...
    const { startDate, endDate, purchaseTot, ackPending, quotation, negotiation, quofinal,
        preparation, poSupplier, viewFlag } = crfSearch
    ...
    const searchCRFDetails = useCallback(async (e) => {
        ...
        getAckPurchaseData().then((val) => {
            ...
            if (success === 1) {
                setOpen(false)
                const ackpendingList = data?.filter(
    ...
    const boxStyle = {
        mt: 4,
        cursor: 'pointer', borderRadius: 200,
        fontSize: 40, display: 'flex', justifyContent: 'center',
        width: 100, fontWeight: 650, color: '#3f51b5', bgcolor: 'white'
    }
    ...
    return (
        <Fragment>
            ...
            <Box sx={{ height: window.innerHeight - 80, flexWrap: 'wrap', bgcolor: 'white', }}>
                ...
                {viewFlag === 1 ?
                    <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', flexWrap: 'wrap', pb: 1 }}>
                        <Box sx={{ pt: 2, width: { xs: '100%', md: '80vw', lg: '70vw', xl: '70vw', display: 'flex' } }}>
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd' }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    CRF Acknowledgement</Typography>
                            ...
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd', mx: 2 }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    CRF Acknowledgement Pending</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'center', }}>
                                    <Box
                                        sx={boxStyle}
                                    >
                            ...
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd', mr: 2 }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    Quotation Calling Pending</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'center', }}>
                                    <Box
                                        sx={boxStyle}
                                    >
                            ...
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd', }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    Quotation Negotiation Pending</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'center', }}>
                                    <Box
                                        sx={boxStyle}
                                    >
                        ...
                        <Box sx={{ pt: 2, width: { xs: '100%', md: '80vw', lg: '70vw', xl: '70vw', display: 'flex' } }}>
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd', }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    Quotation Approval Pending</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'center', }}>
                                    <Box
                                        sx={boxStyle}
                                    >
                            ...
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd', mx: 2 }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    PO Preparation Pending</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'center', }}>
                                    <Box
                                        sx={boxStyle}
                                    >
                            ...
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd', mr: 2 }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    Inform to Supplier(PO) Pending</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'center', }}>
                                    <Box
                                        sx={boxStyle}
                                    >
                            ...
                            <Paper variant='outlined' square sx={{ height: 170, width: 300, bgcolor: '#e3f2fd', }}>
                                <Typography sx={{ textAlign: 'center', fontWeight: 'bold', color: '#145DA0', fontSize: 16, pt: 2 }}>
                                    Data Collection Pending</Typography>
                                <Box sx={{ display: 'flex', justifyContent: 'center', }}>
                                    <Box
                                        sx={boxStyle}
                                    >
                    ...
                    :
                    <Box sx={{
                        display: 'flex', justifyContent: 'center', fontSize: 28, opacity: 0.5,
                        pt: 10, color: 'grey'
                    }}>
                        No Reports Found
                    </Box>
