                ...
                if (success === 1) {
                    const insertArray = data?.map((val) => {
                        return {
                            ...
                            qi_dept_no: qidept,
                            assessment_start: val.ASSESS_START_DATE !== null ? format(new Date(val.ASSESS_START_DATE), 'yyyy-MM-dd HH:mm:ss') : null,
                            assessment_end: val.ASSESS_END_DATE !== null ? format(new Date(val.ASSESS_END_DATE), 'yyyy-MM-dd HH:mm:ss') : null,
                            sumof_service_time: val.SERVICE_TIME === null ? 0 : val.SERVICE_TIME,
                            create_user: id,
                            consult_start_date: val.CONSULT_START_DATE === null ? null : format(new Date(val.CONSULT_START_DATE), 'yyyy-MM-dd HH:mm:ss'),
                            complaint_entry_date: val.COMP_DATE === null ? null : format(new Date(val.COMP_DATE), 'yyyy-MM-dd HH:mm:ss'),
                            investigation_req_date: val.INVESTIGATION_DATE === null ? null : format(new Date(val.INVESTIGATION_DATE), 'yyyy-MM-dd HH:mm:ss'),
                            prescription_req_date: val.PRESCRIPTION_DATE === null ? null : format(new Date(val.PRESCRIPTION_DATE), 'yyyy-MM-dd HH:mm:ss'),
                ...
                if (success === 1) {
                    const insertArray = data?.map((val) => {
                        return {
                            ...
                            sumof_service_time: val.SERVICE_TIME === null ? 0 : val.SERVICE_TIME,
                            create_user: id,
                            consult_start_date: val.CONSULT_START_DATE !== null ? format(new Date(val.CONSULT_START_DATE), 'yyyy-MM-dd HH:mm:ss') : null,
                            complaint_entry_date: val.COMP_DATE === null ? null : format(new Date(val.COMP_DATE), 'yyyy-MM-dd HH:mm:ss'),
                            investigation_req_date: val.INVESTIGATION_DATE === null ? null : format(new Date(val.INVESTIGATION_DATE), 'yyyy-MM-dd HH:mm:ss'),
                            prescription_req_date: val.PRESCRIPTION_DATE === null ? null : format(new Date(val.PRESCRIPTION_DATE), 'yyyy-MM-dd HH:mm:ss'),
                            reference_req_date: val.VRD_DATE === null ? null : format(new Date(val.VRD_DATE), 'yyyy-MM-dd HH:mm:ss')
