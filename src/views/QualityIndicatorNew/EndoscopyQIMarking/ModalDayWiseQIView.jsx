...
const ModalDayWiseQIView = ({ open, handleClose, rowSelect }) => {
    const { ptno, ptname, ptsex, ptage, ptaddrs1, ptaddrs3, doctor_name, ptmobile }
        = rowSelect
    ...
    const { errorDetails, errorReason, errorCorrect, errorPrvnt, redosDetails, redosReason, redosCoorect, redosPrvnt,
        ...
        nearMissesDetails, nearMissessReason, benchMarkReason
    } = qualityIndicators
            ...
            <CssVarsProvider>
                ...
                >
                    ...
                    >
                        ...
                        />
                        <Paper sx={{ display: 'flex', height: 40, bgcolor: '#E3E8F0' }}>
                                    ...
                                    <Box sx={{ pl: 1, flex: 1 }}>
                                        <CssVarsProvider>
                                            <Input
                                                ...
                                                size="sm"
                                                name="entryTime"
                                                value={format(new Date(entryTime), 'dd-MM-yyyy HH:mm:ss')}
                                                sx={{ height: 38 }}
                                            />
                                        </CssVarsProvider>
                                    </Box>
                                    ...
                                    <Box sx={{ pr: 1, pl: 1, flex: 1 }} >
                                        <CssVarsProvider>
                                            <Input
                                                ...
                                                size="sm"
                                                name="assessmentTime"
                                                value={format(new Date(assessmentTime), 'dd-MM-yyyy HH:mm:ss')}
                                                sx={{ height: 38 }}
                                            />
                                        </CssVarsProvider>
                                    </Box>
                                    ...
                                    <Box sx={{ pl: 1, flex: 1 }}>
                                        <CssVarsProvider>
                                            <Input
                                                ...
                                                size="sm"
                                                name="startTime"
                                                value={format(new Date(startTime), 'dd-MM-yyyy HH:mm:ss')}
                                                sx={{ height: 38 }}
                                            />
                                        </CssVarsProvider>
                                    </Box>
                                    ...
                                    <Box sx={{ pl: 1, flex: 1 }}>
                                        <CssVarsProvider>
                                            <Input
                                                ...
                                                size="sm"
                                                name="endTime"
                                                value={format(new Date(endTime), 'dd-MM-yyyy HH:mm:ss')}
                                                sx={{ height: 38 }}
                                            />
                                        </CssVarsProvider>
                                    </Box>
                                    ...
                                    <Box sx={{ pr: 1, pl: 1, flex: 1 }} >
                                        <CssVarsProvider>
                                            <Input
                                                ...
                                                size="sm"
                                                name="reportTime"
                                                value={format(new Date(reportTime), 'dd-MM-yyyy HH:mm:ss')}
                                                sx={{ height: 38 }}
                                            />
                                        </CssVarsProvider>
                                    </Box>
                                    ...
                                    <Box sx={{ pl: 1, flex: 1, pr: 0.8 }} >
                                        <CssVarsProvider>
                                            <Input
                                                ...
                                                size="sm"
                                                name="despatchTime"
                                                value={format(new Date(despatchTime), 'dd-MM-yyyy HH:mm:ss')}
                            ...
                            <Box sx={{ pl: 0.2, display: 'flex', py: 0.5, m: 0.5, bgcolor: '#eceff1' }}>
                                <Box sx={{ flex: 1 }}>
                                    <Box sx={{ pl: 0.5, py: 0.5 }}>
                                        <Typography sx={{ fontSize: 11, textTransform: 'uppercase' }}>Total Initial Assessment Time</Typography>
                                    </Box>
                                    <Box sx={{ display: 'flex', justifyContent: 'center', pt: 0.1, pl: 1 }}>
                                        {benchMarkFlag === 1 ?
                                            <Box sx={{ flex: 1, bgcolor: 'white', color: 'red', height: 41, pt: 1, mr: 0.6, border: '1px solid lightgrey', pl: 2 }}>
                                                {sumOfAssesment}
                                            </Box>
                                            : <Box sx={{ flex: 1, bgcolor: 'white', height: 41, pt: 1, mr: 0.6, border: '1px solid lightgrey', pl: 2 }}>
                                                {sumOfAssesment}
                                            </Box>}
                                    </Box>
                                    <Box sx={{ pt: 0.5 }}>
                                ...
                                <Box sx={{ flex: 1 }}>
                                    ...
                                    <Box sx={{ display: 'flex', justifyContent: 'center', pt: 0.1, pl: 0.5 }}>
                                        <Box sx={{ flex: 1, bgcolor: 'white', height: 41, pt: 1, mr: 0.6, border: '1px solid lightgrey', pl: 2 }}>
                                            {turnaroundTime}
                                        </Box>
                                    </Box>
...
export default ModalDayWiseQIView