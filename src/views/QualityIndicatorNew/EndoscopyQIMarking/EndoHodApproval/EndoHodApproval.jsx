...
import HodQiapprovalView from './HodQiapprovalView';

const EndoHodApproval = ({ viewData, qitype, searchDate, qidept, setsearchFlag, equipmentlist, ipViewReport, testCount, endoDays }) => {
    return (
            ...
            <CssVarsProvider>
                ...
                >
                    ...
                    <TabPanel value={0} sx={{ p: 0, bgcolor: '#b0bec5' }}>
                        <HodQiapprovalView viewData={viewData} searchDate={searchDate} setsearchFlag={setsearchFlag}
                            qidept={qidept} ipViewReport={ipViewReport} testCount={testCount} equipmentlist={equipmentlist} endoDays={endoDays} />
                    </TabPanel>
...
export default memo(EndoHodApproval)