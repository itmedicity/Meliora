...
const HodQiapprovalView = ({ viewData, qidept, searchDate, setsearchFlag, ipViewReport, testCount, equipmentlist, endoDays }) => {
    ...
    const [inchargeDetails, setInchargeDetails] = useState({
        apprvlSlno: 0, inchrgStatus: 0, inchrgeName: '', inchrgDate: '', inchrgRemarks: '', hodStatus: 0
    })
    ...
    useEffect(() => {
        if (viewData.length !== 0 || ipViewReport.length !== 0) {
            ...
            ExistApprvView(postdata).then((val) => {
                ...
                if (success === 1) {
                    const { apprv_slno, endo_incharge_apprv_status, endo_incharge_remarks, endo_Incharge_apprv_date, inchrge, inchargeno,
                        endo_hod_remarks, endo_hod_apprv_date, hod, hodno, endo_hod_apprv_status } = data[0]
                                        ...
                                        <Box sx={{ display: 'flex', py: 1, flexWrap: 'wrap' }}>
                                            ...
                                            <Box sx={{ pr: 1.5, pt: 0.2 }}>
                                                <Typography sx={{ fontSize: 13, color: '#555830' }}>
                                                    {format(new Date(inchrgDate), 'dd-MM-yyyy hh:mm:ss a')}</Typography>
                                            </Box>
                                        </Box>
                                    </Box>
                                </Paper>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                                    {hodStatus === 1 ?
                                        <>
                                            ...
                                            <Box sx={{ pr: 1.5, pt: 2 }}>
                                                <Typography sx={{ fontSize: 13, color: '#555830' }}>
                                                    {format(new Date(lastApprvdDate), 'dd-MM-yyyy hh:mm:ss a')}</Typography>
                                            </Box>
                                        </>
                                        : null}
                                    <Box sx={{ py: 1, pr: 2 }}>
