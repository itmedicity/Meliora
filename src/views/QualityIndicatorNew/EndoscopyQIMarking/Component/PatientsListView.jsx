    ...
    <Box>
      <Paper variant="outlined" square sx={{ display: 'flex', flexDirection: 'column' }}>
        {opCheck === true ? (
          <>
            ...
            {tabFlag === 1 ? (
              <Box sx={{ pt: 0.5, flexWrap: 'wrap' }}>
                <Box
                  variant="outlined"
                  sx={{ height: '38vh', overflow: 'auto', '&::-webkit-scrollbar': { height: 8 } }}
                >
                  <CssVarsProvider>
                    <Table
            ...
            {qiMarkFlag === 1 ? (
              <>
                <PatientsListTable
                  qiMarkedList={qiMarkedList}
                  setqiMarkFlag={setqiMarkFlag}
                  count={count}
                  setCount={setCount}
                  dailyDate={dailyDate}
                  depName={depName}
          ...
          <EndoscopyIPPatients
            ChangeOPList={ChangeOPList}
            ChangeIPList={ChangeIPList}
            opCheck={opCheck}
            ipCheck={ipCheck}
