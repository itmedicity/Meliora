        ...
        <Box>
            {incFlag === 1 ?
                <IncidentModal open={incmodalopen} setIncModalOpen={setIncModalOpen} depName={depName} qidept={qidept}
                    endoSlno={qi_endo_ip_slno} incCount={incCount} setincCount={setincCount} incdExist={incdExist} incidentView={incidentView}
                    ...
                    setNearMissesDetails={setNearMissesDetails} setNearMissessReason={setNearMissessReason} patient_arrived_date={ipd_date}
                    ...
                    <Box sx={{ width: '82vw', overflow: 'auto' }}>
                        <Paper sx={{ display: 'flex', height: 40, bgcolor: '#b0bec5' }}>
                            <Box sx={{ display: 'flex', flex: 1, pt: 0.5 }}>
                                ...
                                <Box sx={{ pt: 0.5, pl: 2 }}>
                                    <Typography sx={{ fontSize: 14 }}> {ptage}/{ptsex}</Typography>
                                </Box>
                                <Box sx={{ pt: 0.5, pl: 2 }}>
                                    <Typography sx={{ fontSize: 14 }}>
                                ...
                                <Box sx={{ pt: 0.5, pl: 2 }}>
                                    <Typography sx={{ fontSize: 14 }}>
                                        {"Dr. " + doctor_name.toLowerCase().split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}</Typography>
                                </Box>
                            </Box>
