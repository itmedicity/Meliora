                ...
                {errorYes === true ? (
                  <Box>
                    <Box sx={{ display: 'flex', pl: 0.3 }}>
                      ...
                      <Box sx={{ pl: 1, pt: 0.7 }}>
                        <Typography sx={{ fontSize: 11, borderRadius: 1 }}>{errorType}</Typography>
                      </Box>
                    </Box>
                ...
                {redosYes === true ? (
                  <Box>
                    <Box sx={{ display: 'flex', pl: 0.3 }}>
                      ...
                      <Box sx={{ pl: 1, pt: 0.7 }}>
                        <Typography sx={{ fontSize: 11, borderRadius: 1 }}>{redosType}</Typography>
                      </Box>
                    </Box>
                    <Box sx={{ pb: 0.5, display: 'flex' }}>
                      <Box sx={{ flex: 1, pl: 0.3 }}>
                ...
                {errorIdentyYes === true ? (
                  <Box>
                    <Box sx={{ display: 'flex', pl: 0.3 }}>
                      ...
                      <Box sx={{ pl: 1, pt: 0.7 }}>
                        <Typography sx={{ fontSize: 11, borderRadius: 1 }}>{identType}</Typography>
                      </Box>
                    </Box>
                    <Box sx={{ pb: 0.5, display: 'flex' }}>
                      <Box sx={{ flex: 1, pl: 0.3 }}>
                ...
                {fallsYes === true ? (
                  <Box>
                    <Box sx={{ display: 'flex', pl: 0.3 }}>
                      ...
                      <Box sx={{ pl: 1, pt: 0.7 }}>
                        <Typography sx={{ fontSize: 11, borderRadius: 1 }}>{fallsType}</Typography>
                      </Box>
                    </Box>
                    <Box sx={{ pb: 0.5, display: 'flex' }}>
                      <Box sx={{ flex: 1, pl: 0.3 }}>
                  ...
                  <Box>
                    ...
                    <Box sx={{ display: 'flex' }}>
                      ...
                      <Box sx={{ pt: 1, flex: 1, pl: 1 }}>
                        <CssVarsProvider>
                          <Checkbox color="neutral" size="md" checked={sentinelAnalyse} />
                        </CssVarsProvider>
                      </Box>
                    </Box>
                  </Box>
                ...
                {nearYes === true ? (
                  <Box>
                    <Box sx={{ display: 'flex', pl: 0.3 }}>
                      ...
                      <Box sx={{ pl: 1, pt: 0.7 }}>
                        <Typography sx={{ fontSize: 11, borderRadius: 1 }}>{nearType}</Typography>
                      </Box>
                    </Box>
                    <Box sx={{ pb: 0.5, display: 'flex' }}>
                      <Box sx={{ flex: 1, pl: 0.3 }}>
...
export default memo(ModalDayWiseQIView)
