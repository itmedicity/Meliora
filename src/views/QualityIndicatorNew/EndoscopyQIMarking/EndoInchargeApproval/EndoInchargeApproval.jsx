...
const EndoInchargeApproval = ({ viewData, qitype, searchDate, qidept, setsearchFlag, equipmentlist, ipViewReport, testCount, endoDays }) => {
    return (
            ...
            <CssVarsProvider>
                ...
                >
                    ...
                    <TabPanel value={0} sx={{ p: 0, bgcolor: '#b0bec5' }}>
                        <QiApprovalView viewData={viewData} searchDate={searchDate} setsearchFlag={setsearchFlag}
