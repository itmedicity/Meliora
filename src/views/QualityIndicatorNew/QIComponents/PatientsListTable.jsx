...
const PatientsListTable = ({ endoList, count, setCount, dailyDate }) => {
    ...
    return (
        <Fragment>
            ...
            {qiflag === 1 ? <ModalQiEndoscopy open={modalopen} setQiflag={setQiflag} handleClose={handleClose} rowSelect={rowSelect}
