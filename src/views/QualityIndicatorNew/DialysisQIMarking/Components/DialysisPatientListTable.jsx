...
import DialysisModalQIMark from './DialysisModalQIMark';
...
const DialysisPatientListTable = ({ setSearchFlag, dailyDate, count, setCount, qidept, depCode, qitype
    ...
    return (
        <Fragment>
            {qiflag === 1 ? <DialysisModalQIMark open={modalopen} setQiflag={setQiflag} handleClose={handleClose} rowSelect={rowSelect}
                count={count} setCount={setCount} dailyDate={dailyDate} RefreshData={RefreshData} />
                : null}
...
export default memo(DialysisPatientListTable)