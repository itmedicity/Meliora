...
const DialysisModalQIMark = ({ open, handleClose, rowSelect }) => {
    const { patient_arrived_date, ptno, ptname, ptsex, ptage, ptaddrs1, ptaddrs3, doctor_name,
        ptmobile } = rowSelect
                    ...
                    <Paper sx={{ display: 'flex', height: 40 }}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', fontSize: 20, pt: 0.5, pr: 0.2 }}>
                            <Tooltip title="Close" placement='bottom' cursor='pointer'>
                                <HighlightOffIcon sx={{ cursor: 'pointer', height: 34, width: 34, opacity: 0.7 }} onClick={handleClose} />
                            </Tooltip>
                        </Box>
                    </Paper>
                    <Box sx={{ overflow: 'auto', pb: 1 }}>
                        <Box sx={{ pt: 1, pl: 1 }}>
                            ...
                            <Box sx={{ display: 'flex', pt: 1 }}>
                                <Box sx={{ flex: 1 }}>
                                    <Box sx={{}}>
                                        <Typography sx={{ fontSize: 12, pl: 0.5, textTransform: 'uppercase' }}>Received The Patient From HDU</Typography>
                                    </Box>
                                ...
                                <Box sx={{ flex: 1, pl: 0.5 }}>
                                    <Box sx={{}}>
                                        <Typography sx={{ fontSize: 12, pl: 0.5, textTransform: 'uppercase' }}>Initial assessment time</Typography>
                                    </Box>
                                    <Box sx={{ pt: 0.5, pl: 1.5 }}>
                                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                                            <DateTimePicker
                                ...
                                <Box sx={{ flex: 1, pl: 0.5 }}>
                                    <Box sx={{}}>
                                        <Typography sx={{ fontSize: 12, pl: 0.5, textTransform: 'uppercase' }}>Procedure Start Time</Typography>
                                    </Box>
                                    <Box sx={{ pt: 0.5, pl: 1.5 }}>
                                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                                            <DateTimePicker
                            ...
                            <Box sx={{ display: 'flex', pt: 1 }}>
                                <Box sx={{ flex: 1 }}>
                                    <Box sx={{}}>
                                        <Typography sx={{ fontSize: 12, pl: 0.5, textTransform: 'uppercase' }}>Procedure End Time</Typography>
                                    </Box>
                                    <Box sx={{ pt: 0.5, pl: 1.5 }}>
                                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                                            <DateTimePicker
                                ...
                                <Box sx={{ flex: 1, pl: 0.5 }}>
                                    <Box sx={{}}>
                                        <Typography sx={{ fontSize: 12, pl: 0.5, textTransform: 'uppercase' }}>SUM OF TIME TAKEN FOR ASSESSMENT</Typography>
                                    </Box>
