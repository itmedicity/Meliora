...
const EmergencyMonthlyReport = ({ viewData, searchDate, dayFlag }) => {
    ...
    return (
        <Fragment>
            {timeFlag === 1 ? <EmerAssessmentModal open={timeModal} handleClose={handleClose} patList={tableData}
                initdate={format(new Date(searchDate), 'MMM-yyyy')} monthFlag={monthFlag}
                returnFlag={returnFlag} /> : null}
