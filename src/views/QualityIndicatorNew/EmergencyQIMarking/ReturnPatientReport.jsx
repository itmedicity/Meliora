                ...
                <CssVarsProvider>
                    <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' stickyFooter hoverRow >
                        <thead style={{ alignItems: 'center' }}>
                            <tr style={{ height: 0.5 }}>
                                <th size='sm' style={{ width: 120, borderRight: '1px solid white', textAlign: 'center', backgroundColor: '#B9B7BD', fontSize: 15 }}>Date</th>
                                <th size='sm' style={{ width: 600, borderRight: '1px solid white', textAlign: 'center', backgroundColor: '#B9B7BD', fontSize: 15 }}>
                                    Return To Emergency Dept Within 72 Hrs With Similar Presenting Complaints</th>
                                <th size='sm' style={{ width: 400, borderRight: '1px solid white', textAlign: 'center', backgroundColor: '#B9B7BD', fontSize: 15 }}>Total No.Of Patients Who Have Come To Emergency</th>
                                <th size='sm' style={{ width: 100, textAlign: 'center', backgroundColor: '#B9B7BD', fontSize: 15 }}>Result</th>
                            </tr>
                        </thead>
                            ...
                            {tableData?.map((val, index) => {
                                return (
                                    < tr key={index} size='small' style={{ maxHeight: 2, cursor: 'pointer' }}>
                                        ...
                                        <td size='sm' style={{ textAlign: 'center', fontSize: 14 }}>{val.returnTot}</td>
