        ...
        <Fragment>
            ...
            < Paper variant='outlined' square >
                <Box sx={{ display: 'flex', flex: 1, height: 40 }}>
                    ...
                    <Box sx={{ flex: 1, fontSize: 18, pt: 1, pl: 0.5, }}>
                        <Typography sx={{ color: '#37474f', fontFamily: 'Arial' }}>
                            {header} Patient&apos;s List
                        </Typography>
                    </Box>
                    {tabFlag === 1 ?
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', fontSize: 20, pr: 0.3, pt: 0.4 }}>
                            <CssVarsProvider>
                ...
                <Box variant="outlined" sx={{ overflow: 'auto', maxHeight: window.innerHeight - 180 }}>
                    <CssVarsProvider>
                        <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' stickyFooter hoverRow >
                            <thead style={{ alignItems: 'center' }}>
                                <tr style={{ height: 0.5 }}>
                                    ...
                                    <th size='sm' style={{ width: 70, backgroundColor: '#78909c', color: 'white', fontSize: 14 }}>&nbsp;Patient ID</th>
                                    <th size='sm' style={{ width: 130, backgroundColor: '#78909c', color: 'white', fontSize: 14 }}>&nbsp;Patient Name</th>
                                    <th size='sm' style={{ width: 80, backgroundColor: '#78909c', color: 'white', fontSize: 14 }}>&nbsp;Age/Gender</th>
                                    <th size='sm' style={{ width: 100, backgroundColor: '#78909c', color: 'white', fontSize: 14 }}>&nbsp;Contacts </th>
                                    <th size='sm' style={{ width: 110, backgroundColor: '#78909c', color: 'white', fontSize: 14 }}>&nbsp;Doctor Name</th>
                                    <th size='sm' style={{ width: 50, backgroundColor: '#78909c', color: 'white', fontSize: 14, textAlign: 'center' }}>&nbsp;Token </th>
                                    <th size='sm' style={{ width: 130, backgroundColor: '#78909c', color: 'white', fontSize: 14 }}>&nbsp;Arrival Time </th>
