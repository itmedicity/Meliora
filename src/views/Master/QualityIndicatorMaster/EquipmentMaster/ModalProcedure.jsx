                        ...
                        <CssVarsProvider>
                            <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' stickyFooter hoverRow >
                                <thead style={{ alignItems: 'center' }}>
                                    <tr style={{ height: 0.5 }}>
                                        <th size='sm' style={{ width: 30, fontWeight: 650, fontSize: 14, textAlign: 'center' }}>&nbsp; Sl.No</th>
                                        <th size='sm' style={{ width: 40, fontWeight: 650, fontSize: 14 }}>&nbsp;Proc Code</th>
                                        <th size='sm' style={{ width: 200, fontWeight: 650, fontSize: 14 }}>&nbsp;Proc Name</th>
                                    </tr>
                                </thead>
                                <tbody size='small'>
                                    {viewProcedures?.map((val, index) => {
                                        return (< tr key={index} size='small'
                                            ...
                                            <td size='sm' style={{ fontSize: 12, height: 5 }}>&nbsp;{val.PD_CODE}</td>
