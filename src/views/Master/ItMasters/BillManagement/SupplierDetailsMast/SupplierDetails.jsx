...
const SupplierDetails = () => {
  ...
  const postdata = useMemo(() => {
    return {
      ...
      it_supplier_saleperson_second_land_two:
        saleSecCheck === true ? it_supplier_land_two : it_supplier_saleperson_second_land_two,
      it_supplier_saleperson_second_mob_one:
        saleSecCheck === true ? it_supplier_mob_one : it_supplier_saleperson_second_mob_one,
      it_supplier_saleperson_second_mob_two:
        saleSecCheck === true ? it_supplier_mob_two : it_supplier_saleperson_second_mob_two,
      it_supplier_saleperson_second_email_one:
        saleSecCheck === true ? it_supplier_email_one : it_supplier_saleperson_second_email_one,
      it_supplier_saleperson_second_email_two:
  ...
  const patchdata = useMemo(() => {
    return {
      ...
      it_supplier_saleperson_email_two:
        it_supplier_saleperson_email_two === null ? '' : it_supplier_saleperson_email_two,
      it_supplier_saleperson_second_name:
  ...
  return (
    <Box>
          ...
          <Box sx={{ flex: 1, bgcolor: '#E2E8EF', p: 1.5 }}>
            <Paper sx={{ flex: 1, borderRadius: 0, p: 2 }}>
              ...
              <Box sx={{ display: 'flex', px: 1.5, pt: 1 }}>
                ...
                <Box sx={{ flex: 1, px: 0.5 }}>
                  <Box sx={{ fontWeight: 600, fontSize: 12, color: '#145DA0', pl: 0.5 }}>
                    Phone No. 2{/* <span style={{ color: '#74112F' }} >*</span> */}
                  </Box>
                  <Box sx={{ fontWeight: 600 }}>
                    <TextFieldCustom
              ...
              <Box sx={{ display: 'flex', px: 1.5, pt: 1 }}>
                ...
                <Box sx={{ flex: 1, px: 0.5 }}>
                  <Box sx={{ fontWeight: 600, fontSize: 12, color: '#145DA0', pl: 0.5 }}>
                    Mobile No. 2{/* <span style={{ color: '#74112F' }} >*</span> */}
                  </Box>
                  <Box sx={{ fontWeight: 600 }}>
                    <TextFieldCustom
              ...
              <Box sx={{ display: 'flex', px: 1.5, pt: 1 }}>
                ...
                <Box sx={{ flex: 1, px: 0.5 }}>
                  <Box sx={{ fontWeight: 600, fontSize: 12, color: '#145DA0', pl: 0.5 }}>
                    Email Id 2{/* <span style={{ color: '#74112F' }} >*</span> */}
                  </Box>
                  <Box sx={{ fontWeight: 600, fontSize: 12 }}>
                    <TextFieldCustom
                      placeholder="example@gmail.com"
            ...
            <Box sx={{ display: 'flex' }}>
              <Paper sx={{ flex: 1, borderRadius: 0, p: 2, mt: 1, mr: 0.5 }}>
                ...
                <Box sx={{ px: 2 }}>
                  <Box sx={{ flex: 1, display: 'flex', justifyContent: 'flex-end' }}>
                    <Box sx={{ fontWeight: 600, fontSize: 12, color: '#0E86D4', pr: 0.5, pb: 0.5 }}>
                      Same as Supplier Details
                    </Box>
                    <CusCheckBox
                      name="imdCheck"
                      value={imdCheck}
                  ...
                  <Box sx={{ fontWeight: 600, fontSize: 12, color: '#145DA0', flex: 1, pl: 0.5 }}>
                    Person Name<span style={{ color: '#74112F' }}>*</span> &nbsp;:
                  </Box>
              ...
              <Paper sx={{ flex: 1, borderRadius: 0, p: 2, mt: 1, ml: 0.5 }}>
                <CssVarsProvider>
                  <Divider
                    sx={{
                      '--Divider-childPosition': `2%`,
      ...
      <Paper sx={{ borderRadius: 0, maxHeight: 600 }}>
        ...
        <Box sx={{ flex: 1, mt: 0.6, px: 1, pb: 0.5 }}>
