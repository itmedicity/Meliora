...
const EscalationTimeMast = () => {
    ...
    //destructuring
    const { esc_activity, esc_responsibility, esc_time_limit, esc_lvl1, esc_lvl2, esc_lvl3, esc_lvl4, esc_top_lvl, esc_slno, esc_status } = escalation
    //state updation
    const updateEscalation = useCallback((e) => {
    ...
    }, [esc_activity, esc_responsibility, esc_time_limit, esc_lvl1, esc_lvl2, esc_lvl3, esc_lvl4, esc_top_lvl, id, esc_status])
    //data set for edit  
    const rowSelect = useCallback((params) => {
        setEdit(1);
        const data = params.api.getSelectedRows()
        const { esc_activity, esc_responsibility, esc_time_limit, esc_lvl1, esc_lvl2, esc_lvl3, esc_lvl4, esc_top_lvl, esc_slno, status } = data[0]
        const frmdata = {
            esc_activity: esc_activity,
            esc_responsibility: esc_responsibility,
    ...
    }, [esc_activity, esc_responsibility, esc_time_limit, esc_lvl1, esc_lvl2, esc_lvl3, esc_lvl4, esc_top_lvl, id, esc_slno, esc_status])

    const submitEscalation = useCallback((e) => {
        e.preventDefault();
        const formreset = {
            esc_activity: '',
            esc_responsibility: '',
