...
const CommonNameStatus = ({ setCrfName, crfName }) => {
    const { hod_name, incharge_name, dms_name, ms_name, mo_name, smo_name, gmo_name, md_name, ed_name, managing_director_name } = crfName
    ...
    return (
        <Box sx={{}}>
            <Paper variant="outlined" sx={{ width: '100%', pl: 0.5, bgcolor: '#f0f3f5' }}>
                <Typography level="body1" sx={{ fontWeight: 500, color: '#4f5d73' }}>Status Name Master</Typography>
            </Paper>
