...
const ApprovalMappingMaster = () => {
    ...
    const { approval_slno, mdStatus, edStatus, manageStatus, mdEmpId, edEmpId, manageEmpId, mdName, edName, manageName, mdNo,
        edNo, manageNo, mdFlag, edFlag, manageFlag } = approvalState
    ...
    const submitCompanyName = useCallback((e) => {
    ...
    const rowSelect = useCallback((val) => {
        setEdit(1)
        const { approval_slno, company_slno, medical_director_approve,
            medical_director_emid, MD_em_no, MD_em_name, executive_director_approve,
            executive_director_emid, ED_em_no, ED_em_name, managing_director_approve,
            managing_director_emid, MA_em_no, MA_em_name } = val
        const formdata = {
            approval_slno: approval_slno,
        ...
        <Fragment>
            <CssVarsProvider>
                <Box sx={{ backgroundColor: "#f0f3f5", border: '1px solid #B4F5F0' }}>
                    <Box sx={{ display: 'flex', }}>
                        <Box sx={{ fontWeight: 550, flex: 1, pl: 1, pt: .5, color: '#385E72', }}>CRF Approval Mapping</Box>
                    ...
                    <Box sx={{ flex: 1 }}>
                        <Box sx={{ display: 'flex' }}>
                            <Box sx={{ width: 600 }}>
                                ...
                                <Box sx={{ pt: 0.5 }}>
                                    <CompanySelect selectedCompany={selectedCompany} setSelectedCompany={setSelectedCompany} companyData={companyData} />
                                </Box>
                            </Box>
                        </Box>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-start', py: 0.2, pl: 1 }}>
                    <Box sx={{ pr: 0.5 }}>
                        <ModalButtomCmp
                            handleChange={submitCompanyName}
                        > Save</ModalButtomCmp>
                    </Box>
                    <Box sx={{ pr: 0.5 }}>
                        <ModalButtomCmp
                            handleChange={refreshWindow}
                        > Refresh</ModalButtomCmp>
                    </Box>
                </Box>
