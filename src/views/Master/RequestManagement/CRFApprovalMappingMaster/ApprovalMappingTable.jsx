        ...
        <Fragment>
            {tabledata.length !== 0 ?
                <Paper variant="outlined" sx={{
                    overflow: 'auto', height: window.innerHeight - 420, flexWrap: 'wrap',
                        ...
                        <Table padding={"none"} stickyHeader borderAxis='both'>
                            <thead style={{ height: 4 }} size='small'>
                                <tr style={{ height: 4 }} size='small'>
                                    ...
                                    <th size='sm' style={{ width: 100, textAlign: 'left' }}>Sl.No</th>
                                    <th size='sm' style={{ width: 200, textAlign: 'left' }}>Company Name</th>
                                    <th size='sm' style={{ width: 200, textAlign: 'left' }}>Medical Director</th>
                                    <th size='sm' style={{ width: 350, textAlign: 'left' }}>Executive Director</th>
                                    <th size='sm' style={{ width: 200, textAlign: 'left' }}>Managing Director</th>
                                </tr>
                            </thead>
