...
const OMEmpMapTable = ({ count, rowSelect }) => {

    const [tabledata, setTabledata] = useState([])
    const [column] = useState([
        { headerName: 'SlNo', field: 'om_emp_slno', minWidth: 100, },
    ...
    useEffect(() => {
        const getmodule = async () => {
            const result = await axioslogin.get('/omempmapping')
...
export default memo(OMEmpMapTable)