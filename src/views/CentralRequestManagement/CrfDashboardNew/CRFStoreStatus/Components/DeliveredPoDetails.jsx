                                ...
                                <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' >
                                    <thead style={{ height: 4 }} size='small'>
                                        <tr style={{ height: 4 }} size='small'>
                                            ...
                                            <th size='sm' style={{ width: 100, textAlign: 'center', backgroundColor: '#e3f2fd' }}>#Order</th>
                                            <th size='sm' style={{ width: 150, textAlign: 'center', backgroundColor: '#e3f2fd' }}>PO Date</th>
                                            <th size='sm' style={{ width: 150, textAlign: 'center', backgroundColor: '#e3f2fd' }}>Store</th>
                                            <th size='sm' style={{ width: 150, textAlign: 'center', backgroundColor: '#e3f2fd' }}>Expected Delivery</th>
                                        </tr>
                                    </thead>
                                    <tbody>
