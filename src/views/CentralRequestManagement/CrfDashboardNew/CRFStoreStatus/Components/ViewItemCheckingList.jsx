                                ...
                                <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' >
                                    <thead style={{ height: 4 }} size='small'>
                                        <tr style={{ height: 4 }} size='small'>
                                            <th size='sm' style={{ width: 50, textAlign: 'center', backgroundColor: '#e3f2fd', fontSize: 13 }}>Sl.No</th>
                                            <th size='sm' style={{ width: 100, textAlign: 'center', backgroundColor: '#e3f2fd', fontSize: 13 }}>Item Code</th>
                                            <th size='sm' style={{ width: 300, textAlign: 'center', backgroundColor: '#e3f2fd', fontSize: 13 }}>Item Name</th>
                                            <th size='sm' style={{ width: 100, textAlign: 'center', backgroundColor: '#e3f2fd', fontSize: 13 }}>Delivered Qty</th>
                                            <th size='sm' style={{ width: 100, textAlign: 'center', backgroundColor: '#e3f2fd', fontSize: 13 }}>Damage Qty</th>
                                            <th size='sm' style={{ width: 100, textAlign: 'center', backgroundColor: '#e3f2fd', fontSize: 13 }}>Excess Qty</th>
                                            <th size='sm' style={{ width: 150, textAlign: 'center', backgroundColor: '#e3f2fd', fontSize: 13 }}>Checked Time</th>
                                        </tr>
                                    </thead>
                                    <tbody>
