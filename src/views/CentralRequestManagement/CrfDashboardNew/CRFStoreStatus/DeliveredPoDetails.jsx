                                ...
                                <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' >
                                    <thead style={{ height: 4 }} size='small'>
                                        <tr style={{ height: 4 }} size='small'>
                                            <th size='sm' style={{ width: 50, textAlign: 'center', backgroundColor: '#5885AF', color: 'white' }}>Sl.No</th>
                                            <th size='sm' style={{ width: 100, textAlign: 'center', backgroundColor: '#5885AF', color: 'white' }}>#Order</th>
                                            <th size='sm' style={{ width: 150, textAlign: 'center', backgroundColor: '#5885AF', color: 'white' }}>PO Date</th>
                                            <th size='sm' style={{ width: 150, textAlign: 'center', backgroundColor: '#5885AF', color: 'white' }}>Store</th>
                                            <th size='sm' style={{ width: 150, textAlign: 'center', backgroundColor: '#5885AF', color: 'white' }}>Expected Delivery</th>
                                        </tr>
                                    </thead>
                                    <tbody>
