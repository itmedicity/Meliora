...
const StoreAckTableView = ({ setackFlag, disData, heading, userAckFlag }) => {
                        ...
                        {disData.length !== 0 ?
                            <Box sx={{ width: '100%' }}>
                                <Box display="flex" justifyContent="space-between" sx={{
                                    ...
                                    <Typography sx={{ width: 200, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>Req.Dpt</Typography>
                                    <Typography sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>Store</Typography>
                                    {userAckFlag === 1 ?
                                        <>
                                            <Typography sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>Remarks</Typography>
                                            <Typography sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>Ack Date</Typography>
                                            <Typography sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>User</Typography>
                                            <Typography sx={{ width: 100, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>Received or Not</Typography>
                                        </>
                                        : userAckFlag === 2 ?
                                            <>
                                                <Typography sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>Remarks</Typography>
                                                <Typography sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>Received Date</Typography>
                                                <Typography sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, color: 'white' }}>User</Typography>
                                            </>
                                            : null}
                                    <Typography sx={{ width: 80, textAlign: 'center', fontWeight: 550, fontSize: 12, color: 'white' }}></Typography>
                                </Box>
                                <Virtuoso
                                    ...
                                    itemContent={(index, val) => (
                                        <React.Fragment key={index}>
                                            <Box display="flex" justifyContent="space-between" sx={{ borderBottom: '1px solid lightgrey', flexWrap: 'nowrap' }}>
                                                ...
                                                {userAckFlag === 1 ?
                                                    <>
                                                        <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>{val.substore_remarks}</Typography>
                                                        <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>{format(new Date(val.substore_ack_date), 'dd-MM-yyyy hh:mm:ss a')}</Typography>
                                                        <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>{val.store_user}</Typography>
                                                        <Typography sx={{ width: 100, textAlign: 'left', fontSize: 12, my: 1 }}>{val.received_status === 1 ? 'Received' : 'Not Received'}</Typography>
                                                    </>
                                                    : userAckFlag === 2 ?
                                                        <>
                                                            <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>{val.received_user_remarks}</Typography>
                                                            <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>{format(new Date(val.received_date), 'dd-MM-yyyy hh:mm:ss a')}</Typography>
                                                            <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>{val.receive_user}</Typography>
                                                        </>
                                                        : null}
