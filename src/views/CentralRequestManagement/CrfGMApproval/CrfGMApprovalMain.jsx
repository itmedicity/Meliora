...
import { AllListForGMApi, CloseListApi, OnHoldListApi, RejectListApi, getGMAppvalPending } from '../ComonComponent/ComonFunctnFile'
...
const CrfGMApprovalMain = () => {
    ...
    const updateRadioClick = useCallback(async (e) => {
        ...
        if (e.target.value === '1') {
            ...
            AllListForGMApi(setDisArray, setOpen)
