...
const CrfGMApprovalModal = ({ open, ApprovalData, setApprovalModal, setApprovalFlag, count, setCount, setApprovalData }) => {
    ...
    useEffect(() => {
        ...
        setRemark(gm_approve_remarks)
        setDetailAnalis(gm_detial_analysis)
    ...
    const submit = useCallback(() => {
        const updateInchargeApproval = async (DMSPatchData) => {
            const result = await axioslogin.patch('/CRFRegisterApproval/Gm', DMSPatchData);
        ...
        if (approve !== false || reject !== false || pending !== false) {
            if (approve === true && detailAnalis !== '' && remark !== '') {
                updateInchargeApproval(DMSPatchData)
            }
    ...
    }, [approve, reject, pending, remark, detailAnalis, DMSPatchData, setCount, count, reset])
