...
const CommonDmsApprvCmp = ({ DetailViewData, company }) => {
  const { req_slno, dms_approve, dms, dms_remarks, dms_detail_analysis, dms_approve_date, dms_user, dms_image } = DetailViewData
            ...
            <Box sx={{ display: 'flex', py: 1 }}>
              ...
              <Box sx={{ display: 'flex', flex: 1 }}>
                ...
                <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                  {format(new Date(dms_approve_date), 'dd-MM-yyyy hh:mm:ss a')}
                </Typography>
                {dms_image === 1 ? (
