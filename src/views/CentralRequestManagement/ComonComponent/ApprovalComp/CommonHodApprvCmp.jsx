...
const CommonHodApprvCmp = ({ DetailViewData, company }) => {
  const { req_slno, hod_approve, hod, hod_detial_analysis, hod_approve_date, hod_remarks, hod_user, hod_image } = DetailViewData
            ...
            <Box sx={{ display: 'flex', py: 1 }}>
              ...
              <Box sx={{ display: 'flex', flex: 1 }}>
                ...
                <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                  {format(new Date(hod_approve_date), 'dd-MM-yyyy hh:mm:ss a')}
                </Typography>
                {hod_image === 1 ? (
