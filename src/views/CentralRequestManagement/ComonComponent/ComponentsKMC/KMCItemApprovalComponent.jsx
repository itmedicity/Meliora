                        ...
                        <tr style={{ cursor: 'pointer' }}>
                          <td>
                            {item.po_item_status === 1 || item.higher === 1 ? (
                              <CustomToolTipForCRF
                                title={item.po_item_status === 1 ? 'PO generated' : 'Cant Edit'}
                                placement="right"
                                sx={{ bgcolor: 'white', color: '#003060' }}
                              >
                                <EditOutlinedIcon
                                  disabled
                                  sx={{
          ...
          <Box sx={{ px: 0.5 }}>
            ...
            <Box sx={{ display: 'flex', pt: 0.5, pb: 1 }}>
              ...
              <Box sx={{ flex: 0.6, pl: 0.5, pt: 0.4 }}>
                ...
                <UomApprvSelect uom={uom} setUOM={setUOM} />
              </Box>
              <Box sx={{ flex: 1 }}>
        ...
        {rejHoldRemarkFlag === 1 ? (
          <Box sx={{ display: 'flex' }}>
            ...
            <Box sx={{ flex: 0.2, m: 0.4 }}>
              <CustomIconButtonCmp handleChange={RejectfctnUpdate}>Update</CustomIconButtonCmp>
            </Box>
          </Box>
        ) : rejHoldRemarkFlag === 2 ? (
          <Box sx={{ display: 'flex' }}>
            ...
            <Box sx={{ flex: 0.2, m: 0.4 }}>
              <CustomIconButtonCmp handleChange={onHoldfctnUpdate}>Update</CustomIconButtonCmp>
            </Box>
          </Box>
        ) : null}
      </Box>
