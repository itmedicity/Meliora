...
const ClosedDetailsModal = ({ open, CloseData, setCloseData, setCloseModal, setCloseFlag }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, expected_date, incharge_approve, incharge_req,
        ...
        crf_close_remark, crf_closed_one, close_date, closed_user
    } = CloseData
    ...
    const ModalClose = useCallback(() => {
        ...
        setCloseModal(false)
        setCloseData([])
    }, [setCloseFlag, setCloseModal, setCloseData])
                ...
                >
                    ...
                    <Box sx={{ width: "100%", mt: 0, display: "flex", flexDirection: "column" }}>
                        ...
                        <Box sx={{ width: "100%", mt: 0, }}>
                            ...
                            {dms_approve !== null ? <Box sx={{ width: "100%", mt: 0 }}>
                                <Paper variant='outlined' sx={{ mt: 1 }} >
                                    <Box sx={{
                                        width: "100%",
                                        display: "flex",
                            ...
                            {
                                ms_approve !== null ? <Box sx={{ width: "100%", mt: 0 }}>
                                    <Paper variant='outlined' sx={{ mt: 1 }} >
                                        <Box sx={{
                                            width: "100%",
                                            display: "flex",
                            ...
                            {
                                md_approve !== null ? <Box sx={{ width: "100%", mt: 0 }}>
                                    <Paper variant='outlined' sx={{ mt: 1 }} >
                                        <Box sx={{
                                            width: "100%",
                                            display: "flex",
                                            ...
                                            {md_image === 1 ? <Box sx={{ display: 'flex', width: "20%", height: 35, pl: 3, pt: 0.5, pb: 0.5 }}>
                                                <Button onClick={ViewMDUploadImage} variant="contained"
                                                    color="primary">View Image</Button>
                                            </Box> : null}
                                        </Box>
                                    </Paper>
                                ...
                                <Paper variant='outlined' sx={{ mt: 1 }} >
                                    <Box sx={{
                                        ...
                                        <Box
                                            ...
                                            <CssVarsProvider>
                                                <Typography sx={{ fontSize: 15, fontWeight: 600 }} >Closed Remarks: </Typography>
                                                <Typography ml={5} sx={{ fontSize: 15 }} >{crf_close_remark} </Typography>
                                            </CssVarsProvider>
                                        </Box>
                                        ...
                                        <Box
                                            ...
                                            <CssVarsProvider>
                                                <Typography sx={{ fontSize: 15, fontWeight: 600 }} >Closed By: </Typography>
                                                <Typography ml={10} sx={{ fontSize: 15 }} >{crf_closed_one} </Typography>
                                            </CssVarsProvider>
                                        </Box>
                                        ...
                                        <Box
                                            ...
                                            <CssVarsProvider>
                                                <Typography sx={{ fontSize: 15, fontWeight: 600 }} >Closed User: </Typography>
                                                <Typography ml={8} sx={{ fontSize: 15 }} >{closed_user} </Typography>
                                            </CssVarsProvider>
                                        </Box>
                                        ...
                                        <Box
                                            ...
                                            <CssVarsProvider>
                                                <Typography sx={{ fontSize: 15, fontWeight: 600 }} >Closed Date: </Typography>
                                                <Typography ml={8} sx={{ fontSize: 15 }} >{close_date} </Typography>
                                            </CssVarsProvider>
                                        </Box>
