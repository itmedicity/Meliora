...
const GMApproveViewForHigher = ({ DetailViewData, selectedCompany, company }) => {
  const { req_slno, gm_approve, gm, gm_approve_remarks, gm_detial_analysis, gm_approv_date, gm_user, gm_image } =
    DetailViewData
          ...
          {gm_approve === 1 && gm_approve_remarks !== null ? (
            <Box sx={{ pt: 0.5 }}>
              ...
              <Box sx={{ display: 'flex', pt: 1 }}>
                ...
                <Typography sx={{ pl: 0.5 }}> :&nbsp;</Typography>
                <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, flex: 1, pr: 0.5, pt: 0.3 }}>
                  {gm_detial_analysis === null ? 'Not Updated' : gm_detial_analysis}
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: 'flex', py: 1 }}>
              ...
              <Box sx={{ display: 'flex', flex: 1 }}>
                ...
                <Typography sx={{ height: 'auto', fontSize: 13, fontWeight: 550, pl: 2, pt: 0.3 }}>
                  {format(new Date(gm_approv_date), 'dd-MM-yyyy hh:mm:ss a')}
                </Typography>
                {gm_image === 1 ? (
