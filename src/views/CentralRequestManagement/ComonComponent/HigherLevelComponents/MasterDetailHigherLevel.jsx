          ...
          <Box sx={{ flex: 0.7, borderRight: '1px solid lightgray', flexWrap: 'wrap' }}>
            <Box sx={{ ml: 1, mt: 0.5 }}>
              <Typography sx={{ fontSize: 15, color: '#003060', fontWeight: 'bold' }}>
                {selectedCompany === '2' ? `CRF/KMC/${req_slno}` : `CRF/${company_name}/${req_slno}`}
              </Typography>
            </Box>
            <Box sx={{ ml: 1, mt: 0.5 }}>
              <Typography sx={{ fontSize: 12, color: '#003060' }}>
                {format(new Date(req_date), 'dd-MM-yyyy hh:mm:ss a')}
              </Typography>
            </Box>
            <Box sx={{ ml: 1, mt: 0.5 }}>
              <Typography
          ...
          {emergency_flag === 1 ? (
            <Box sx={{ flex: 0.6, textAlign: 'center', borderRight: '1px solid lightgray' }}>
              ...
              <Typography sx={{ fontSize: 11, color: '#b71c1c', pt: 0.2 }}>
                {emergeny_remarks !== null ? capitalizeWords(emergeny_remarks) : null}
              </Typography>
            </Box>
          ) : null}
