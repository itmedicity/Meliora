...
const TopDesignForHigherlevel = ({ pendingData, radiovalue, setRadioValue, allData, setDisData, getPendingData, getApprovalData,
    ...
    const updateRadioClick = useCallback(async (e) => {
        ...
        ClearSearch()
    }, [setRadioValue, getPendingData, getApprovalData, getProcurementData, getInventoryData, getuserAckData, getHoldData,
        getRejectData, ClearSearch])

    const updateItemRadioClick = useCallback(async (e) => {
        e.preventDefault()
            ...
            <Box sx={{ flexWrap: 'wrap', }}>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', bgcolor: '#E3EFF9', border: '0.4px solid #B4F5F0', borderTop: 'none' }}>
                    ...
                    >
                        ...
                        />
                        <FormControlLabel value='3' sx={{ pl: 1 }}
                            control={
                                <Radio
                                    sx={{
                                        color: '#0d47a1',
                        ...
                        />
                        <FormControlLabel value='4' sx={{ pl: 1 }} control={
                            <Radio
                                sx={{
                                    color: '#887BB0',
                                    '&.Mui-checked': {
                        ...
                        <FormControlLabel value='5' sx={{ pl: 1 }} control={
                            <Radio
                                sx={{
                                    color: '#116530',
                                    '&.Mui-checked': {
                    ...
                    <RadioGroup
                        sx={{
                            pt: 1, flex: '1 1 auto', bgcolor: '#D4F1F4', borderLeft: '1px solid lightgrey',
                        }}
                        row
                        aria-labelledby="demo-row-radio-buttons-group-label"
                        name="row-radio-buttons-group"
                        ...
                        onChange={(e) => updateRadioClick(e)}
                    >
                        <FormControlLabel value='6' sx={{ pl: 1 }} control={
                            <Radio
                                sx={{
                                    color: '#F7AC32',
                                    '&.Mui-checked': {
                        ...
                        <FormControlLabel value='7' sx={{ pl: 1 }} control={
                            <Radio
                                sx={{
                                    color: '#BA0F30',
                                    '&.Mui-checked': {
                        ...
                        <FormControlLabel value='8' sx={{ pl: 1 }} control={
                            <Radio
                                sx={{
                                    color: '#DF362D',
                                    '&.Mui-checked': {
                ...
                {radiovalue === '8' ?
                    <Paper sx={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', p: 0.5 }}>
                        <Box sx={{ display: 'flex', pl: 0.5, pb: 0.5 }}>
                            <Typography sx={{ fontSize: 14, color: '#0d47a1', pt: 1.7, pr: 1, fontWeight: 550 }}>Closed Date :</Typography>
                    ...
                    <Paper sx={{}}>
                        {radiovalue === '6' || radiovalue === '7' ?
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', borderBottom: '1px solid lightgrey' }}>
                                ...
                                >
                                    <FormControlLabel value='1' sx={{ pl: 1 }} control={
                                        <Radio
                                            sx={{
                                                color: '#BA0F30',
                                                '&.Mui-checked': {
                                        ...
                                        />} label="CRF" />
                                    <FormControlLabel value='2' sx={{ pl: 1 }} control={
                                        <Radio
                                            sx={{
                                                color: '#F7AC32',
                                                '&.Mui-checked': {
                                        ...
                                        <CssVarsProvider>
                                            <CustomInputDateCmp
                                                StartIcon={<Box sx={{ display: 'flex', alignItems: 'center' }}>
                                                    ...
                                                    <Typography sx={{ fontSize: '13px', color: '#0063C5' }}>  {selectedCompany === '2' ? 'CRF/KMC/' : `CRF/${company?.company_name}/`}                                                    </Typography>
                                                </Box>}
                                                className={{
