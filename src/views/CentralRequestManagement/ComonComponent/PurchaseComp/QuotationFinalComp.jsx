        ...
        <Box sx={{ display: 'flex', mx: 0.3, p: 1 }}>
          ...
          <Box sx={{ flex: 1, display: 'flex' }}>
            ...
            <Typography sx={{ fontSize: 12, flex: 1, fontWeight: 550, pt: 0.2 }}>
              {quatation_fixing_remarks === null ? 'Not Updated' : quatation_fixing_remarks}
            </Typography>
            <Typography
              sx={{
                display: 'flex',
            ...
            >
              {capitalizeWords(quatation_fixuser)}&nbsp; /
            </Typography>
            <Typography
              sx={{
                pr: 2,
            ...
            >
              {format(new Date(quatation_fixing_date), 'dd-MM-yyyy hh:mm:ss a')}
            </Typography>
          </Box>
        </Box>
      </Paper>
