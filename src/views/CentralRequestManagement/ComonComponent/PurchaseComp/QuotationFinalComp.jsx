...
const QuotationFinalComp = ({ poData }) => {
    const { quatation_fixuser, quatation_fixing_remarks, quatation_fixing_date } = poData
        ...
        <Fragment>
            <Paper variant="outlined" sx={{ overflow: 'auto', flexWrap: 'wrap', }}>
                ...
                <Box sx={{ display: 'flex', mx: 0.3, p: 1 }}>
                    <Typography sx={{ fontSize: 14, flex: 0.3 }}>Remarks</Typography>
                    <Box sx={{ flex: 1, display: 'flex' }}>
                        <Typography sx={{ fontSize: 12, flex: 1 }}>: &nbsp;{quatation_fixing_remarks === null ? 'Not Updated' : quatation_fixing_remarks}</Typography>
                        <Typography sx={{
                            display: 'flex', flex: 1, justifyContent: 'flex-end', fontSize: 12,
...
export default memo(QuotationFinalComp)