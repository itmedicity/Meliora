...
const DataCollectionSave = ({ flag, val, empdeptsec, selectedCompany, depkmc }) => {
  ...
  }, [setDataEnterViewFlag, setDataEnterViewModal, setDataEnterViewData, val, selectedCompany])
  ...
  return (
    <Fragment>
      ...
      {dtaEnterViewFlag === 1 ? (
        <DataCollectionViewModal
          open={dtaEnterViewModal}
          handleClose={handleClose}
          flag={flag}
          dtaEnterViewData={dtaEnterViewData}
          reqItems={reqItems}
          approveTableData={approveTableData}
          reqData={val}
          imagearray={imagearray}
      ...
      >
        <Box sx={{ pl: 2, p: 0.6 }}>
          {flag === 1 ? (
            <Button
              variant="contained"
              startIcon={<SaveAsIcon sx={{ height: 19, width: 19, color: '#0277bd' }} />}
              sx={buttonstyle}
              onClick={ActionFctn}
            >
              Action
            ...
            <Button
              variant="contained"
              startIcon={<PreviewIcon sx={{ height: 19, width: 19, color: '#0277bd' }} />}
              sx={buttonstyle}
              onClick={ViewFctn}
            >
              View
