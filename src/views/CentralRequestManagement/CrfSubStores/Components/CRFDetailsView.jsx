import { Box, CssVarsProvider, Modal, ModalClose, ModalDialog, Table, Textarea, Typography } from '@mui/joy'
                        ...
                        <Paper variant="outlined" sx={{ flexWrap: 'wrap' }}>
                            <Box
                                ...
                                <Box sx={{ display: 'flex' }}>
                                    ...
                                    <Box sx={{ pt: 0.5, flex: 2 }}>
                                        <CssVarsProvider>
                                            <Textarea sx={{ fontSize: 12 }}
                                                readOnly
                                                minRows={1}
                                                maxRows={3}
                                                type="text"
                                                size="sm"
                                                name="actual_requirement"
                                                value={actual_requirement === null ? 'nil' : actual_requirement}
                                            />
                                        </CssVarsProvider>
                                    </Box>
                                </Box>
                            ...
                            <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' >
                                <thead style={{ height: 4 }} size='small'>
                                    <tr style={{ height: 4 }} size='small'>
                                        ...
                                        <th size='sm' style={{ width: 80, textAlign: 'center', backgroundColor: '#EBEBE8' }}>Qnty</th>
