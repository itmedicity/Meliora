                                ...
                                <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' >
                                    <thead>
                                        <tr>
                                            ...
                                            <th size='sm' style={{ width: 80, textAlign: 'center', backgroundColor: '#e3f2fd' }}>Qnty</th>
                                            ...
                                            <th size='sm' style={{ borderRadius: 0, width: 100, textAlign: 'center', backgroundColor: '#e3f2fd' }}>Approx.cost</th>
                                        </tr>
                                    </thead>
                                    <tbody>
