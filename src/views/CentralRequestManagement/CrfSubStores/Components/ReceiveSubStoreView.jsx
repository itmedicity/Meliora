...
const ReceiveSubStoreView = ({ tableData, selectedRadio, storeName, setSelectedRadio, setStoreName, company,
    ...
    const { data: returnList, isLoading: isReturnLoading, error: returnError } = useQuery({
    ...
    return (
        <Fragment>
            ...
            {returnFlag === 1 ? <ReturnViewDetails setReturnModalData={setReturnModalData} returnModalData={returnModalData}
                handleClose={handleCloseReturn} open={retrunModal} /> : null}
            <Box>
                {tableData.length !== 0 ?
                    <Box variant="outlined" sx={{
                        ...
                        <Paper elevation={3} sx={{ width: '100%' }}>
                            ...
                            >
                                ...
                                {returnData.length > 0 ? <Typography sx={{ width: 30, textAlign: 'center', fontWeight: 550, fontSize: 12 }}> Return</Typography> : null}
                                    ...
                                    <React.Fragment key={index}>
                                        <Box display="flex" justifyContent="space-between" sx={{ borderBottom: '1px solid lightgrey', cursor: 'pointer' }} >
                                            ...
                                            {returnData.length > 0 ?
                                                ...
                                                : null}
                                            <Box sx={{ width: 30, textAlign: 'center', cursor: 'pointer', display: 'flex', mr: 2 }}>
