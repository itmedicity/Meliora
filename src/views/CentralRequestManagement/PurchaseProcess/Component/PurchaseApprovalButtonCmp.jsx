  ...
  return (
    <Fragment>
      {puchaseFlag === 2 ? (
        ...
        <PurchaseModal
          open={puchaseModal}
          puchaseData={puchaseData}
          poModalClose={poModalClose}
          ...
          newlyApprvdItems={newlyApprvdItems}
          company={company}
        />
      ) : null}

      {imageshowFlag === 1 ? (
        <ImageDisplayModal open={imageshow} handleClose={handleClose} images={allImageList} />
      ) : null}
      <Box
        sx={{
          display: 'flex',
