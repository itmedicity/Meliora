  ...
  const AddToTable = useCallback(() => {
    ...
    if (array.length === 0) {
      const podDatas = {
        ...
        storeName: storeName,
        expected_delivery:
          expected_delivery !== (null || undefined)
            ? format(new Date(expected_delivery), 'yyyy-MM-dd')
      ...
      >
        <ModalDialog variant="outlined">
          ...
          <Paper
            variant="outlined"
            square
            sx={{ display: 'flex', height: 40, bgcolor: '#41729F', flexWrap: 'wrap', m: 1 }}
          >
                    ...
                    >
                      <thead style={{ alignItems: 'center' }}>
                        <tr style={{ height: 0.5 }}>
                          ...
                          <th size="sm" style={{ width: 80, fontSize: 14 }}>
                            &nbsp;Item Code
                          </th>
                          <th size="sm" style={{ width: 250, fontSize: 14 }}>
                            &nbsp;Item
                          </th>
                          <th size="sm" style={{ width: 80, fontSize: 14 }}>
                            &nbsp;Qnty
          ...
          <Box sx={{ display: 'flex', justifyContent: 'flex-end', pb: 1 }}>
            <Box sx={{ pt: 1, px: 0.5 }}>
              <CssVarsProvider>
                {existFlag === 0 ? (
                  <Button variant="outlined" sx={buttonStyle} onClick={AddDetails}>
                    Add
                  </Button>
                ) : (
                  <Button variant="outlined" sx={buttonStyle} onClick={AddToTable}>
                    Add
                  </Button>
                )}
              </CssVarsProvider>
            ...
            <Box sx={{ pt: 1, pr: 1 }}>
              <CssVarsProvider>
                <Button variant="outlined" sx={buttonStyle} onClick={CancelData}>
                  Cancel
                </Button>
              </CssVarsProvider>
            </Box>
