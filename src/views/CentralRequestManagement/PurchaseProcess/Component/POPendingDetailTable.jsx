...
const POPendingDetailTable = ({ pendingPOList }) => {
  ...
  const viewPOItemDetails = useCallback(
    indexvalue => {
  ...
  const POtoSupplierUpdate = useCallback(
    (aprrvdStatus, po_detail_slno) => {
      if (aprrvdStatus === 3) {
          ...
          >
            <Paper sx={{ width: 1640 }}>
              ...
              >
                ...
                <Typography sx={{ width: 180, textAlign: 'center', fontWeight: 550, fontSize: 12 }}>
                  Approval Status
                </Typography>
                <Typography
                  sx={{ width: 150, textAlign: 'left', fontWeight: 550, fontSize: 12, pl: 1 }}
                ></Typography>
                <Typography
                  sx={{ width: 30, textAlign: 'left', fontWeight: 550, fontSize: 12, mr: 2 }}
                ></Typography>
              </Box>
              <Virtuoso
                ...
                itemContent={(index, val) => (
                  <React.Fragment key={val.slno}>
                    ...
                    >
                      ...
                      >{`CRF/${val?.company_name}/${val?.req_slno}`}</Typography>
                        ...
                        <CssVarsProvider>
                          {val.aprv_status === 3 || val.aprv_status === 4 ? (
                            <IconButton
                              ...
                              onClick={() =>
                                POtoSupplierUpdate(val.aprv_status, val.po_detail_slno)
                              }
                            >
                              PO to Supplier
                              <TelegramIcon
                                sx={{ height: 20, width: 20, color: '#1565c0', ml: 1 }}
                              />
                            </IconButton>
                          ) : (
                            <IconButton
                    ...
                    {expandedRow === index && (
                      <Box sx={{ mx: 1, pt: 0.5, boxShadow: '0px 8px 10px rgba(0, 0, 0, 0.16)' }}>
                        ...
                        >
                          <Typography
                            sx={{ width: 40, textAlign: 'center', fontWeight: 550, fontSize: 13 }}
                          >
                            Sl.No
                          </Typography>
                          <Typography sx={{ width: 70, fontWeight: 550, fontSize: 13 }}>
                            Item Code
                          </Typography>
                          <Typography sx={{ width: 350, fontWeight: 550, fontSize: 13 }}>
                            Item
                          </Typography>
                          <Typography sx={{ width: 50, fontWeight: 550, fontSize: 13 }}>
                            Qnty
                          </Typography>
                          <Typography sx={{ width: 60, fontWeight: 550, fontSize: 13 }}>
                            Rate
                          </Typography>
                          <Typography sx={{ width: 70, fontWeight: 550, fontSize: 13 }}>
                            MRP
                          </Typography>
                          <Typography sx={{ width: 80, fontWeight: 550, fontSize: 13 }}>
                            Tax
                          </Typography>
                          <Typography sx={{ width: 100, fontWeight: 550, fontSize: 13 }}>
                            Tax Amount
                          </Typography>
                          <Typography sx={{ width: 100, fontWeight: 550, fontSize: 13 }}>
                            Net Amount
                        ...
                        {val.items.map((item, itemIndex) => (
                          ...
                          >
                            <Typography sx={{ width: 40, textAlign: 'center', fontSize: 12 }}>
                              {itemIndex + 1}
                            </Typography>
                            <Typography sx={{ width: 70, fontSize: 12 }}>
                              {item.item_code}
                            </Typography>
                            <Typography sx={{ width: 350, fontSize: 12 }}>
                              {item.item_name}
                            </Typography>
                            <Typography sx={{ width: 50, fontSize: 12 }}>
                              {item.item_qty}
                            </Typography>
                            <Typography sx={{ width: 60, fontSize: 12 }}>
