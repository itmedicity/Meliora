...
const PurchaseTablemain = () => {
      ...
      if (apprvData) {
        const poLIst = apprvData
          ...
          .map((po, ind) => ({
            ...
            expected_delvery: po.expected_delivery
  ...
  if (
    ...
    return <p>Loading...</p>
  if (ackError || quoError || apprvError || storeError || dcError || compError || viewcompError)
