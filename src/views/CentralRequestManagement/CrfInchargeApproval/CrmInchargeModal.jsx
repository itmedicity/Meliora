...
const CrmInchargeModal = ({ open, ApprovalData, setApprovalModal, setApprovalFlag, count, setCount, setApprovalData }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, expdate, incharge_approve,
        incharge_remarks, inch_detial_analysis, hod_approve } = ApprovalData
                                    ...
                                    <Box sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <Box
                                                sx={{ pr: 9 }}>
                                                <CssVarsProvider>
                                                    <Typography sx={{ fontWeight: 900, fontSize: 14, color: TypoHeadColor }} >Incharge Approval</Typography>
                                                </CssVarsProvider>
                                            </Box>
