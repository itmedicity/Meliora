...
const ApproveButtonComponentIncharge = ({ setApprovalFlag, setApprovalModal, setCancelFlag, setCancelModal, setApprovalData,
    ...
    }, [setApprovalFlag, setApprovalModal, val, setApprovalData, setPoDetails, setApproveTableData,
        setReqItems, queryClient, deptsecArry, setImageArry])
    ...
    const CloseFnctn = useCallback(() => {
        ...
        setCancelData(val)
        queryClient.invalidateQueries(['inchargeHodCrfList', deptsecArry]);
    }, [setCancelFlag, setCancelModal, setCancelData, val, queryClient, setPoDetails, setApproveTableData,
        setReqItems, deptsecArry, setImageArry])
