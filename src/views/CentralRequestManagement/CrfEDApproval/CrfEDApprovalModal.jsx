...
const CrfEDApprovalModal = ({ open, ApprovalData, reqItems, handleClose, setApproveTableData, approveTableData, company,
    ...
    const { req_slno, incharge_req, incharge_remarks, hod_req, hod_approve, dms_req, dms_approve, ms_approve,
        ...
        ed_approve_remarks, ed_detial_analysis, ed_image, actual_requirement, request_deptsec_slno, req_deptsec, needed, expected_date,
    } = ApprovalData
    ...
    const postdata = {
        ...
        complaint_desc: "The complaint was raised by ED  with the remark \"" + remark + "\" under CRF No: " + req_slno + " regarding the items , which has to be internally arranged.",
    ...
    const insertMastTask = {
        ...
        tm_task_description: "The task is to arrange for \"" + needed + "\"concerning the items metioned in CRF No :" + req_slno + " By ED ",
