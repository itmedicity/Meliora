...
const ManagingDirectorModal = ({ open, ApprovalData, reqItems, handleClose, setApproveTableData, approveTableData, company,
    ...
    const { req_slno, incharge_req, incharge_remarks, hod_req, hod_approve, dms_req, dms_approve, ms_approve,
        ms_approve_req, manag_operation_approv, senior_manage_approv, gm_approve, md_approve, req_deptsec, needed, expected_date, actual_requirement,
        managing_director_approve, managing_director_remarks, managing_director_analysis, managing_director_image, company_slno, request_deptsec_slno
    } = ApprovalData
    ...
    const postdata = {
        ...
        complaint_desc: "The complaint was raised by  Managing director with the remark \"" + remark + "\" under CRF No: " + req_slno + " regarding the items , which has to be internally arranged.",
    ...
    const insertMastTask = {
        ...
        tm_task_description: "The task is to arrange for \"" + needed + "\"concerning the items metioned in CRF No :" + req_slno + " By Managing director",
    ...
    }, [managPatchData, reset, datacollFlag, datacolectremark, crfdept, id, req_slno, selectFile, queryClient, internallyArr, datacollFlagKMC, postdata, crfHod,
