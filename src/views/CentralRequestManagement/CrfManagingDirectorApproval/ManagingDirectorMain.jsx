...
import ManagingDirectorModal from './ManagingDirectorModal'
...
import ApproveButtonComponentManag from './ApproveButtonComponentManag'
import CRFCloseManage from './CRFCloseManage'
...
const ManagingDirectorMain = () => {
    ...
    }, [manageData, radiovalue, selectedCompany, manageDataKmc]);
    ...
    const getCloseData = useCallback(() => {
        const fetchClosmanageDetails = async () => {
            try {
                if (selectedCompany === '1') {
                            ...
                            itemContent={(index, val) =>
                                <Box key={index} sx={{
                                    ...
                                    {radiovalue === '8' ?
                                        ...
                                        :
                                        <ApproveButtonComponentManag val={val} setApprovalFlag={setApprovalFlag}
...
export default memo(ManagingDirectorMain)