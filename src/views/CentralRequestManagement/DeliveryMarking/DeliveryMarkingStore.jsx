...
const DeliveryMarkingStore = () => {
  ...
  const addBillDetails = useCallback(() => {
    if (billNumber === '') {
      ...
      if (editIndex !== null) {
        const updatedData = billDetails.map((val, index) => (index === editIndex ? newdata : val))
        ...
        <CssVarsProvider>
          ...
          {viewFlag === 1 ? (
            <DeliveryMarkingView
              ...
              setimageshowFlag={setimageshowFlag}
            ...
            >
              <Box sx={{ display: 'flex', justifyContent: 'flex-end', pt: 1 }}>
                <Typography sx={{ fontSize: 14, color: '#1565c0', pr: 1 }}>
                  Delivery Chellan Marking Date &nbsp; :
                </Typography>
                <Typography sx={{ fontSize: 13, color: '#1565c0', fontWeight: 650, pr: 2 }}>
                ...
                <Box sx={{ pt: 1, width: { xs: '100%', md: '60vw', lg: '50vw', xl: '50vw' } }}>
                  <Box sx={{ px: 1 }}>
                    <Box sx={{ pl: 1, fontSize: 12 }}>
                      DC RECEIVED DATE <KeyboardArrowDownIcon fontSize="small" />
                    </Box>
                    <Box sx={{ pt: 0.5 }}>
                      <CustomInputDateCmp
                  ...
                  {searchFlag === 1 ? (
                    <>
                      <Box sx={{ pt: 1, px: 1 }}>
                        <Box sx={{ pl: 1, fontSize: 12 }}>
                          MODE OF TRANSPORT <KeyboardArrowDownIcon fontSize="small" />
                        </Box>
                      ...
                      <Box sx={{ display: 'flex', flex: 1, px: 1 }}>
                        <Box sx={{ pt: 1, width: '46%' }}>
                          <Box sx={{ pl: 1, fontSize: 12 }}>
                            DC/BILL NO. <KeyboardArrowDownIcon fontSize="small" />
                          </Box>
                        ...
                        <Box sx={{ pt: 1, pl: 0.5, width: '46%' }}>
                          <Box sx={{ pl: 1, fontSize: 12 }}>
                            DC/Bill Date <KeyboardArrowDownIcon fontSize="small" />
                          </Box>
                          <Box sx={{ pl: 0.5, pt: 0.5 }}>
                            <CustomInputDateCmp
                              // StartIcon={<CalendarMonthIcon sx={{ color: '#0070E0' }} />}
                                ...
                                {billDetails?.map((val, index) => (
                                  ...
                                  >
                                    ...
                                    <td size="sm" style={{ fontSize: 12 }}>
                                      &nbsp;{val.delivered_bill_no}
                                    </td>
                                    <td size="sm" style={{ fontSize: 12 }}>
                                      &nbsp;
                                      {format(new Date(val.delivered_bill_date), 'dd-MM-yyyy')}
                                    </td>
                                    <td size="sm" style={{ fontSize: 12, textAlign: 'center' }}>
                                      <EditIcon
                                        sx={{
                      ...
                      <Box sx={{ pt: 1, flex: 1, px: 1 }}>
                        <Box sx={{ pl: 1, fontSize: 12 }}>
                          PACKAGE/BOX COUNT <KeyboardArrowDownIcon fontSize="small" />
                        </Box>
                        <Box sx={{ pl: 0.5, pt: 0.5 }}>
                          <CustomInputDateCmp
                      ...
                      <Box sx={{ pt: 1, flex: 1, px: 1 }}>
                        <Box sx={{ pl: 1, fontSize: 12 }}>
                          REMARKS <KeyboardArrowDownIcon fontSize="small" />
                        </Box>
                        <Box sx={{ pl: 0.5, pt: 0.5 }}>
                          <Textarea
                      ...
                      <Box sx={{ pt: 1, flex: 1, px: 1 }}>
                        <Box sx={{ pl: 1, fontSize: 12 }}>
                          RECEIVER <KeyboardArrowDownIcon fontSize="small" />
                        </Box>
                        <Box sx={{ pl: 0.5, pt: 0.5 }}>
                      ...
                      >
                        ...
                        <Box sx={{ ml: 0.7, mr: 1 }}>
                          <Button variant="outlined" sx={buttonStyle} onClick={ResetDetails}>
                            Cancel
                          </Button>
                        </Box>
                      </Box>
