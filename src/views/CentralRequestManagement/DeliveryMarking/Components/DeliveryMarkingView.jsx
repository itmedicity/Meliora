          ...
          >
            <Box sx={{ px: 1, display: 'flex', flexWrap: 'wrap' }}>
              ...
              <Box sx={{ flex: 0.5, pt: 3.2, pl: 0.3 }}>
                <IconButton sx={buttonStyle} onClick={backToDeliveryMarking}>
                  Back
                </IconButton>
              </Box>
              <Box sx={{ flex: 0.5, pt: 3.2, pl: 0.3 }}>
                ...
                itemContent={(index, val) => (
                  <React.Fragment key={val.delivery_mark_slno}>
                    ...
                    >
                      ...
                      <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>
                        {format(new Date(val.dc_receive_date), 'dd-MM-yyyy hh:mm:ss a')}
                      </Typography>
                      <Typography sx={{ width: 170, textAlign: 'left', fontSize: 12, my: 1 }}>
                        {val.mt_direct || val.mt_courier
                      ...
                      <Typography sx={{ width: 150, textAlign: 'left', fontSize: 12, my: 1 }}>
                        {val.remarks ? val.remarks : 'Not Updated'}
                      </Typography>
