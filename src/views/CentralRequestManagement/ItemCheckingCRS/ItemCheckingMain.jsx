...
const ItemCheckingMain = () => {
  ...
  const changeReceivedQty = useCallback(
    (item_slno, value) => {
                ...
                <Box sx={{ pt: 1, width: { xs: '100%', md: '60vw', lg: '50vw', xl: '50vw' } }}>
                  <Box sx={{ display: 'flex', px: 1 }}>
                    <Box sx={{ pt: 1, flex: 1.5 }}>
                      <Box sx={{ pl: 1, fontSize: 12, color: '#0d47a1' }}>
                    ...
                    <Box sx={{ flex: 0.3, pt: 3.7, pl: 0.5 }}>
                      <CustomIconButtonCmp handleChange={SearchData}>Search</CustomIconButtonCmp>
                    </Box>
                    {tableData.length !== 0 ? (
                      <Box sx={{ flex: 0.3, pt: 3.7, pl: 0.5 }}>
                        <CustomIconButtonCmp handleChange={SaveData}>Save</CustomIconButtonCmp>
                      </Box>
                    ) : null}
                    <Box sx={{ flex: 0.3, pt: 3.7, pl: 0.5 }}>
                      <CustomIconButtonCmp handleChange={viewDetails}>View</CustomIconButtonCmp>
                    </Box>
                  </Box>
                </Box>
              </Box>
