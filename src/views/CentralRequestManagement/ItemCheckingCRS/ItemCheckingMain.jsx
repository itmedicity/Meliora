...
import ViewChekingDetails from './Component/ViewChekingDetails';
import { getDepartSecemployee } from 'src/redux/actions/EmpNameDeptSect.action';
import ItemSaveModal from './Component/ItemSaveModal';
import SupplierSelectPendingPO from './Component/SupplierSelectPendingPO';
const ItemCheckingMain = () => {
                ...
                try {
                    ...
                    if (success === 1) {
                        const poItems = data?.map((val) => {
                            ...
                            //     .reduce((acc, curr) => acc + (curr.received_qty), 0))
                            return {
    ...
    return (
        <Fragment>
            {saveFlag === 1 ?
                <ItemSaveModal open={saveModal} handleClose={handleClose} tableData={tableData} reset={reset} supCode={supCode} />
                : null}
            ...
            <Box sx={{ height: window.innerHeight - 80 }}>
                <CssVarsProvider>
                    ...
                    {viewFlag === 1 ?
                        <ViewChekingDetails setViewFlag={setViewFlag} />
                        : <Box sx={{
                                ...
                                <Box sx={{ pt: 1, width: { xs: '100%', md: '60vw', lg: '50vw', xl: '50vw' } }}>
                                    <Box sx={{ display: 'flex', px: 1 }}>
                                        <Box sx={{ pt: 1, flex: 1.5 }}>
                                            ...
                                            <Box sx={{ pt: 0.5 }}>
                                                <SupplierSelectPendingPO supCode={supCode} setSupCode={setSupCode} />
                                            </Box>
                                        </Box>
                                ...
                                {tableData.length !== 0 ? (
                                    <Box sx={{ width: '100%' }}>
                                        <Box display="flex" justifyContent="space-between" sx={{
                                            ...
                                            <Typography sx={{ width: 40, textAlign: 'center', fontWeight: 550, fontSize: 13, m: 0.5 }}>Sl.No</Typography>
                                            <Typography sx={{ width: 100, fontWeight: 550, fontSize: 13, m: 0.5, textAlign: 'center', }}>Item Code</Typography>
                                            <Typography sx={{ width: 250, fontWeight: 550, fontSize: 13, m: 0.5 }}>Item</Typography>
                                            <Typography sx={{ width: 110, fontWeight: 550, fontSize: 13, m: 0.5, textAlign: 'left' }}>Pending Qty</Typography>
                                            <Typography sx={{ width: 120, fontWeight: 550, fontSize: 13, m: 0.5, textAlign: 'center' }}>Delivered Qty</Typography>
                                            <Typography sx={{ width: 350, fontWeight: 550, fontSize: 13, m: 0.5, textAlign: 'center' }}>Damage</Typography>
                                        </Box>
                                        <Virtuoso
