...
const CrfMOApproval = () => {
    ...
    const updatedone = useCallback((e) => {
        if (e.target.checked === true) {
            ...
            const DoneList = DisData.filter((val) => {
                return val.crf_close !== 1 && val.manag_operation_approv !== null || val.senior_manage_approv !== null || val.gm_approve !== null ||
    ...
    useEffect(() => {
        if (tabledata.length !== 0) {
            const molist = tabledata.filter((val) => {
                return val.manag_operation_req === 1
            })
            ...
            const pendingList = datas.filter((val) => {
                return val.crf_close !== 1 && val.manag_operation_approv === null && val.senior_manage_approv === null &&
