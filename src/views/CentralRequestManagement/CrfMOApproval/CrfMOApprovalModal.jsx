...
const CrfMOApprovalModal = ({ open, ApprovalData, setApprovalModal, setApprovalFlag, count, setCount, setApprovalData }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, expected_date, incharge_approve, incharge_req,
        ...
        manag_operation_approv, manag_operation_remarks, om_detial_analysis, image_status,
        hod_image, dms_image, ms_image, mo_image, dms_req, ms_approve_req
    } = ApprovalData
    ...
    useEffect(() => {
        ...
        setRemark(manag_operation_remarks !== null ? manag_operation_remarks : '')
        setDetailAnalis(om_detial_analysis !== null ? om_detial_analysis : '')
    }, [manag_operation_approv, manag_operation_remarks, om_detial_analysis])
    ...
    }, [approve, reject, pending, remark, detailAnalis, MOPatchData, setCount, count, reset,
                                            ...
                                            <Box>
                                                {ApproveTableDis === 1 ?
                                                    <Paper variant='outlined' sx={{ p: 0, mt: 1 }} >
                                                        ...
                                                        <Box sx={{ p: 1 }}>
                                                            <ApprovalCompntAll
                                                                heading="CRF Documentation Approval"
                                                                approve={approve}
                                                                reject={reject}
                                                                pending={pending}
                                                                remark={remark}
                                                ...
                                                <Box sx={{ display: 'flex', width: '400', pt: 1 }}>
                                                    {mo_image === 1 ? <CusIconButton size="sm" variant="outlined" color="primary" clickable="true" onClick={ViewUploadImage}  >
                                                        <AttachFileIcon fontSize='small' />
                                                        <Typography color="primary" sx={{ fontSize: 15, pl: 1, pr: 1, }}>View Image</Typography>
                                                    </CusIconButton> : null}
                                                    <Box >
