                        ...
                        <Table aria-label="table with sticky header" borderAxis="both" padding={"none"} stickyHeader size='sm' >
                            <thead style={{ height: 4 }} size='small'>
                                <tr style={{ height: 4 }} size='small'>
                                    ...
                                    <th size='sm' style={{ width: 80, textAlign: 'center', backgroundColor: '#e3f2fd' }}>Price</th>
                                    <th size='sm' style={{ width: 80, textAlign: 'center', backgroundColor: '#e3f2fd' }}>Approx.Cost</th>
                                    ...
                                    return (
                                        <NewTooltip key={item.req_detl_slno} placement="top" title={item.item_status_approved === 1
                                            ...
                                            <tr style={{ cursor: 'pointer' }}>
                                                ...
                                                <td style={{ textAlign: 'center', color: rowColor }}>{item.item_status_approved === 1
