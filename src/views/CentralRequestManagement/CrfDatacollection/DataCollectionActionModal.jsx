import { Box, CssVarsProvider, IconButton, Modal, ModalClose, ModalDialog, Textarea, Tooltip, Typography } from '@mui/joy'
...
const DataCollectionActionModal = ({ open, handleClose, reqItems, approveTableData, dcData, setApproveTableData,
    ...
    return (
        <Fragment>
            {imageshowFlag === 1 ? <ReqImageDisModal open={imageshow} handleClose={handleCloseImageView}
            ...
            <CssVarsProvider>
                ...
                >
                    ...
                    >
                        ...
                        />
                        <Box sx={{ minWidth: '80vw', minHeight: '62vh', maxHeight: '85vh', overflowY: 'auto', px: 0.2 }}>
