    ...
    <>
      ...
      <Box sx={{ height: window.innerHeight - 80, flexWrap: 'wrap', bgcolor: 'white', width: "100%" }}>
        <Box sx={{ display: 'flex', backgroundColor: '#f0f3f5', border: '1px solid #B4F5F0' }}>
          <Box sx={{ fontWeight: 550, flex: 1, pl: 1, pt: 0.5, color: '#385E72' }}>CRF View</Box>
        ...
        >
          ...
          <Box sx={{ flex: 0.3, pl: 1.5 }}>
            <CssVarsProvider>
              <IconButton sx={buttonStyle} onClick={searchCRFDetails}>
                Search
              </IconButton>
            </CssVarsProvider>
          </Box>
          ...
          {tableData.length !== 0 ? (
            <Virtuoso
              ...
              itemContent={(index, val) => (
                ...
                >
                  <MasterComponent val={val} selectedCompany={selectedCompany} companyData={company} count={count} setcount={setcount} />
                </Box>
              )}
            ></Virtuoso>
          ) : (
