    ...
    <Fragment>
      {poDetails.length !== 0 ? (
        <Paper variant="outlined" sx={{ p: 1, mt: 0.5 }}>
          ...
          >
            <Typography sx={{ width: 60, textAlign: 'left', fontWeight: 550, fontSize: 12 }}>
              Order#
            </Typography>
            ...
            <Typography sx={{ width: 90, textAlign: 'left', fontWeight: 550, fontSize: 12 }}>
              Amount
            </Typography>
            <Typography
            ...
            itemContent={(index, val) => (
              <React.Fragment key={val.po_detail_slno}>
                <Box
                  display="flex"
                  justifyContent="space-between"
                  sx={{ borderBottom: '1px solid lightgrey', flexWrap: 'nowrap', px: 1 }}
                >
                  <Typography sx={{ width: 60, textAlign: 'left', fontSize: 12, my: 1 }}>
                    {val.po_number}
                  </Typography>
                  ...
                  <Typography sx={{ width: 90, textAlign: 'left', fontSize: 12, my: 1 }}>
                    {'Rs. ' + val.po_amount}
                  </Typography>
                  <Box sx={{ width: 30, textAlign: 'center', pt: 0.5, cursor: 'pointer', mr: 2 }}>
                    <CustomToolTipForCRF title={'View PO Items'} placement={'left'}>
                      <ExpandMoreIcon
                        sx={{
                          fontSize: 'lg',
                          color: '#3e2723',
