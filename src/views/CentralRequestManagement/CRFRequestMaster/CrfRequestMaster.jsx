                ...
                <CssVarsProvider>
                    ...
                    >
                        <TabList
                            disableUnderline
                            sx={{
                                border: '1px solid lightblue', gap: 0.3,
                        ...
                        >
                            <Tab
                                disableIndicator
                                sx={{
                                    borderTopLeftRadius: 50, ml: 0.5, height: 30, bgcolor: 'white', border: '1px solid #c5cae9',
                                    transition: 'transform 0.2s', width: 300, m: 0.2,
                                    '&:hover': {
                            ...
                            <Tab
                                disableIndicator
                                sx={{
                                    borderTopLeftRadius: 50, height: 30, bgcolor: 'white', border: '1px solid #c5cae9',
                                    transition: 'transform 0.2s', width: 300, m: 0.2,
                                    '&:hover': {
                                        transform: 'scale(1.01)',
                                        bgcolor: 'white',
