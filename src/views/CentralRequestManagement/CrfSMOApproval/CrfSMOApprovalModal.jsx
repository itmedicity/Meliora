...
const CrfSMOApprovalModal = ({ open, ApprovalData, setApprovalModal, setApprovalFlag, count, setCount, setApprovalData }) => {
    const { req_slno, req_date, actual_requirement, needed, expected_date, incharge_approve, incharge_req,
        ...
        image_status, hod_image, dms_image, ms_image, mo_image, smo_image, dms_req, ms_approve_req
    } = ApprovalData
    ...
    useEffect(() => {
        ...
        setRemark(senior_manage_remarks !== null ? senior_manage_remarks : '')
        setDetailAnalis(smo_detial_analysis !== null ? smo_detial_analysis : '')
                                        ...
                                        datacollFlag === false ?
                                            <Box>
                                                ...
                                                <Box sx={{ display: 'flex', width: '400', pt: 1 }}>
                                                    {smo_image === 1 ? <CusIconButton size="sm" variant="outlined" color="primary" clickable="true" onClick={ViewUploadImage}  >
                                                        <AttachFileIcon fontSize='small' />
                                                        <Typography color="primary" sx={{ fontSize: 15, pl: 1, pr: 1, }}>View Image</Typography>
                                                    </CusIconButton> : null}
                                                    <Box >
