...
import { AllListForSMOApi, CloseListApi, OnHoldListApi, RejectListApi, getSMOAppvalPending } from '../ComonComponent/ComonFunctnFile'
...
const CrfSMOApprovalMain = () => {
    ...
    useEffect(() => {
        setOpen(true)
        getSMOAppvalPending(setDisArray, setOpen)
    }, [count])
    ...
    const updateRadioClick = useCallback(async (e) => {
        ...
        if (e.target.value === '1') {
            ...
            AllListForSMOApi(setDisArray, setOpen)
