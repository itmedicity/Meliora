...
const CrfSMOApproval = () => {
    ...
    const updatedone = useCallback((e) => {
        if (e.target.checked === true) {
            ...
            const DoneList = DisData.filter((val) => {
                return val.crf_close !== 1 && val.senior_manage_approv === null && val.gm_approve === null &&
    ...
    useEffect(() => {
        if (tabledata.length !== 0) {
            ...
            const smolist = tabledata.filter((val) => {
                return val.senior_manage_req === 1 && val.crf_close !== 1
            })
