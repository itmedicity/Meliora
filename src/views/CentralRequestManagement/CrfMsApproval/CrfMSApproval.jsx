...
const CrfMSApproval = () => {
    ...
    const updatedone = useCallback((e) => {
        if (e.target.checked === true) {
            ...
            const DoneList = DisData.filter((val) => {
                return val.crf_close !== 1 && val.ms_approve !== null || val.manag_operation_approv !== null ||
    ...
    useEffect(() => {
        if (tabledata.length !== 0) {
            const mslist = tabledata.filter((val) => {
                return val.ms_approve_req === 1
            })
            const datas = mslist.map((val) => {
                const obj = {
                    ...
                    dms_remarks: val.dms_remarks !== null ? val.dms_remarks : "Not Done",
                    dms_detail_analysis: val.dms_detail_analysis !== null ? val.dms_detail_analysis : "Not Done",
                    ...
                    ms_detail_analysis: val.ms_detail_analysis !== null ? val.ms_detail_analysis : '',
    ...
    return (
        <Fragment>
            ...
            {ApprovalFlag === 1 ? <CrfMSApprovalModal open={ApprovalModal} ApprovalData={ApprovalData}
