...
const CrfMSApprovalModal = ({ open, ApprovalData, setApprovalModal, setApprovalFlag, count, setCount, setApprovalData }) => {
    ...
    const { req_slno, req_date, actual_requirement, needed, expdate, incharge_approve, incharge_req,
        ...
        dms_approve, dms, dms_remarks, dms_detail_analysis, dms_approve_date, dms_user, ms_approve_req,
    ...
    const submit = useCallback(() => {
        const updateInchargeApproval = async (MSPatchData) => {
        ...
        if (approve !== false || reject !== false || pending !== false) {
            if (approve === true && detailAnalis !== '' && remark !== '') {
                updateInchargeApproval(MSPatchData)
            }
