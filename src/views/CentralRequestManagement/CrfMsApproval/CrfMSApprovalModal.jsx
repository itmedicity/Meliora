...
const CrfMSApprovalModal = ({ open, ApprovalData, reqItems, handleClose, setApproveTableData, approveTableData,
    ...
    const { req_slno, incharge_req, incharge_remarks, hod_req, hod_approve, dms_req, dms_approve, req_deptsec, needed, expected_date,
        ms_approve, ms_approve_remark, ms_detail_analysis, ms_image, company_slno, request_deptsec_slno, actual_requirement,
    } = ApprovalData
    ...
    const insertMastTask = {
        ...
        tm_task_description: "The task is to arrange for \"" + needed + "\"concerning the items metioned in CRF No :" + req_slno + " By MS",
                                    ...
                                    <Box sx={{ mt: 0.5, pb: 1, flexWrap: 'wrap', mx: 0.3 }} >
                                        {approveTableData.length !== 0 ?
                                            <ItemsApprovalCompnt req_slno={req_slno} setMoreItem={setMoreItem}
                                                ...
                                                setApproveTableData={setApproveTableData} header='MS' apprvLevel={4} ApprovalData={ApprovalData} />
                                            : null
                                        }
                                        <Box sx={{ pl: 0.5 }}>
                                            <CustomIconButtonCmp
