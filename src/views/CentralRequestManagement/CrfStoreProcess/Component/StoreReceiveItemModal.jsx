        ...
        >
          ...
          >
                  ...
                  itemContent={(index, val) => (
                    <React.Fragment key={index}>
                      <Box
                        display="flex"
                        justifyContent="space-between"
                        sx={{ borderBottom: '1px solid lightgrey', overflow: 'auto' }}
                      >
                        ...
                        <Typography sx={{ width: 350, textAlign: 'left', fontSize: 12, my: 1 }}>
                          {val.item_name}
                        </Typography>
                        <Typography sx={{ width: 80, textAlign: 'center', fontSize: 12, my: 1 }}>
                          {val.item_qty}
                        </Typography>
                        <Typography
                          sx={{
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
              <Box sx={{ pt: 0.4 }}>
                <Button variant="plain" sx={buttonStyle} onClick={SaveDetails}>
                  Save
                </Button>
              </Box>
              <Box sx={{ pr: 2, pt: 0.4 }}>
