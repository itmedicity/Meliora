...
export const CrfPdfWithOutDetails = async (val) => {
            ...
            [
              {
                ...
                text: [
                  ...
                  { text: md_approve !== null ? md : 'Not Updated', fontSize: 8, font: 'Roboto' }
                ]
              },
              '', '', ''
            ],
            ...
            [
              {
                ...
                text: [
                  ...
                  { text: ed_approve !== null ? ed : 'Not Updated', fontSize: 8, font: 'Roboto' }
                ]
              },
              '', '', ''
            ],
