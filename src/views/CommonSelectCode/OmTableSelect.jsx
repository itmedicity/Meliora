    ...
    return (
        <Box   >
            <FormControl fullWidth size="small"  >
                ...
                >
                    <MenuItem value={0} disabled  >Select OM Table</MenuItem>
                    {
                        omTableata && omTableata.map((val, index) => {
                            return <MenuItem key={index} value={val.omtable_no} >{val.omtable_name}</MenuItem>
                        })
                    }
                </Select>
            </FormControl>
