...
const FloorSelectBasedBuild = ({ value, setValue, buildno, setName }) => {
    ...
    useEffect(() => {
        dispatch(getFloorBasedOnBuild(buildno))
    }, [dispatch, buildno])
        ...
        <Box >
            <FormControl fullWidth size="small"  >
                ...
                >
                    ...
                    {
                        FloorData && FloorData.map((val, index) => {
                            return <MenuItem key={index} value={val.rm_floor_slno}
                                name={val.rm_floor_alias}>{val.rm_floor_name}</MenuItem>
                        })
                    }
                </Select>
            </FormControl>
