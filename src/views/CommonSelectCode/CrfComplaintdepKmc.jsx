...
import { getComplaintDeptKmc } from 'src/redux/actions/ComplaintDept.action';

const CrfComplaintdepKmc = ({ value, setValue }) => {

    const dispatch = useDispatch();

    const complaintdeptdata = useSelector((state) =>
        state.getComplaintDeptKmc.complaintdeptListKMC || []
        // state.getComplaintDeptKmc

    );

    // Fetch complaint departments
    useEffect(() => {
        dispatch(getComplaintDeptKmc())
    }, [dispatch]);
    return (
        <Box >
...
export default CrfComplaintdepKmc