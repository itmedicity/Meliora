    ...
    return (
        <Box>
            <FormControl fullWidth size="small"  >
                ...
                >
                    <MenuItem value={0} disabled  >Select Hall name</MenuItem>
                    {
                        hallmaster && hallmaster.map((val, index) => {
                            return <MenuItem key={index} value={val.hall_slno}>{val.hall_name}</MenuItem>
                        })
                    }
                </Select>
            </FormControl>
