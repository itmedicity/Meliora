import { Box, Button, CssVarsProvider, Modal, ModalClose, ModalDialog, Option, Select, Textarea, Typography } from '@mui/joy'
                        ...
                        <Box sx={{ display: 'flex', bgcolor: '#1976D2', flexWrap: 'wrap' }}>
                            <Box sx={{ flex: 0.5, m: 1 }}>
                                <Typography sx={{ fontWeight: 550, fontSize: 35, color: 'white', fontFamily: 'system-ui' }}>
                                    Incident Report Form</Typography>
                            </Box>
                            <Box sx={{ flex: 1, m: 1, flexWrap: 'wrap' }}>
                                ...
                                <Box sx={{ m: 0.5 }}>
                                    <TextFieldCustom
                                        ...
                                        sx={{ '@media screen and (max-width: 768px)': { width: 100, fontSize: 10, color: 'white', fontFamily: 'system-ui' } }}
                                        type="datetime-local"
                                        name="inicidentDate"
                                        value={inicidentDate}
                                        size="sm"
                                ...
                                <Box sx={{ m: 0.5 }}>
                                    <Typography sx={{ fontWeight: 550, fontSize: 14, color: 'white', fontFamily: 'system-ui' }}>Location of Incident</Typography>
                                </Box>
