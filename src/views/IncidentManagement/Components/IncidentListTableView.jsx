          ...
          <Table borderAxis="bothBetween" padding={'none'} stickyHeader>
            ...
            <tbody size="small">
              {tableData?.map((val, index) => {
                return (
                  <tr key={index} size="small" style={{ cursor: 'pointer' }}>
                    ...
                    <td size="sm" style={{ fontSize: 14, height: 15, textAlign: 'center' }}>
                      {val.clinic_nonclinic === 1 ? 'Clinical' : 'Non Clinical'}
                    </td>
                    <td size="sm" style={{ fontSize: 13, height: 15 }}>
                      {val.incident_reason}
                    </td>
                    <td size="sm" style={{ fontSize: 13, height: 15 }}>
                      {val.incident_details}
                    </td>
                    <td size="sm" style={{ fontSize: 13, height: 15 }}>
                      {val.create_emp}
                    </td>
                    ...
                    <td size="sm" style={{ fontSize: 13, height: 15 }}>
                      {val.incident_mark_remarks === '' ? 'Nil' : val.incident_mark_remarks}
                    </td>
                    <td size="sm" style={{ fontSize: 13, height: 15 }}>
                    ...
                    <td size="sm" style={{ fontSize: 13, height: 15 }}>
                      {val.verified_date === null
                        ? 'Not Verified'
                        : format(new Date(val.verified_date), 'dd-MM-yyyy hh:mm a')}
                    </td>
                  </tr>
                )
              })}
