  ...
  return (
    <Fragment>
      ...
      >
              ...
              >
                  ...
                  <Box sx={{ pl: 7 }}>
                    <CssVarsProvider>
                      <Typography sx={{ fontSize: 15 }}>
                        Request Date: {format(new Date(compalint_date), 'dd-MM-yyyy hh:mm:ss')}
                      </Typography>
                    </CssVarsProvider>
                  </Box>
                </Box>
                ...
                >
                  <CssVarsProvider>
                    ...
                    <Typography sx={{ textTransform: 'capitalize', fontSize: 15, pl: 1.7 }}>
                      {' '}
                      {sec_name.toLowerCase()}
                    </Typography>
                  </CssVarsProvider>
                </Box>
                <Box
                ...
                >
                  <CssVarsProvider>
                    ...
                    <Typography sx={{ textTransform: 'capitalize', fontSize: 15, pl: 5.4 }}>
                      {' '}
                      {complaint_type_name.toLowerCase()}
                    </Typography>
                  </CssVarsProvider>
                </Box>
        ...
        <DialogActions>
          <Button color="secondary" onClick={sendMeassage}>
            Ok
          </Button>
        </DialogActions>
      </Dialog>
