...
`
  ...
  const AssistanceRequest = useCallback(
    val => {
      setAssistNeed(val)
      setFlags(prevFlags => ({
        ...prevFlags,
  ...
  const RectifyRequest = useCallback(
    val => {
      setRectfyDta(val)
      setFlags(prevFlags => ({
        ...prevFlags,
    ...
    >
      ...
      {flags.rectfyFlag === 1 ? (
        <NewRectifyModal
          ...
          setrectfyOpen={value => setOpenStates(prevState => ({ ...prevState, rectfyOpen: value }))}
          setrectfyFlag={value => setFlags(prevFlags => ({ ...prevFlags, rectfyFlag: value }))}
          rectfyDta={rectfyDta}
          count={count}
          setCount={setCount}
        />
      ...
      {flags.holdFlag === 1 ? (
        <HoldReasonModal
          ...
          setHoldOpen={value => setOpenStates(prevState => ({ ...prevState, holdOpen: value }))}
          setHoldflag={value => setFlags(prevFlags => ({ ...prevFlags, holdFlag: value }))}
          holdData={holdData}
          count={count}
          setCount={setCount}
        />
      ...
      {loading ? (
        <div style={{ display: 'flex', height: '100%', pl: 0.5 }}>
          <CircularProgress
            color="neutral"
            sx={{
