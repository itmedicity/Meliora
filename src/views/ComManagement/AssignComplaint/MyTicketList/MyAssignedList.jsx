                ...
                {assistReq?.map((val, index) => {
                    return (
                        <Box
                            ...
                            <Box sx={{
                                flex: 1, bgcolor: '#A47551',
                                display: 'flex',

                            }}>
                                <Box sx={{ color: 'white', pl: 1, fontWeight: 600 }}>
                                    <NotificationsIcon sx={{ color: 'white', animation: `${borderblinkAnimation} 1s infinite }}` }} /> Assist Request
                                </Box>
