...
const HoldReasonModal = ({ holdOpen, setHoldOpen, setHoldflag, holdData }) => {
    ...
    const { complaint_slno, complaint_desc, compalint_date, rm_roomtype_name, rm_room_name, rm_insidebuildblock_name,
        rm_floor_name, location, complaint_type_name, holduser, pending_onhold_time, rectify_pending_hold_remarks, cm_hold_reason } = holdData
            ...
            <Modal
                ...
                <ModalDialog variant="outlined" sx={{ width: '43vw', p: 0, overflow: 'auto' }}>
                    ...
                    <Box sx={{
                        ...
                        <Typography sx={{ fontWeight: 600, pb: .5, color: '#50655B' }}>
                            Holded Reason
                        </Typography>
                        <TextFieldCustom
                            style={{ width: "100%" }}
                        ...
                        <Typography sx={{ fontWeight: 600, pb: .5, pt: 1, color: '#50655B' }}>
                            Holded by
                        </Typography>
                        <Typography sx={{ pr: 2, fontSize: 14, fontWeight: 400, }}>
                            {holduser}
                        </Typography>
