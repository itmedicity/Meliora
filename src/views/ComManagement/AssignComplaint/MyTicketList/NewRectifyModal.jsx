...
const NewRectifyModal = ({ rectfyOpen, setrectfyOpen, setrectfyFlag, rectfyDta, count, setCount }) => {
  ...
  const [pendholdreason, setPendhold] = useState(
    rectify_pending_hold_remarks !== null ? rectify_pending_hold_remarks : ''
  )
  ...
  const AssetSpareDetailsview = useCallback(
    val => {
        ...
        >
          ...
          >
            <Box sx={{ mb: 2, flexShrink: 0 }}>
              <Box sx={{ flex: 1, color: 'grey', pl: 0.5 }}>Rectify Complaint / Service Report</Box>
              <Box sx={{ flex: 1, display: 'flex', bgcolor: '#ECEDEF', py: 1, px: 0.5, mt: 1 }}>
                ...
                <Box sx={{ flex: 0.8, textAlign: 'right', pr: 1.5 }}>
            ...
            >
              ...
              {isExpanded || assetArray.length !== 0 ? (
                <Box>
                  ...
                  <Box sx={{ pt: 1, display: 'flex' }}>
                    ...
                    />
                    {select === 1 && (
                      <Box sx={{ flex: 1, display: 'flex', mr: 5, mt: 0.1 }}>
                        <CssVarsProvider>
                          <Box sx={{ flex: 1, ml: 1 }}>
                            <CmAssetList
                              assetz={assetData}
                      ...
                      >
                        ...
                        >
                          {val.asset_item_service === 0 ? (
                            ...
                            <Tooltip
                              title={'Asset will be Transfer to Service List by clicking'}
                              sx={{ width: 200 }}
                              color="warning"
                              placement="top"
                            >
                            ...
                            <Tooltip
                              title={'Asset Already added to service'}
                              sx={{ width: 215, bgcolor: 'grey' }}
                              placement="top"
                            >
                              <ManageAccountsSharpIcon
                                sx={{
                            ...
                            <Tooltip
                              title={'Asset  added to  Condem List'}
                              sx={{ width: 215, bgcolor: 'grey' }}
                              placement="top"
                            >
                              <DeleteIcon
                  ...
                  <Box sx={{ flex: 1, pt: 1.5 }}>
                    <Typography sx={{ fontWeight: 600, color: '#394E6C', fontSize: 15, pt: 0.5 }}>
                      Asset Transfer
                    </Typography>
                    <Typography sx={{ fontStyle: 'italic', color: '#394E6C' }}>
              ...
              <Box sx={{ pl: 0.4, pt: 2, display: 'flex', gap: 0.5 }}>
                <Typography sx={{ fontWeight: 600, color: 'Black', fontSize: 16, pt: 0.2 }}>
                ...
                <Box sx={{ margin: 'auto' }}>
                  {uploadBlink === 1 ? (
                    ...
                    >
                      ...
                      <Typography sx={{ fontSize: 13, color: 'white', mt: 0.1 }}>Upload</Typography>
                    </Box>
                  ) : (
                    <Box
                      sx={{
            ...
            <Box sx={{ mt: 0.5, flexShrink: 0, display: 'flex', justifyContent: 'flex-end' }}>
              <Button variant="plain" sx={buttonStyle} onClick={rectifycmplt}>
                Save
              </Button>
