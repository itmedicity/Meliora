...
const AcceptOrRejectAssistRequest = ({
  open,
  setOpen,
  reqDetails,
  count,
        ...
        <ModalDialog variant="outlined" sx={{ width: '50vw', p: 0, overflow: 'auto' }}>
          ...
          <Box sx={{ flex: 1, pl: 1, bgcolor: '#ECEDEF', display: 'flex' }}>
            <Box sx={{ flex: 2 }}>
              ...
              <Typography sx={{ fontSize: 13, color: 'Black', pl: 0.5 }}>
                {complaint_type_name}
              </Typography>
            </Box>
          ...
          <Box sx={{ flex: 1, pl: 2 }}>
            ...
            <Typography sx={{ pl: 0.5, fontSize: 15, color: 'Black', pt: 0.3 }}>
              {complaint_desc}
            </Typography>
          </Box>
          ...
          {reason === 1 ? (
            <Box sx={{ flex: 1, textAlign: 'center', mx: 3 }}>
              <Typography sx={{ fontWeight: 600, pb: 0.3, textAlign: 'left' }}>
                Reason to Reject
              </Typography>
              <CustomTextarea
                style={{ width: '100%' }}
