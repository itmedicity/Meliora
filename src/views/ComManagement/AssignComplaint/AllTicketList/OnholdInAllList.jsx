                        ...
                        return (
                            <Box
                                ...
                                {val.aprrox_date !== null ?
                                    <Box sx={{
                                        flex: 1, bgcolor: '#E7D2CC', display: 'flex', py: .3,
                                    }}>
                                    ...
                                    <Box sx={{
                                        ...
                                        <Box sx={{ flex: 1, display: 'flex', my: .5, justifyContent: "center", }}>
                                                ...
                                                slno === 251 ? (
                                                    <Tooltip title='Change Assignees' key={slno || idx} >
                                                        <SettingsAccessibilityIcon sx={{
                                                            height: 28, width: 30, color: '#603F8B', cursor: 'pointer', border: 1, borderRadius: 5, p: .3, mr: .5,
                                                            '&:hover': { color: '#A16AE8' },
                                                        }}
                                            ...
                                            <Tooltip title='On Hold Reason'  >
                                                <ArticleIcon sx={{
                                                    height: 28, width: 30, color: '#50655B ', cursor: 'pointer', border: 1, borderRadius: 5, p: .3,
                                                    '&:hover': { color: 'grey' }, mr: .5
                                                }}
                                            ...
                                            {val.cm_asset_status === 1 ?
                                                <Tooltip title='Asset Details' sx={{ bgcolor: '#4C5270' }} >
                                                    <MiscellaneousServicesIcon sx={{
                                                        ...
                                                        p: .1, color: '#4C5270', cursor: 'pointer', mr: .5
