...
const AssetSpareModal = ({ openSpare, setOpenSpare, setassetSpareFlag, assetSparedetails, complaint_slno }) => {
    ...
    const { item_asset_no, item_name, am_item_map_slno, am_spare_item_map_slno, item_custodian_dept, category_name, item_asset_no_only,
        am_category_pm_days,
    } = assetSparedetails
    ...
    const servicefunctn = useCallback(async (val) => {
                                            ...
                                            {alldetailsService.length !== 0 ?
                                                <Box >
                                                    ...
                                                    {alldetailsService?.map((val, index) => {
                                                        return (
                                                            <Box
                                                                key={index} sx={{ ml: .5, mb: 2, border: 1, py: 2, mr: 1 }}>
                                                                <Box sx={{ display: 'flex' }}>
