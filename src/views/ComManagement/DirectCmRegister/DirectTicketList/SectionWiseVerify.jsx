...
const SectionWiseVerify = ({ count, setCount, forVerify }) => {
            ...
            <Box sx={{ width: '100%', overflow: 'auto' }}>
                ...
                {forVerify.length !== 0 ?
                    <Box sx={{ width: 2100, }}>
                        <Box sx={{
                            ...
                            <Box sx={{ width: 130, fontWeight: 600, color: '#444444', fontSize: 12, }}>Action</Box>
                            ...
                            <Box sx={{ width: 200, fontWeight: 600, color: '#444444', fontSize: 12, pl: 2 }}>Asset Details</Box>
                        </Box>
                        <Virtuoso
                            style={{ height: '35vh' }}
                ...
                {/* </> :
                    <Box sx={{ fontWeight: 700, fontSize: 20, color: 'lightgrey', textAlign: 'center', my: 4 }}>
                        Select the Section to View  Tickets to Verify
                    </Box>
                } */}
            </Box >
        </Box>
