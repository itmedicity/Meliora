            ...
            {emptyFlag === 1 ?
                <>
                    {dataa.length !== 0 ?
                        ...
                        />
                        :
                        <Box sx={{ flex: 1, m: 1, height: '20vh', textAlign: 'center', fontWeight: 700, fontSize: 22, color: 'lightgray', pt: 6 }}>
                            {flagz === 1 ?
                                <>
                                    Empty list Under Selected Date Range
                                </> :
                                <>
                                    Select the Section and Date Range to View Rectified Complaints
                                </>}
