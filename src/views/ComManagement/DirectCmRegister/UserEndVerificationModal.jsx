                ...
                <Box sx={{ flex: 1, display: 'flex' }}>
                  ...
                  <Box sx={{ flex: 3 }}>
                    {compalint_priority === 1 ? (
                      <Chip sx={{ bgcolor: '#FBAA60', mr: 0.5 }}>Level 1</Chip>
                    ) : compalint_priority === 2 ? (
                      <Chip sx={{ bgcolor: '#FBAA60', mr: 0.5 }}>Level 2</Chip>
                    ) : compalint_priority === 3 ? (
                      <Chip sx={{ bgcolor: '#FBAA60', mr: 0.5 }}>Level 3</Chip>
                    ) : null}
                    {priority_check === 1 ? (
                      <Chip sx={{ bgcolor: '#E43D40' }}>Critical</Chip>
                    ) : (
