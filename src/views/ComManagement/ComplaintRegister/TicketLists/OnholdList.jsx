                ...
                onholdCompl.length !== 0 ?
                    <Box sx={{}}>
                        <Box sx={{
                            ...
                            <Box sx={{ width: "5%", fontWeight: 600, color: '#444444', fontSize: 12, pl: 2 }}>Ticket No.</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, textAlign: 'center' }}>Action</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, pl: .5 }}>Complaint Type</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, pl: 1.5 }}>Describtion</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, pl: .5 }}>Complaint To</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, pl: .5 }}>Complaint From</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, pl: .5 }}>Location</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, pl: .5 }}>Location Details</Box>
                            <Box sx={{ width: "", fontWeight: 600, color: '#444444', fontSize: 12, }}>Complaint Date</Box>
                        </Box>
                        <Virtuoso
                            style={{ height: '26vh' }}
                            ...
                            itemContent={(index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Box sx={{ pl: 2, width: "", fontWeight: 600, fontSize: 14 }}>
                                            {val.complaint_slno}
                                        </Box>
                                        <Box sx={{ width: "", display: 'flex', gap: .5, textAlign: 'center' }}>
