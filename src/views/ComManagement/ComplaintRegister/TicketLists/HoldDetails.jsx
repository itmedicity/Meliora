          ...
          <ModalDialog variant="outlined" sx={{ width: '43vw', p: 0, overflow: 'auto' }}>
            ...
            <Box sx={{ px: 2, mt: 1 }}>
              ...
              <Box sx={{ flex: 1, display: 'flex', gap: 1.5 }}>
                <Box sx={{ flex: 1 }}>
                  <Typography sx={{ fontWeight: 600, pt: 1, pb: 0.3 }}>Complaint Type</Typography>
                  <Textarea variant="outlined" minRows={1} value={complaint_type_name} readOnly />
                </Box>

                <Box sx={{ flex: 1 }}>
                  <Typography sx={{ fontWeight: 600, pt: 1, pb: 0.3 }}>Complaint To</Typography>
                  <Textarea variant="outlined" minRows={1} value={complaint_dept_name} readOnly />
                </Box>
              </Box>
              ...
              <Box sx={{ flex: 1, mt: 1.5, textAlign: 'right' }}>
                <Typography sx={{ fontWeight: 600, pt: 1, pb: 0.3, pr: 2 }}>Holded By</Typography>
                <Typography sx={{ pt: 0.5, pr: 2, fontSize: 14 }}>{holduser}</Typography>
                <Typography sx={{ pb: 0.3, pr: 2, fontSize: 12 }}>
                  {pending_onhold_time
