    ...
    <Box sx={{ width: '100%', overflow: 'auto' }}>
      ...
      {loading ? (
        ...
        <Box sx={{ width: 2100 }}>
          ...
          >
            <Box sx={{ width: 100, fontWeight: 600, color: '#444444', fontSize: 12, pl: 1.5 }}>
              Ticket No.
            </Box>
            <Box
              sx={{
            ...
            <Box sx={{ width: 155, fontWeight: 600, color: '#444444', fontSize: 12 }}>
              Complaint Type
            </Box>
            <Box sx={{ width: 610, fontWeight: 600, color: '#444444', fontSize: 12 }}>
              Describtion
            </Box>
            <Box sx={{ width: 180, fontWeight: 600, color: '#444444', fontSize: 12 }}>
              Complaint To
            </Box>
            <Box sx={{ width: 225, fontWeight: 600, color: '#444444', fontSize: 12 }}>
              Complaint From
            </Box>
