...
const VerifyListUserEnd = ({ count, setCount }) => {
    ...
    return (
        <Box sx={{ bgcolor: 'white', }}>
            ...
            {rectifedList.length !== 0 ?
                                    ...
                                    <Box sx={{ flex: 1, display: 'flex', p: .8, }}>
                                        ...
                                        <Box sx={{
                                            ...
                                            <Box sx={{ flex: 1, display: 'flex', mt: .5 }}>
                                                <Typography sx={{ flex: 2, fontSize: 13, fontWeight: 700 }}>
                                                    Section
                                                </Typography>
                ...
                />
                :
                <Box sx={{ flex: 1, m: 1, height: '20vh', textAlign: 'center', fontWeight: 700, fontSize: 20, color: 'lightgray', pt: 3 }}>
                    {flagz === 1 ?
                        <>
...
export default memo(VerifyListUserEnd)