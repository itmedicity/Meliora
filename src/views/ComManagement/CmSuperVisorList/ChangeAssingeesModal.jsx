        ...
        <Modal open={empTransferOpen}>
          ...
          >
            <Box sx={{ flex: 1, display: 'flex', mt: 1, p: 1 }}>
              <Box sx={{ flex: 1, color: 'grey' }}>Change Assignees</Box>
            ...
            <Box sx={{ flex: 1, display: 'flex', mt: 2, mx: 8 }}>
              <Typography sx={{ flex: 1.5 }}>Assignees :</Typography>
              <Box
                sx={{
                  flex: 3,
            ...
            <Box sx={{ flex: 1, display: 'flex', mx: 8 }}>
              <Typography sx={{ flex: 1.5 }}>Change Assignees to :</Typography>
              <Box sx={{ flex: 3 }}>
