    ...
    return (
        <Box>
            {queryflag === 1 ?
                ...
                : null}
            {verifyFlag === 1 ?
                <SupervisorVerifyModal open={verifyOpen} setverifyOpen={setverifyOpen} forVerifyData={forVerifyData}
                                        ...
                                        <Box sx={{ flex: 1, display: 'flex', my: .5, justifyContent: "center", }}>
                                            ...
                                            <Tooltip title='Verify' color='primary' >
                                                <VerifiedSharpIcon sx={{
                                                    height: 28, width: 30,
                                                    color: '#0B6BCB',
                                                    cursor: 'pointer', border: 1, borderRadius: 5, p: .1, mx: .5,
                                                    '&:hover': { color: '#41729F' },
                                                }
                                                }
