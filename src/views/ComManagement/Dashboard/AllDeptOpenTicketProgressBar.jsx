...
const AllDeptOpenTicketProgressBar = () => {
    ...
    return (
        <Box sx={{ flex: 1, border: 1, borderColor: 'lightgrey', p: 1, bgcolor: 'white', borderRadius: 5, mt: .5 }}>
            <Box sx={{ flex: 1, display: 'flex' }}>
                <TextComponent text={"Tickets Response TAT"} sx={{ flex: 1, fontWeight: 600, fontSize: 16, color: '#5D6C89' }} />
                <Box sx={{ width: 150 }}>
                    <Input
                        variant="soft"
                        color='primary'
            ...
            <Box sx={{ width: '100%', height: 233 }}>
                {opentimeRangeData.length > 0 ? (
                    <BarChart
                        ...
                        xAxis={[{
                            data: opentimeRangeLabels, scaleType: "band",
                        }]}
                    ...
                    <BarChart
                        series={[
                            { data: EmptyData, label: 'EmptyData', id: 'EmptyData', stack: 'total' },
                        ]}
                        xAxis={[{
...
export default memo(AllDeptOpenTicketProgressBar)