...
const AllDeptTicketProgressList = () => {
    ...
    return (
        <Box sx={{ flex: 1, border: 1, borderColor: 'lightgrey', px: 1, py: .5, bgcolor: 'white', borderRadius: 5 }}>
            <Box sx={{ flex: 1, display: 'flex' }}>
                <TextComponent text={"Ticket Status Across Departments"} sx={{ flex: 1, fontWeight: 600, fontSize: 16, color: '#5D6C89' }} />
