...
const FloorCreationTable = ({ count, rowSelect }) => {
  ...
  const [column] = useState([
    ...
    { headerName: 'Block', field: 'rm_buildblock_name', wrapText: true, minWidth: 300 },
    ...
    { headerName: 'floor Number', field: 'rm_floor_no', wrapText: true, minWidth: 100 },
    { headerName: 'Floor Code', field: 'floor_order', wrapText: true, minWidth: 150 },
