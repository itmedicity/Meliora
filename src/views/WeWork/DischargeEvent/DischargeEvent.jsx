  ...
  return (
    <Paper square elevation={3} sx={{ dispaly: 'flex', justifyContent: 'column' }}>
      <Box sx={{ display: 'flex', backgroundColor: '#f0f3f5' }}>
        <Box sx={{ flex: 1 }}>
          <Typography sx={{ fontFamily: 'Roboto', fontSize: 20, p: 1.5 }}>DischargeEvents</Typography>
        </Box>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', width: '100%', pl: 2, pt: 1 }}>
        ...
        >
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Discharge Type:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '55%', md: '50%', sm: '49%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="text" name="disType" value={disType} onchange={getDiscType} />
          </Box>
        </Box>
        <Box
          sx={{
        ...
        >
          <Box sx={{ width: { xl: '35%', lg: '48%', md: '50%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Discharge Medicine Received time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '50%', md: '49%', sm: '50%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="datetime-local" name="disType" value={medtime} onchange={getmedtime} />
          </Box>
        </Box>
      </Box>
      <Box sx={{ display: 'flex', flexDirection: 'row', width: '100%', pl: 2, pt: 1 }}>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Summary time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '55%', md: '50%', sm: '49%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="datetime-local" name="disType" value={sumrytym} onchange={getsumryTym} />
          </Box>
        </Box>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '35%', lg: '48%', md: '50%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Discharge medicine indent time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '50%', md: '49%', sm: '50%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="datetime-local" name="disType" value={indeTym} onchange={getIndentTym} />
          </Box>
        </Box>
      </Box>
      <Box sx={{ display: 'flex', flexDirection: 'row', width: '100%', pl: 2, pt: 1 }}>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Discharge Anounced date:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '55%', md: '50%', sm: '49%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="datetime-local" name="distime" value={distime} onchange={getdisTime} />
          </Box>
        </Box>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '35%', lg: '48%', md: '50%', sm: '49%' } }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', width: '100%', pl: 2, pt: 1 }}>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Discharge entry time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '55%', md: '50%', sm: '49%' }, height: 40 }}>
            <TextFieldCustom
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '35%', lg: '48%', md: '50%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography> Actual entry time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '50%', md: '49%', sm: '50%' }, height: 40 }}>
            <TextFieldCustom
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', width: '100%', pl: 2, pt: 1 }}>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Final bill ready time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '55%', md: '50%', sm: '49%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="datetime-local" name="billtime" value={billtime} onchange={getbilltime} />
          </Box>
        </Box>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '35%', lg: '48%', md: '50%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Actual Ready time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '50%', md: '49%', sm: '50%' }, height: 40 }}>
            <TextFieldCustom
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', width: '100%', pl: 2, pt: 1 }}>
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Discharge time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '55%', md: '50%', sm: '49%' }, height: 40 }}>
            <TextFieldCustom
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', width: '50%' }}>
          <Box sx={{ width: { xl: '35%', lg: '48%', md: '50%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Actual Discharge time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '50%', md: '49%', sm: '50%' }, height: 40 }}>
            <TextFieldCustom
      ...
      <Box sx={{ display: 'flex', width: '100%', pl: 2, pt: 1 }}>
        <Box sx={{ width: '50%', display: 'flex', flexDirection: 'row' }}>
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Cross consulation if any:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '55%', md: '50%', sm: '49%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="text" name="disType" value={cross} onchange={getconstation} />
          </Box>
        </Box>
        <Box sx={{ width: '50%', display: 'flex', flexDirection: 'row' }}>
          <Box sx={{ width: { xl: '35%', lg: '48%', md: '50%', sm: '49%' } }}>
            <CssVarsProvider>
              <Typography>Room clearence time:</Typography>
            </CssVarsProvider>
          </Box>
          <Box sx={{ width: { xl: '50%', lg: '50%', md: '49%', sm: '50%' }, height: 40 }}>
            <TextFieldCustom size="sm" type="datetime-local" name="disType" value={clearence} onchange={getcleartime} />
          </Box>
        </Box>
      </Box>
      <Box sx={{ width: '100%', display: 'flex', flexDirection: 'row', pl: 2, pt: 1 }}>
        <Box sx={{ width: '50%', display: 'flex', flexDirection: 'row' }}>
          <Box sx={{ width: { xl: '30%', lg: '40%', md: '40%', sm: '49%' }, flexDirection: 'row' }}>
            <CssVarsProvider>
              <Typography>Feedback collected:</Typography>
            </CssVarsProvider>
          </Box>
