        ...
        <Fragment>
            <Box sx={{ flex: 1, display: 'flex', mt: 1 }}>
                <Box sx={{ flex: 4, display: 'flex', justifyContent: 'flex-end', }}>
                    <Box sx={{ flex: 2.5, }}></Box>
                    <Box sx={{ flex: 3, display: 'flex', pt: 1, fontWeight: 500, fontSize: 18, color: '#C7C8CB' }}>
                        <Box sx={{ flex: 1 }}>
                            <TmDepartmentSelect
                    ...
                    <Box sx={{ display: 'flex', flex: 1, pt: 1, pl: 1, }}>
                        <Tooltip title="search" placement="bottom">
                            <Box sx={{ border: 1, borderRadius: 7, color: '#055C9D', cursor: 'pointer' }}> <SearchIcon sx={{ color: '#055C9D' }}
                                onClick={searchdept} /></Box>
                        </Tooltip>
                        <Tooltip title="refresh" placement="bottom">
                            <Box sx={{ ml: .5, border: 1, borderRadius: 7, color: '#055C9D', cursor: 'pointer' }}> <ReplayIcon sx={{ color: '#055C9D' }}
                                onClick={refresh} /></Box>
                        </Tooltip>
                    </Box>
                </Box>
