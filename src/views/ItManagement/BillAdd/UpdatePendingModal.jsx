...
const UpdatePendingModal = ({ pendingModalOpen, setpendingModalFlag, setpendingModalOpen, billData, index_no, billCount, setbillCount, bill_description, filezUrls }) => {
    ...
    const updateBilling = useCallback((e) => {
        e.preventDefault()
    ...
    }, [MonthlyAdd, selectFile, QuarteryAdd, YearlyAdd, billnumber, otherBillAdd, billCount, billamount, billdate, billduedate, handleImageUpload, index_no,
        setbillCount, bill_tariff,
        handleClose,
        billpaiddate, payedStatus])
