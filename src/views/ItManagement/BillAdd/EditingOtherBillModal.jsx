...
const EditingOtherBillModal = ({
  ...
  return (
    <Box>
      ...
      >
        <Box sx={{ margin: 'auto' }}>
          <ModalDialog variant="outlined" sx={{ width: 900 }}>
            ...
            >
              ...
              <Box sx={{ flex: 1, mt: 1.5, ml: 2, fontWeight: 600 }}>
                <ReceiptIcon sx={{ pb: 0.5, fontSize: 20, fontWeight: 800 }} />
              ...
              <Box sx={{ flex: 1, mt: 1.5, ml: 2, fontWeight: 600 }}>
                <NotesIcon sx={{ pb: 0.5, fontSize: 20 }} />
                Bill Description
              </Box>
              <Box sx={{ flex: 1, mx: 2 }}>
                <CssVarsProvider>
              ...
              <Box sx={{ flex: 1, mt: 1.5, ml: 2, fontWeight: 600 }}>
                <CurrencyRupeeIcon sx={{ pb: 0.5, fontSize: 20 }} />
              ...
              <Box sx={{ flex: 1, mt: 1.5, ml: 2, fontWeight: 600 }}>
                <InsertInvitationIcon sx={{ pb: 0.5, fontSize: 20 }} />
