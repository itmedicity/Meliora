...
const BillAddModal = ({ open, setAddModalFlag, setaddModalOpen, billCount, setbillCount, }) => {
    ...
    }, [PostData, InsertOtherBills, billName, billCount, selectFile,
        handleClose,
        billCategory, bill_amount, bill_date, bill_due_date, bill_number, handleImageUpload,
        setbillCount, tarrif, bill_paid_date, payedStatus])
                ...
                <ModalDialog variant="outlined"
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{ flex: 1, mt: 1.5, ml: 2, fontWeight: 600 }}>
                            <PaidIcon sx={{ pb: .5, fontSize: 20 }} />Tariff<span style={{ color: '#74112F' }} >*</span>
                        </Box>
                        <Box sx={{ flex: 1, mx: 2 }}>
                            ...
                            <Box>
                                {billType === 3 ?
                                    <Box>
                                        ...
                                        <Paper sx={{ mx: 2, borderRadius: 0, bgcolor: '#F0F2F3', boxShadow: '0px 0px 3px' }}>
                                            <Box sx={{ flex: 1, mt: 1.5, fontWeight: 600, px: .5, color: '#54627B' }}>
                                                <ManageSearchIcon sx={{ fontSize: 20, color: '#54627B' }} />Asset No.<span style={{ color: '#74112F' }} >*</span>
                                            </Box>
                                        ...
                                        <Box sx={{ flex: 1, mt: 1.5, ml: 2, fontWeight: 600 }}>
                                            <CurrencyRupeeIcon sx={{ pb: .5, fontSize: 20, fontWeight: 800 }} />Bill Amount<span style={{ color: '#74112F' }} >*</span>
                                        </Box>
                                        <Box sx={{ flex: 1, mx: 2 }}>
                                            <TextFieldCustom
                                                placeholder="$0.00"
                                        ...
                                        <Box sx={{ border: '1px', borderStyle: 'dashed', mt: .5, py: .5, borderColor: '#41729F', display: 'flex', pl: .5, mx: 1.8 }}>
                                    ...
                                    <Box>
                                        ...
                                        <Box sx={{ border: '1px', borderStyle: 'dashed', mt: .5, py: .5, borderColor: '#41729F', display: 'flex', pl: .5, mx: 1 }}>
                                            <Box sx={{ m: .5, border: 1, borderColor: '#41729F', borderRadius: 8, flex: 1, pl: 1, fontSize: 13, color: '#05445E', margin: 'auto' }}>
                                                <label htmlFor="file-input">
                                                    <DriveFolderUploadIcon sx={{ cursor: 'pointer', color: '#175873', height: 30, width: 30, '&:hover': { color: '#189AB4' }, }} />&nbsp;Bill Attach
                                                </label>
                                ...
                                {billCategoryName === 'CUG' ?
                                    <Box>
                                        ...
                                        {checkFlag === 1 ?
                                            <>
                                                <Box sx={{ flex: 1, mt: 1, ml: 2, fontWeight: 600 }}>
                                                    <SimCardSharpIcon sx={{ pb: .5, fontSize: 20 }} />Sim Type<span style={{ color: '#74112F' }} >*</span>
                                                </Box>
                                                <Box sx={{ flex: 1, mx: 2 }}>
