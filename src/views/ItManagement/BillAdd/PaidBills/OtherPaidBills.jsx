            ...
            <Box sx={{ flex: 1, my: .2 }}>
                {otherBills.length !== 0 ?
                    <Box sx={{ flex: 1, display: 'flex', bgcolor: '#868B8E', minHeight: 30, pt: .5 }}>
                        ...
                        <Box sx={{ flex: 2, fontWeight: 600, color: 'white', pl: 1, }}>Bill Date
                        ...
                        <Box sx={{ flex: 2, pl: .5, fontWeight: 600, color: 'white', }}>Bill amount</Box>
                        <Box sx={{ flex: 6, pl: 2, fontWeight: 600, color: 'white', }}>Bill Name<ManageSearchIcon sx={{ color: 'white', height: 20, width: 30, cursor: 'pointer' }}
