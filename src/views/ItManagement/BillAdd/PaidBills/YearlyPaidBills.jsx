            ...
            <Box sx={{ flex: 1, my: .2 }}>
                {yearBills.length !== 0 ?
                    <Box sx={{ flex: 1, display: 'flex', bgcolor: '#868B8E', minHeight: 30, pt: .5, }}>
                        ...
                        <Box sx={{ flex: 2, fontWeight: 600, color: 'white', }}>Bill Date
                        ...
                        <Box sx={{ flex: 6, fontWeight: 600, color: 'white', }}>Bill Name<ManageSearchIcon sx={{ color: 'white', height: 20, width: 30, cursor: 'pointer' }}
