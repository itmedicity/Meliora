...
const WeekCountTable = ({ weektableData, setWeektabflag, weekflag, count, setCount }) => {
    ...
    return (
        <Fragment>
            <Paper>
                {flag === 1 ? < ModalWeeklyVerification open={modalopen} handleClose={handleClose} rowSelect={view} count={count} setCount={setCount} /> :
                            ...
                            <Table borderAxis="both" padding={"none"} stickyHeader >
                                <thead style={{ alignItems: 'center' }}>
                                    <tr>
                                        ...
                                        {weekflag === 1 ? <th rowSpan={2} style={{ width: 120, textAlign: 'center' }}>Backup Date</th> : null}
                                        ...
                                        {weekflag === 3 ? <th rowSpan={2} style={{ width: 160, textAlign: 'center' }}>Date </th> : null}
                                        {weekflag === 3 ? <th rowSpan={2} style={{ width: 100, textAlign: 'center' }}>Employee </th> : null}
                                        {weekflag === 3 ? <th rowSpan={2} style={{ width: 100, textAlign: 'center' }}>Status</th> : null}
                                        {weekflag === 3 ? <th rowSpan={2} style={{ width: 150, textAlign: 'center' }}>Remarks</th> : null}
                                    </tr>
                                ...
                                <tbody size='small' style={{ height: 8 }}>
                                    {weektableData?.map((val, index) => (
                                        <tr key={val.weekly_slno} size='small'
                                            ...
                                            {weekflag === 3 ? <td>{(val.verify_status === 1) ? 'Successfull' : (val.verify_status === 2) ? 'Not Successfull' : 'Not Updated'}</td> : null}
