...
const DayCountTable = ({ dayTabledata, dayflag, setDaytabflag, count, setCount }) => {
    ...
    return (
        <Fragment>
            <Paper>
                {flag === 1 ? < ModalDashboardVerify open={modalopen} handleClose={handleClose} rowSelect={view} count={count} setCount={setCount} /> :
                                ...
                                <Table borderAxis="both" padding={"none"} stickyHeader >
                                    <thead style={{ alignItems: 'center' }}>
                                        <tr>
                                            ...
                                            {dayflag === 1 ? <th rowSpan={2} style={{ width: 120, textAlign: 'center' }}>Backup Date</th> : null}
                                            {dayflag === 2 || dayflag === 3 ?
                                            ...
                                            {dayflag === 3 ? <th rowSpan={2} style={{ width: 160, textAlign: 'center' }}>Date </th> : null}
                                            {dayflag === 3 ? <th rowSpan={2} style={{ width: 100, textAlign: 'center' }}>Employee </th> : null}
                                            {dayflag === 3 ? <th rowSpan={2} style={{ width: 100, textAlign: 'center' }}>Status</th> : null}
                                            {dayflag === 3 ? <th rowSpan={2} style={{ width: 150, textAlign: 'center' }}>Remarks</th> : null}
                                        </tr>
                                    ...
                                    <tbody size='small' style={{ height: 8 }}>
                                        {dayTabledata?.map((val, index) => (
                                            <tr key={val.daily_slno} size='small'
                                                ...
                                                {dayflag === 3 ? <td>{(val.verify_status === 1) ? 'Successfull' : (val.verify_status === 2) ? 'Not Successfull' : 'Not Updated'}</td> : null}
