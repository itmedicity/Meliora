...
const TarrifModalBillAdds = ({ open, handleClose, getarry,count,setCount, }) => {
    

    const { device_type_name, dept_name, reciver_name,providername, amount,device_name,monthly_slno
    ...
    const { bill_amount,bill_date,bill_due_date,bill_number,bill_entered_date,file_upload_status,payed_status
      ...
      const reset = () => {
        ...
        }, [monthly_slno,  bill_date,bill_due_date,bill_number,bill_entered_date,file_upload_status,payed_status,bill_amount
           ])
                    ...
                    // pt: 1, 
                            ...
                            <CssVarsProvider>
                                ...
                                <Box
                                  ...
                                  <Box sx={{flex:.3,pl:1}}>
                            <CssVarsProvider>
                                <Typography sx={{ fontSize: 15 }}>Tarrif Amount</Typography>
                                    </CssVarsProvider>
                                    </Box>
...
export default memo(TarrifModalBillAdds)