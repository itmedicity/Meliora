...
const TarrifModalBillAdds = ({ open, handleClose, getarry, setMonthlyCount, monthlyCount }) => {
  ...
  const submitModal = useCallback((e) => {
    ...
    if (billAmount !== '' && !containsOnlyDigits(billAmount)) {
  ...
  }, [patchdata, handleImageUpload, handleClose, billDate, billDueDate, billNo,
    billAmount, monthly_slno, setMonthlyCount, monthlyCount, selectFile]);
