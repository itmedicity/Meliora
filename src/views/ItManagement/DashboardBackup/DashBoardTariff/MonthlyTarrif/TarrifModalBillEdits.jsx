...
const TarrifModalBillEdits = ({ open, handleClose, getarry, count,setCount,}) => {
    

    const { device_type_name, dept_name, reciver_name, bill_due_date, providername, amount, bill_date, bill_amount,
        bill_entered_date, file_upload_status, bill_number, monthly_slno, payed_status, device_name
    } = getarry
    ...
    }, [monthly_slno,billDate,billAmount,billDueDate,billNo,billPayedDate,fileUploadStatus,billPayedStatus])
