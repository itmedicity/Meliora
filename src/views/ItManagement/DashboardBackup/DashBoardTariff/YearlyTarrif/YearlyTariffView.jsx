...
const YearlyTariffView = ({yearlydata,setBackdashboard,setyearly}) => {
    ...
    return (
        ...
        {AddModalFlag === 1 ? <YearlyBillEdits open={addModalOpen} handleClose={handleClose}
         ...
         getarry={getarry} editFlag={editFlag} /> : null}
           <CssVarsProvider>
           <Typography sx={{ fontWeight: 10, fontSize: 28, fontFamily: 'Anton',color:'#003060' }}>Yearly Tarrif </Typography>
