                            ...
                            <Box sx={{ display: "flex", flexDirection: 'column', justifyContent: "center", width: "100%" }}>
                                ...
                                <Box sx={{ display: 'flex' }}>
                                    ...
                                    <Box sx={{ flex: 3.5, display: 'flex', flexDirection: 'row' }}>
                                        <Typography style={{ fontSize: 15, color: '#274472' }}>:&nbsp; Before Compression-&nbsp; {backup_size_before} KB</Typography>
                                        <Typography style={{ fontSize: 15, color: '#274472' }}>,&nbsp; After Compression-&nbsp; {backup_size_after} KB</Typography>
                                    </Box>
                                </Box>
                                <Box sx={{ display: 'flex', }}>
                                    <Box sx={{ flex: 1, pl: 1 }}>
