...
import { getescalationlvl3 } from 'src/redux/actions/Level3Escalation.action';
import Level3Table from './Level3Table'
import { getEscalationMapping } from 'src/redux/actions/EscalationMapping.action';
import { getEscalationMappingLvl3Main } from 'src/redux/actions/EscalationMappingLvl3Main.action';
import { getEscalationMappingLvl3It } from 'src/redux/actions/EscalationMappingLvl3It.action';
const Level3escalation = () => {
    ...
    // }, [dispatch])
    // const level3 = useSelector((state) => {
    ...
    useEffect(() => {
        if (bc !== 0) {
            dispatch(getescalationlvl3(timeescalationData)).then(() => {
                setCheck(2)
            })
        }
    ...
    const complaints = useSelector((state) => {
        return state.getescalationlvl3.lvl3scalation
    })
    ...
    useEffect(() => {
        if (escmap.length !== 0) {
            dispatch(getEscalationMappingLvl3Main(postdata2))
            dispatch(getEscalationMappingLvl3It(postdata))
        }
...
export default Level3escalation