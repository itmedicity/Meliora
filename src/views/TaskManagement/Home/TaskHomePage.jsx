...
const TaskHomePage = () => {
  ...
  const aa = [
    { slno: 1, task: 'dgfgfgfg', date: 'Yesterday' },
    { slno: 2, task: 'dgfgfgfg', date: 'Yesterday' },
    { slno: 3, task: 'dgfgfgfg', date: 'Yesterday' },
    { slno: 4, task: 'dgfgfgfg', date: 'Yesterday' },
    { slno: 5, task: 'fgfdgdf', date: 'Yesterday' },
    { slno: 2, task: 'dgfgfgfg', date: 'Yesterday' },
    { slno: 3, task: 'dgfgfgfg', date: 'Yesterday' },
    { slno: 4, task: 'dgfgfgfg', date: 'Yesterday' },
    { slno: 5, task: 'fgfdgdf', date: 'Yesterday' },
  ...
  return (
    ...
    >
      ...
      >
        <CssVarsProvider>
          <Typography
            sx={{ textTransform: 'capitalize', bold: true, fontSize: 25, font: 'Roboto' }}
          >
            Good Morning,{id.toLowerCase()}
          </Typography>
        </CssVarsProvider>
      </Box>
      ...
      >
        <CssVarsProvider>
          <Button size="xs" variant="outlined" fullWidth sx={{ backgroundColor: '#eeeeee' }}>
            <Box
              sx={{
                display: 'flex',
                flexDirection: 'row',
            ...
            >
              <CssVarsProvider>
                <Typography sx={{ fontSize: 15, pr: 1 }}>
                  <DoneIcon />
                </Typography>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <CssVarsProvider>
                    <Typography sx={{ bold: true, fontSize: 20, fontWeight: 500 }}>
                      MY Tasks
                    </Typography>
                ...
                >
                  <CssVarsProvider>
                    <Button onClick={upComming} variant="contained" size="small" color="primary">
                      Up Comming
                    </Button>
                  </CssVarsProvider>
                  <CssVarsProvider>
                    <Button onClick={overdue} variant="contained" size="small" color="primary">
                      Overdue
                    </Button>
                  </CssVarsProvider>
                  <CssVarsProvider>
                    <Button onClick={completed} variant="contained" size="small" color="primary">
                      Completed
                    </Button>
                  </CssVarsProvider>
                </Box>
                      ...
                      {addTask === 1 ? (
                        <TableBody>
                          <TableCell align="left" width={0}>
                            <IconButton sx={{ paddingY: 0.5 }} onClick={() => AddTAsk()}>
          ...
          >
            ...
            >
              ...
              >
                <IconButton onClick={() => createNewProject()}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <CssVarsProvider>
                    <Button color="#9e9e9e" variant="contained" disabled></Button>
                  </CssVarsProvider>
                </Box>
