...
const PendingAssingments = ({ tableCount, setTableCount }) => {
    ...
    return (
        <Paper sx={{ pb: .3, bgcolor: 'white' }}>
            ...
            {editModalFlag === 1 ?
                <EditPendingAcceptance open={editModalOpen} masterData={masterData} setEditModalOpen={setEditModalOpen}
                    setEditModalFlag={setEditModalFlag}
                    tableCount={tableCount} setTableCount={setTableCount} taskcount={taskcount} settaskcount={settaskcount}
                    statuscount={statuscount} setstatuscount={setstatuscount}
                    projectcount={projectcount} setProjectcount={setProjectcount} setsecCount={setsecCount} secCount={secCount}
                /> : null}
            ...
            <Box sx={{ width: '100%', overflow: 'auto', }}>
                {taskList.length !== 0 ?
                            ...
                            itemContent={(index) => {
                                ...
                                return (
                                    <Box key={val.tm_task_slno} sx={{
                                        ...
                                        <Box sx={{ width: 50, fontWeight: 600, color: 'grey', fontSize: 12, display: 'flex' }}>
                                            <EditIcon
                    ...
                    : <Box sx={{
                        textAlign: 'center', width: 400, margin: 'auto', height: 500, pt: 25, fontWeight: 700, fontSize: 30, color: '#C7C8CB',
                    }}>
