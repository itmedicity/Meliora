    ...
    return (
        <Box>
            ...
            {taskList.length !== 0 ?
                <Box>
                    <Box sx={{
                        flex: 1, height: 45, mt: .5, mx: 1, display: 'flex', borderBottom: 1, borderTop: 1, borderColor: 'lightgray', pt: 1.5,
                        bgcolor: 'white'
                    }}>
                    ...
                    <Box sx={{ maxHeight: '60vh', overflow: 'auto' }}>
                        {taskList?.map((val, index) => {
                            return <Box key={val.tm_task_slno} sx={{
                                flex: 1, display: 'flex', mt: .3, borderBottom: 2, mx: 1, borderColor: 'lightgrey', minHeight: 30,
                                maxHeight: 80,
                ...
                <Box sx={{ height: 30, fontWeight: 800, color: 'grey', textAlign: 'center', borderColor: 'lightgray', }}>
