      ...
      <Box sx={{ width: '100%', overflowX: 'auto' }}>
        <Box sx={{ width: 2500 }}>
          ...
          >
            ...
            <Box sx={{ width: 100, fontWeight: 600, color: '#444444', fontSize: 12, pl: 1 }}>
              Status
            </Box>
            ...
            <Box sx={{ width: 500, fontWeight: 600, color: '#444444', fontSize: 12, pl: 0.5 }}>
              Description
            </Box>
          </Box>
          <Virtuoso
                    ...
                    {val.tm_project_status === 1 ? (
                      ...
                      <Box
                        sx={{
                          width: 500,
                          fontWeight: 600,
                          color: isPastDue(val.tm_project_duedate) ? '#B32600' : 'grey',
                          fontSize: 12,
                          pl: 1,
                          textTransform: 'capitalize',
                        }}
