...
import AddSubtaskAnyDept from './AddSubtaskAnyDept';
import EditsubtaskAllDept from './EditsubtaskAllDept';
import { getDepartment } from 'src/redux/actions/Department.action';
import AttachmentIcon from '@mui/icons-material/Attachment';
import SubtaskTablePendingAcceptance from './SubtaskTablePendingAcceptance';

const EditPendingAcceptance = ({ open, masterData, setEditModalFlag, setEditModalOpen, tableCount, setTableCount, taskcount, settaskcount, setsecCount, secCount,
        ...
        const getMasterTask = async (tm_task_slno) => {
            ...
            if (success === 2) {
                const { tm_task_slno, tm_task_name, tm_task_due_date, tm_task_description, tm_project_slno, tm_task_status,
                    tm_pending_remark, tm_onhold_remarks, tm_completed_remarks, tm_task_dept_sec, tm_task_dept } = data[0]
                const formdata = {
    ...
    const SubmitTask = useCallback((e) => {
        ...
        employeeMast, settaskcount, taskcount, setstatuscount, statuscount, setProjectcount, projectcount, setsecCount, secCount])
                                ...
                                <Box sx={{ mt: 1, pl: 1, }}>
                                    {
                                        flag === 1 ?
                                            ...
                                            flag === 2 ?
                                                <Box>
                                                    <EditsubtaskAllDept setflag={setflag} subTaskData={subTaskData}
...
export default memo(EditPendingAcceptance)