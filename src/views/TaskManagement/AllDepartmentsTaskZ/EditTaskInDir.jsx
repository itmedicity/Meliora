...
import SubtaskTableUnderTaskz from './SubtaskTableUnderTaskz';
import EditsubtaskAllDept from './EditsubtaskAllDept';
import { getDepartment } from 'src/redux/actions/Department.action';
import AttachmentIcon from '@mui/icons-material/Attachment';

const EditTaskInDir = ({ open, masterData, setEditModalFlag, setEditModalOpen, tableCount, setTableCount, taskcount, settaskcount, setsecCount, secCount,
...
export default memo(EditTaskInDir)