        ...
        <Box sx={{}}>
            {subTask.length !== 0 ?
                <Box>
                    ...
                    {subTask.length !== 0 ?
                        <Box sx={{ mt: 3, flex: 1, }}>
                            <Divider sx={{ '--Divider-childPosition': `5%`, fontWeight: 600, fontSize: 18, color: '#004369', mb: 1, mt: 2, mx: 1.5 }}>Subtask List/s</Divider>
                        </Box> :
                        null}
                                    ...
                                    {subTask?.map((val, index) => {
                                        return (
                                            ...
                                            >
                                                <td> {index + 1}</td>
                                                <td>
                                                    <EditIcon sx={{ cursor: 'pointer', '&:hover': { color: '#003060' } }} size={6}
...
export default memo(SubtaskTableUnderTaskz)