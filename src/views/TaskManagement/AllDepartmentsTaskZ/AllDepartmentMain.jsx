...
const AllDepartmentMain = () => {
    ...
    return (
        <Paper sx={{ pb: .3, bgcolor: '#DFE3ED' }}>
            {AddModalFlag === 1 ? <CreateTaskInAllDept open={addModalOpen} tableCount={tableCount} setTableCount={setTableCount}
            ...
            <Box sx={{ flex: 1, border: .1, m: .3, borderColor: '#EAEAEA', borderRadius: 1, bgcolor: 'white', }}>
                ...
                <Box sx={{
                    mx: 6, width: 155, color: 'black', bgcolor: '#79A9F5', boxShadow: 1, borderRadius: 30, border: 1,
                                ...
                                <Box sx={{ display: 'flex', flex: 1, mb: 0, borderBottom: 1, borderColor: 'lightgray' }} >
                                    <Box sx={{ flex: 2, display: 'flex', px: .5 }}>
                                        <Tab disableIndicator sx={{ color: '#8C5249', fontWeight: 800, width: 140 }}>
                                            <AccountTreeIcon sx={{ color: '#8C5249' }} />&nbsp;By Projects</Tab>
                                        ...
                                        <Tab disableIndicator sx={{ color: '#613659', fontWeight: 800, width: 200 }}>
                                            <PendingActionsSharpIcon sx={{ color: '#613659' }} />&nbsp;Pending Acceptance</Tab>
                                        <Tab disableIndicator sx={{ color: '#74112F', fontWeight: 800, width: 200 }}>
                                            <AccountTreeTwoToneIcon sx={{ color: '#74112F' }} />&nbsp;Task Under Queries</Tab>
                                        <Tab disableIndicator sx={{ color: '#177DBB', fontWeight: 800, width: 100 }}>
                                            <RadarIcon sx={{ color: '#177DBB' }} />&nbsp;Goals</Tab>
