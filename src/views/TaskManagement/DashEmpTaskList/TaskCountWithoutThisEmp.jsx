            ...
            {otherempTask.length !== 0 ?
                <Box>
                    ...
                    <Accordion>
                        ...
                        <AccordionDetails>
                            {
                                otherempTask && otherempTask.map((val, index) => {
                                    ...
                                    return <Paper key={val.tm_task_slno}
                                        sx={{ minHeight: 33, maxHeight: 50, bgcolor: '#E4E5E8', borderRadius: 0, display: 'flex', mt: .5, color: 'black', }}>
                                        <Box sx={{
                                            borderRadius: 10, width: 20, height: 20, fontSize: 10, bgcolor: '#67595E', display: 'flex', justifyContent: 'center',
                                            pt: .3, fontWeight: 800, mt: 1, mx: .5, color: 'white'
                                        }}>
                                            {index + 1}
                                        </Box>
                                        <Tooltip title="Task ">
                                        ...
                                        <Tooltip>
                                            {val.tm_task_status !== 1 ?
                                                <Box sx={{ border: 1, borderRadius: 3, borderColor: '#C3CEDA', p: .5, flex: 1, justifyContent: 'center', mr: .5 }}>
                                                    <CountDowncomponent DueDates={val.tm_task_due_date} />
                                                </Box> :
                                                <Box sx={{ display: 'flex', border: 1, borderRadius: 3, borderColor: '#C3CEDA', p: .5, flex: 1, justifyContent: 'center', mr: .5 }}>
