      ...
      <Modal open={SubTaskmodalOpen}>
        ...
        >
          <Card sx={{ bgcolor: '#52688F' }}>
            ...
            {tm_project_slno !== null ? (
              <Box sx={{ flex: 1, fontSize: 24, fontFamily: 'Georgia', color: 'white', pl: 1 }}>
                <AssignmentSharpIcon sx={{ height: 30, width: 30, color: 'white' }} />
                Task
                <Typography sx={{ color: 'white', fontFamily: 'Georgia', fontSize: 16, pl: 1 }}>
                  {tm_task_name}
                </Typography>
              </Box>
            ) : (
          ...
          <Box sx={{ height: '60vw', overflow: 'auto' }}>
            <Box sx={{ mt: 1.8 }}>
              <Box sx={{ flex: 1, display: 'flex', mb: 0.8 }}>
                <Box
                  sx={{
                    flex: 1,
                    height: 30,
