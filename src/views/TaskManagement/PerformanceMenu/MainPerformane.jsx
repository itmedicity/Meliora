...
const MainPerformane = () => {
    ...
    const TotalPerformance = (EmpTotalWithouthold + empTotComplaintsWithoutOnhold) === 0 ? 0 : (((AdjustedCompleteion + emptotCompltedComplaints) / (EmpTotalWithouthold + empTotComplaintsWithoutOnhold)) * 100)
    ...
    const sortedOverdueTaskList = OverdueTaskList && [...OverdueTaskList].sort((a, b) => {
        const today = new Date();
                ...
                <Box sx={{ bgcolor: 'white', height: '100%', flex: 1, pb: 1, display: 'flex', borderRadius: 2, overflow: 'auto' }}>
                    <Box sx={{ flex: 2.5, mt: 2, pl: 2 }}>
                        <Box sx={{ flex: 1, display: 'flex', mx: 2, }}>
                            <Box sx={{ flex: 1, display: 'flex', mt: .5, ml: 1.5 }}>
                                <AutoGraphSharpIcon fontSize='large' sx={{ color: '#274472' }} />
                                <Typography sx={{ fontSize: 20, pl: .5, color: '#274472', fontWeight: 600 }}>
                        ...
                        <Box sx={{ flex: 1, mx: 2, mt: 1.5, display: 'flex', minHeight: 85 }}>
                            <Box sx={{ flex: .5, bgcolor: '#394457', textAlign: 'right', pr: 2, pt: 2.5, fontSize: 28, color: 'white', }}>
                                {monthName}
                            </Box>
                            <Box sx={{ flex: 2, display: 'flex', }}>
                                <Box sx={{ flex: 1, fontSize: 25, color: '#12467B', fontWeight: 600, bgcolor: '#DFE3ED', mx: .5 }}>
                                    <Typography sx={{ textAlign: 'center' }}>
                                        Task
                                    </Typography>
                                    <Box sx={{ flex: 1, display: 'flex', pl: 2 }}>
                                        <Box sx={{ flex: 1, display: 'flex', }}>
                                            <Box sx={{ width: 50, height: 43, bgcolor: '#12467B', textAlign: 'center', mb: .5, borderRadius: 2, mr: .5, color: 'white', pt: .3 }}>
                                                {empTotalTask}
                                            </Box>
                                        ...
                                        <Box sx={{ flex: 1, display: 'flex', }}>
                                            <Box sx={{ width: 50, height: 43, bgcolor: '#006400', textAlign: 'center', mb: .5, borderRadius: 2, mr: .5, color: 'white', pt: .3 }}>
                                                {empCompletedTask}
                                            </Box>
                                            <Typography sx={{ fontSize: 15, pt: 2 }}>
                                                Completed
                                        ...
                                        <Box sx={{ flex: 1, display: 'flex', }}>
                                            <Box sx={{ width: 50, height: 43, bgcolor: '#717982', textAlign: 'center', mb: .5, borderRadius: 2, mr: .5, color: 'white', pt: .3 }}>
                                                {onHoldEmployeeTask}
                                            </Box>
                                            <Typography sx={{ fontSize: 15, pt: 2 }}>
                                                On Hold
                                ...
                                <Box sx={{ flex: 1, fontSize: 25, color: '#460D0D', fontWeight: 600, bgcolor: '#DFE3ED', mx: .5 }}>
                                    <Typography sx={{ textAlign: 'center' }}>
                                        Complaints
                                    </Typography>
                                    <Box sx={{ flex: 1, display: 'flex', pl: 2 }}>
                                        <Box sx={{ flex: 1, display: 'flex', }}>
                                            <Box sx={{ width: 50, height: 43, bgcolor: '#460D0D', textAlign: 'center', mb: .5, borderRadius: 2, mr: .5, color: 'white', pt: .3 }}>
                                                {empTotComplaints}
                                            </Box>
                                            <Typography sx={{ fontSize: 15, pt: 2 }}>
                                                Total
                    ...
                    <Box sx={{ flex: 1, mr: 1, }}>
                        <Box sx={{ width: 180, height: 33, margin: 'auto', bgcolor: '#394457', mr: .1, borderRadius: 1, px: 2.5, my: 0, mt: 1 }}>
                            <CssVarsProvider>
                                <Input
                                    size="sm"
                        ...
                        <Typography sx={{ flex: 1, textAlign: 'center', bgcolor: '#DFE3ED', fontWeight: 600, mt: .5, fontSize: 40, px: .5, color: '#394457' }}>
                            Pending Task
                        </Typography>
                        ...
                        <Box sx={{ height: '70vh', overflow: 'auto' }}>
                            {sortedOverdueTaskList.length !== 0 ?
                                <>
                                    <Box sx={{ flex: 1, }}>
                                        {sortedOverdueTaskList && sortedOverdueTaskList
                                            .map((val) => {
                                                return (
