                ...
                <Box sx={{ bgcolor: 'white', p: 1, }} >
                    ...
                    <Box sx={{ width: '100%', overflow: 'auto', }}>
                        ...
                        {tableDataEmployee.length !== 0 ?
                                    ...
                                    itemContent={(index) => {
                                        ...
                                        return (
                                            <Box key={val.tm_task_slno} sx={{
                                                flex: 1, display: 'flex', mt: .1, borderBottom: 2, mx: .5, borderColor: 'lightgrey', minHeight: 30,
                                                maxHeight: 80,
                            ...
                            : <Box sx={{ textAlign: 'center', width: 200, margin: 'auto', height: 600, pt: 20, fontWeight: 700, fontSize: 30, color: '#C7C8CB' }}>
                                No Dues
                            </Box>}
                    </Box>
