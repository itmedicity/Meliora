    ...
    return (
        ...
        <Box>
            {tabledata.length !== 0 ?
                    ...
                    <Box sx={{ width: '100%', overflow: 'auto' }}>
                        <Box sx={{ width: 2200, }}>
                            <Box sx={{
                                ...
                                <Box sx={{ width: 70, textAlign: 'center', fontWeight: 600, color: '#444444', fontSize: 12, }}>Action</Box>
                                <Box sx={{ width: 60, textAlign: 'center', fontWeight: 600, color: '#444444', fontSize: 12, }}>Files</Box>
                                <Box sx={{ width: 140, textAlign: 'center', fontWeight: 600, color: '#444444', fontSize: 12, }}>Status</Box>
                                <Box sx={{ width: 250, fontWeight: 600, color: '#444444', fontSize: 12, textAlign: 'center', }}>CountDown</Box>
                                    ...
                                    itemContent={(index) => {
                                        ...
                                        return (
                                            <Box key={val.tm_task_slno} sx={{
                                                ...
                                                {val.tm_task_status === 1 ?
                                                    <Box sx={{ width: 700, fontWeight: 600, color: 'grey', fontSize: 12, textTransform: 'capitalize', pl: 1 }}>
                                                        {val.tm_task_name || 'not given'}
                                                    </Box> :
                                                    <Box sx={{
                                                        width: 700, fontWeight: 650, color: isPastDue(val.tm_task_due_date) ? '#B32800' : 'grey', fontSize: 12,
                                                ...
                                                {val.tm_task_status === 1 ?
                                                    ...
                                                    <Box sx={{
                                                        width: 700, fontWeight: 600, color: isPastDue(val.tm_task_due_date) ? '#B32800' : 'grey', fontSize: 12,
                                                        textTransform: 'capitalize', pl: 1
                                                    }}>
                                                        {val.tm_project_name || 'not given'}
                                                    </Box>
                ...
                <Box sx={{ textAlign: 'center', pt: 20, height: 500, fontWeight: 700, fontSize: 30, color: '#C7C8CB', }}>
                    No Task Asssigned!
                </Box>
            }
        </Box >
