              ...
              <Box>
                <Box sx={{ flex: 1, mt: 3.2 }}>
                  ...
                  <Box sx={{ display: 'flex', pt: 1, fontFamily: 'Georgia', color: '#000C66' }}>
                    ...
                    <Box sx={{ flex: 8, textTransform: 'capitalize', mr: 2 }}>:&nbsp;{depmt}</Box>
                  </Box>

                  <Box sx={{ display: 'flex', pt: 1, fontFamily: 'Georgia', color: '#000C66' }}>
                    <Box sx={{ flex: 0.9, ml: 3 }}>Section</Box>
                    <Box sx={{ flex: 8, textTransform: 'capitalize', mr: 2 }}>:&nbsp;{depmtSec}</Box>
                  </Box>
                      ...
                      {selectTaskfile &&
                        selectTaskfile.map((taskFile, index) => (
                          ...
                          >
                            ...
                            <Box sx={{ ml: 0.3 }}>
                              <CloseIcon
                                sx={{ height: '17px', width: '20px', cursor: 'pointer' }}
...
export default memo(EmpStatusUpdationinDash)
