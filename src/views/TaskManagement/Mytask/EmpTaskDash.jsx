  ...
  return flag === 1 ? (
    ...
    <Paper sx={{ minHeight: '90vh', p: 0.5, width: "100%" }}>
      <Box sx={{ display: 'flex', borderBottom: 0.1, borderColor: 'lightgrey', height: 40 }}>
        ...
        <Box sx={{ pt: 1.2, color: '#C7C8CB', bgcolor: 'white' }}>My Task</Box>
      </Box>
      <Box sx={{ bgcolor: ' #DFE3ED', height: '100%', p: 0.3 }}>
        <Box sx={{ bgcolor: 'white', height: '100%', pb: 0.5 }}>
                  ...
                  <Box sx={{ flex: 1, mx: 1 }}>
                    ...
                    <Box sx={{ flex: 1, textAlign: 'center', fontSize: 15, display: 'flex' }}>
                      ...
                      <Box sx={{ flex: 1, display: 'flex', justifyContent: 'flex-end' }}>
                        ...
                        >
                          <Box sx={{ fontSize: 18, color: '#341948' }}>{employeeOnHold.length}</Box>
                        </Avatar>
                      </Box>
                    </Box>
                  </Box>
