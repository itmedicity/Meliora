      ...
      <Modal open={dueDateModal}>
        ...
        >
          <Box sx={{ minHeight: 500, maxHeight: 900 }}>
            <Box sx={{ flex: 1, display: 'flex', borderBottom: 1, pb: 0.5, borderColor: '#E9EAE0' }}>
            ...
            >
              ...
              <Box sx={{ flex: 1, my: 1.5, ml: 0.5, display: 'flex' }}>
                ...
                <Box sx={{ ml: 0.5 }}>
                  ...
                  <Chip sx={{ color: '#44110E', bgcolor: 'white', border: 1 }}>{IntialDueDate}</Chip>
                </Box>
                <Box sx={{ ml: 0.5 }}>
                  <Typography sx={{ fontSize: 11, color: '#212510', fontWeight: 500, pl: 1.4 }}>
                    Current Duedate
            ...
            <Box sx={{ flex: 1, height: 25, bgcolor: '#92443A', mb: 0.5, mx: 1, display: 'flex' }}>
              ...
              <Box sx={{ flex: 3, textAlign: 'center', mb: 0.5, fontWeight: 600, color: 'white' }}>Duedate</Box>
