...
import { Box, Chip, CssVarsProvider, Grid, Modal, ModalDialog, Textarea, Typography, } from '@mui/joy'
...
const CreateDeptTask = ({ open, setAddModalFlag, setaddModalOpen, queryClient }) => {
  ...
  }, [handleClose, employee, handleImageUpload, id, insertMastTask, tm_task_name, selectFile, setInsertId, tm_task_due_date, queryClient])
    ...
    <Box>
      ...
      <CssVarsProvider>
        {addProjectFlag === 1 ? <ProjectCreation open={addProjectModalOpen}
          setAddProjectFlag={setAddProjectFlag} setaddProjectlModalOpen={setaddProjectlModalOpen} insertId={insertId}
        /> : null}
        <Modal
          ...
          <ModalDialog variant="outlined" sx={{ width: '50vw', p: 0, overflow: 'auto' }}>
            <Box sx={{ flex: 1, }}>
              ...
              <Typography sx={{ fontWeight: 800, color: 'grey', fontSize: 15, pt: 7, pl: 5.8 }}>Create Task</Typography>
