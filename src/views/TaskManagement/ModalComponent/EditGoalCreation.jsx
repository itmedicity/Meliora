...
const EditGoalCreation = ({ open, setEditGoalFlag, setEditGoalModalOpen, tableCount, setTableCount, goalData, setgoalData }) => {

    const { tm_goals_slno, tm_goal_name, tm_goal_duedate, tm_goal_fromdate, tm_goal_description, tm_goal_status, tm_goal_cmpledate } = goalData
                    ...
                    <ModalDialog variant="outlined" sx={{ width: '43vw', p: 0, }}>
                        <Box sx={{ flex: 1, }}>
                            <Box sx={{ flex: 1, display: 'flex', bgcolor: 'white', height: 30 }}>
                                <Typography sx={{ color: 'lightgray', fontSize: 12, pl: 1, flex: 1, pt: 1.5, fontWeight: 900, }}>Update Goal</Typography>
                                <HighlightOffIcon sx={{
                            ...
                            <Box sx={{ maxHeight: '65vh', overflow: 'auto' }}>
                                ...
                                <Box sx={{ flex: 1, mx: 3, mt: 3.5, display: 'flex', }}>
                                    <Box sx={{ flex: 1, mr: 1.5 }}>
                                        <Typography sx={{ pl: 1.5, color: '#003B73', fontWeight: 600, textUnderline: 1, fontSize: 12 }}>From Date*</Typography>
                                        <Inputcomponent
                                            placeholder="New Goal"
                                            type="datetime-local"
                                ...
                                <Box sx={{ flex: 1, display: 'flex', justifyContent: 'flex-end', pt: 5, pb: 2, mr: 3 }}>
                                    <Button variant="plain" sx={{ fontSize: 15 }} onClick={UpdateGoals}>Update</Button>
                                    <Button variant="plain" sx={{ fontSize: 15 }} onClick={CloseGoal}> Cancel</Button>
                                </Box>
                            </Box>
                        </Box>
                    </ModalDialog>
