...
const ProjectCreation = ({ open, setAddProjectFlag, setaddProjectlModalOpen, tableCount, setTableCount }) => {
    ...
    const { tm_project_name, tm_project_duedate, tm_project_description, tm_project_status, tm_project_cmpltedate } = projectMast
                    ...
                    <ModalDialog variant="outlined" sx={{ width: '43vw', p: 0, }}>
                        <Box sx={{ flex: 1, }}>
                            <Box sx={{ flex: 1, display: 'flex', bgcolor: 'white', height: 30 }}>
                                <Typography sx={{ color: 'lightgray', fontSize: 12, pl: 1, flex: 1, pt: 1.5, fontWeight: 900, }}>Create A New Project</Typography>
                                <HighlightOffIcon sx={{
                            ...
                            <Box sx={{ flex: 1, bgcolor: '#52688F', height: 100, mt: 1 }}>
                            </Box>
                            <Box style={{
                                marginLeft: 50,
                                marginTop: "-0.99em",
                            ...
                            <Typography sx={{ fontWeight: 800, color: 'grey', fontSize: 15, pt: 5, pl: 5.8 }}>Create Project</Typography>
                            <Box sx={{ maxHeight: '60vh', overflow: 'auto' }}>
                                <Box sx={{ flex: 1, mx: 3, mt: 4, }}>
                                    <Typography sx={{ pl: 1.5, color: '#003B73', fontWeight: 600, textUnderline: 1, fontSize: 12 }}>Project
                                ...
                                <Box sx={{ flex: 1, mx: 3, mt: 2.5, }}>
                                    <Typography sx={{ pl: 1.5, color: '#003B73', fontWeight: 600, textUnderline: 1, fontSize: 12 }}>Goal
                                    </Typography>

                                    <Box sx={{ flex: 1, display: 'flex' }}>
                                        <TmAllGoalsList
                                            goalz={goalz}
                                            setgoalz={setgoalz} setdueDateGoal={setdueDateGoal} />
                                ...
                                <Box sx={{ flex: 1, display: 'flex', justifyContent: 'flex-end', pt: 3, pb: 2, mr: 3 }}>
                                    <Button variant="plain" sx={{ fontSize: 15 }} onClick={InsertProject}>Create</Button>
