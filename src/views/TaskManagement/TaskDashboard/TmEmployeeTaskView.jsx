                                        ...
                                        return (
                                            <tr
                                                ...
                                                {val.tm_task_status !== 1 ?
                                                    ...
                                                    <td>
                                                        {val.datediff > 0 ?
                                                            <Chip sx={{ backgroundColor: '#EECE88', borderRadius: 20, color: '#3B0404', fontWeight: 600, fontSize: 12 }}>
                                                                {val.days} Days - {val.hours}h: {val.minutes}m: {val.seconds}s
                                                            </Chip> :
                                                            <Chip style={{ color: '#578E87', fontWeight: 600, fontSize: 12 }}> Completed On Time</Chip>
                                                        }</td>}
                                                {val.tm_task_status === 1 ?
