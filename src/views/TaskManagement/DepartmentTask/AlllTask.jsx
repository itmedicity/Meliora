...
const AlllTask = () => {
  ...
  const { data: AllTaskList = [], isSuccess: DeptTaskSuccess, isError: DeptTaskError, isLoading: DeptTaskLoading } = useQuery({
    queryKey: ['getIncompletedAllTaskUnderDepartment', empDept],
    queryFn: () => getAllTaskUnderDepartment(empDept),
    enabled: !!empDept,
  });
