...
const ServiceFileAttach = ({ imageServiceUrls, serviceimageViewOpen, servicefileDetails, setimageServiceFlag, setServiceimageViewOpen,
            ...
            <Modal
                ...
                <ModalDialog variant="outlined" sx={{ p: 0, overflow: 'auto' }}>
                    ...
                    <Box sx={{ flex: 1, bgcolor: '#FBFCFE', border: 1, mx: 1.5, borderRadius: 5, py: .5, borderColor: '#EFEFEF' }}>
                        <Typography
                            sx={{
                                pl: 2, fontWeight: 600, fontSize: 18, pb: .5
                            }}
                        >
                            Item Under Service
                        </Typography>
