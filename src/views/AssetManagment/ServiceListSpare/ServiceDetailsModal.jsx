import { Box, Button, Checkbox, Chip, CssVarsProvider, Grid, Input, Modal, Textarea, Typography } from '@mui/joy'
...
const ServiceDetailsModal = ({ open, setOpen, setFlag, serviceDetails, count, setCount }) => {
    ...
    const { item_name, category_name, spare_asset_no, spare_asset_no_only, item_asset_no, item_asset_no_only, asset_spare_slno, am_custodian_dept_slno,
    ...
    const { am_service_details_slno, dept_service_date, expcted_service_date, expcted_service_remarks, service_on_hold_reason, condm_transf_remarks, suppl_serviced_date,
        suppl_serviced_remarks, suppl_concted_emp, } = servicee
    ...
    const serviceSparee = useCallback(async (val) => {
    ...
    }, [PostDeptServiceDetails, PatchDeptServiceDetails, PostData, PatchData, count, am_service_details_slno, serviced_emp_detail_slno, Reset,
        deptServiceSlno, flags, setCount, service_issues_identified, serviced_date, serviced_issue_remarks, spareCheckEmp]);
    ...
    const AddTostock = useCallback((e) => {
        ...
        am_custodian_dept_slno, am_custodian_deptsec_slno, am_item_map_slno, am_spare_item_map_slno, currentDateAndTime, handleImageUpload,
        insertId, spare_asset_no_only]);
    ...
    }, [PatchData, PostData, patchDataServiceHoldSpare, patchDataServiceHoldAssset, am_service_details_slno, count, item_asset_no_only, setCount, spare_asset_no_only])
                        ...
                        <Box>
                            ...
                            >
                                ...
                                <TabPanel value={2} sx={{
                                    ...
                                    >
                                        ...
                                        <Box sx={{ border: 1, borderColor: '#E0E1E3', py: 1, pl: 2 }}>
                                            ...
                                            />
                                            <Box sx={{ flex: 1, display: 'flex', mt: 1, gap: .8, pr: 2 }}>
                                                <Box sx={{ flex: 1.3 }}>
                                            ...
                                            {deptServDetailsData.length !== 0 ?
                                                <Box>
                                                    <Box sx={{ flex: 1, display: 'flex', mr: 2, bgcolor: '#EBEFFB', mt: 1, }}>
                                                    ...
                                                    {deptServDetailsData?.map((val, index) => {
                                                        return (
                                                            <Box key={val.serviced_emp_detail_slno} sx={{
                                                                flex: 1, display: 'flex', mr: 2, borderBottom: 2,
                                                                borderColor: '#E0E1E3', pt: .5
                                                            }}>
                                                ...
                                                supplierSelect !== 0 ?
                                                    <Box>
                                                        <Box sx={{ flex: 1, mt: 2 }}>
                                                            ...
                                                            <Box sx={{ pt: 1, color: 'black', fontWeight: 500 }}>
                                                                {callSupplierFlag === 1 ? (
                                                                    <CheckBoxIcon sx={{ cursor: 'pointer', color: 'black' }} onClick={callSupplier} />
                                                                ) : (
                                                                    <CheckBoxOutlineBlankOutlinedIcon sx={{ cursor: 'pointer', color: 'black' }} onClick={callSupplier} />
                                                                )}
                                                                Yes
                                                            </Box>
                                                            {callSupplierFlag === 1 ?
                                                                <Box sx={{ flex: 1, pt: .5, display: 'flex', gap: 1, pr: 1 }}>
                                                                    <Box sx={{ flex: 1.5 }}>
                                                                        <Typography sx={{ fontSize: 14, fontWeight: 600, color: 'black', pl: .5 }}>
                                                                    ...
                                                                    <Box sx={{ width: 45, }} onClick={AddServiceDetails} >
                                        ...
                                        <Box sx={{ border: 1, borderColor: '#E0E1E3', py: 1, pl: 2, mt: .5 }}>
                                            ...
                                            {flags.serviceCheck === 1 ?
                                                <Box >
                                                    <Box sx={{ flex: 1, display: 'flex', mt: 1.5, gap: 1 }}>
                                                        <Box sx={{ flex: 1 }}>
                                                            <Typography sx={{ color: '#32383E', fontSize: 14, fontWeight: 500, pl: .5 }}>
                                                                Service Completed Date<span style={{ color: '#74112F', fontSize: 15 }} >*</span>
                                                            </Typography>
                                                            <Input
                                                                type="datetime-local"
                                                                name="suppl_serviced_date"
                                                                value={suppl_serviced_date || currentDateAndTime}
                                                                onChange={UpdateServicedtl}
                                                                slotProps={{
                                                                    input: {
                                                                        max: currentDateTime,
                                                    ...
                                                    <Box sx={{
                                                        width: 180, borderRadius: 5, py: .5, bgcolor: '#1B669D',
                                                        boxShadow: '1px 2px 4px', cursor: 'pointer', color: 'white', mt: 1, mb: 2.5,
                                        ...
                                        {UploadedFiles.length !== 0 ?
                                            <Box sx={{ flex: 1, border: 1, borderRadius: 4, my: .5, borderColor: '#CDD7E1', pl: 1, mr: .5 }}>
                                        ...
                                        <Box sx={{ flex: 1, border: 1, mr: .5, borderRadius: 4, mt: .5, mb: 2, display: 'flex', borderColor: '#CDD7E1' }}>
                                            <label htmlFor="file-input">
                                                <Box sx={{
                                                    bgcolor: '#EBEFFB', px: 1.5, borderRadius: 1, cursor: 'pointer',
                                                    '&:hover': { bgcolor: '#F0F4F8', }, textAlign: 'center', height: "58px", m: .5, pt: .4,
                                                }}>
                                                    <UploadFileRoundedIcon sx={{ color: '#1873CE', }} />
                                                    <Typography sx={{ color: '#1873CE', fontSize: 13, px: .3, pt: .1, fontWeight: 600 }}>
                                                        Attach File
                                                    </Typography>
                                                </Box>
                                            </label>
                                            ...
                                            <Box sx={{ flex: 1, }}>
                                                {selectFile.length !== 0 ?
                                                    <Box sx={{ display: 'flex', flex: 1, overflowY: 'auto', border: 1, borderColor: 'lightgrey', p: .4, my: .5 }}>
                                                        {selectFile.length !== 0 &&
                                            ...
                                            <Box sx={{
                                                bgcolor: '#1873CE ', px: 1.5, borderRadius: 1, cursor: 'pointer',
                                                '&:hover': { bgcolor: '#0857A2', }, textAlign: 'center', height: "58px", m: .5, pt: .4,
                                                boxShadow: '1px 1px 3px'
                                            }} onClick={AddServiceDetails} >
                                                <UploadFileRoundedIcon sx={{ color: '#EBEFFB', }} />
                                                <Typography sx={{ color: '#EBEFFB', fontSize: 13, px: .3, pt: .1, fontWeight: 600 }}>
                                                    Upload
                                                </Typography>
                                            </Box>
                                        </Box>
                                ...
                                {spare_asset_no === undefined ?
                                    <TabPanel value={3} sx={{
                                        ...
                                        <Box
                                            ...
                                            <ServicePmTab am_item_map_slno={am_item_map_slno} item_asset_no={item_asset_no} am_spare_item_map_slno={am_spare_item_map_slno}
                                ...
                                <TabPanel value={4} sx={{
                                    ...
                                    >
                                        <BreakDownDetails alldetailsService={alldetailsService} fileView={fileView} deptServiceempList={deptServiceempList}
