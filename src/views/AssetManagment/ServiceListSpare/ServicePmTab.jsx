...
const ServicePmTab = ({ am_item_map_slno, am_category_pm_days }) => {

    const [setUpDate, setSetUpDate] = useState(0)
    ...
    useEffect(() => {
        if (isSuccess && AmcPmdetails && AmcPmdetails.length > 0) {
                ...
                {addPmFlag === 1 ?
                    <Box sx={{ flex: 1, display: 'flex', }} >
                        <Box sx={{ width: 500 }}>
                            ...
                            <Box sx={{ display: 'flex', pt: .5 }}>
                                <Box sx={{ width: 130, pt: 1 }}>
                                </Box>
                                <Box sx={{ flex: 1, gap: .5, display: 'flex', pb: 2 }}>
                                    <Box>
                                    ...
                                    return (
                                        <Box key={index} sx={{ flex: 1, display: 'flex', borderBottom: 1, borderColor: 'lightgrey', pl: 1, py: .6, gap: .5 }}>
                                            ...
                                            <Box sx={{ flex: 2, fontWeight: 600 }}>
                                                {val.status === 1 ?
                                                    <QrCode2Icon sx={{ color: 'black', border: 1, p: .1, borderRadius: 0, cursor: 'pointer' }} onClick={() => qrCodeOpen(val)} />
                                                    :
                                                    <QrCode2Icon sx={{ color: 'lightgrey', border: 1, p: .1, borderRadius: 0, }} />}
                                            </Box>
...
export default memo(ServicePmTab)