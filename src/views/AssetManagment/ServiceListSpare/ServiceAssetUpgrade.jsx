                        ...
                        {spareDetails.map((val, index) => {
                            ...
                            return (
                                <Box key={index} sx={{ flex: 1, display: 'flex', borderBottom: 1, borderColor: 'lightgrey', pt: .8, mr: 2 }}>
                                    ...
                                    <Box sx={{ width: 120, fontSize: 13, fontWeight: 500 }}>{val.spare_asset_no}/{formattedSlno}</Box>
                                    ...
                                    <Tooltip title={'By clicking, the spare will be removed from the asset and add back to the stock'}
                                        ...
                                        <Box sx={{ width: 100, textAlign: 'center', fontSize: 13, pr: .5, cursor: 'pointer' }}>
                                    ...
                                    <Tooltip title={'Click Here for Service this Spare (this will be transfered to the service list)'}
                                        sx={{ width: 200, }} placement='top'>
                            ...
                            {spareData.length !== 0 ?
                                <>
                                    ...
                                    {spareData.map((val, index) => {
                                        return (
                                            <Box key={index} sx={{
                                                flex: 1, display: 'flex', borderBottom: 1, borderColor: 'lightgrey', py: .5, mr: 2
                                            }}>
