...
import AmPMDetails from '../ItemDetailEnter/AmPMDetails';
import AMCCMCDetailAdding from '../ItemDetailEnter/AMCCMCDetailAdding';
import ItemGRNandBill from '../ItemDetailEnter/ItemGRNandBill';
import SpecDetailsComp from '../ItemDetailEnter/SpecDetailsComp';
import AssetUpgrade from '../ItemDetailEnter/AssetUpgrade';
...
const PendingDetailEntry = ({ detailArry, setpendingDetailFlag, setRender, render, count, setCount, }) => {
    ...
    const { item_name, category_name, spare_asset_no, item_asset_no, am_custodian_name, deptname, secname, am_item_map_slno,
        am_spare_item_map_slno, item_custodian_dept, item_asset_no_only, spare_asset_no_only, } = detailArry

    const spareAssetNo = item_asset_no !== undefined ? item_asset_no : spare_asset_no !== undefined ? spare_asset_no : "Not Found"
    const FormatedNo = item_asset_no_only !== undefined
    ...
    return (
        <CssVarsProvider >
            <Box sx={{
                ...
                <Box sx={{ flex: 1, border: 1, py: 1, borderColor: '#EFEFEF', mx: .5, mt: .5, bgcolor: '#FBFCFE', display: 'flex' }}>
                    <Box sx={{ flex: 1, }}>
...
export default memo(PendingDetailEntry)