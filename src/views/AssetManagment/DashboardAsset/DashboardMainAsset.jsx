...
import {
    getActiveItemsWarrentyGaurentee, getAllAmcCmcUnderCustodian, getAssetCount, getAssetValue, getCategoryDetails, getCategoryDetailsSpare,
    getExpiredAmcCmc, getExpiredWarGaur, getSpareCount, getSpareValue
            ...
            <CssVarsProvider>
                {detailOpen === 1 ?
                    <Box sx={{ bgcolor: 'white', height: '90vh' }}>
                        <AmcCmcWarGaurDetailsView setDetailOpen={setDetailOpen} detailArray={detailArray} setDetailArray={setDetailArray} />
                    </Box>
                    :
                    <Box>
                        ...
                        <Box sx={{ mx: 1, borderRadius: 5, }}>
                            <Box sx={{ display: 'flex', gap: .5 }}>
                                <Box sx={{
                                    ...
                                    <Box sx={{ fontSize: 14, fontWeight: 600, color: '#636b74', pl: 1.5, pt: 1, pb: .5 }}>
                                        AMC/CMC
                                    </Box>
                                    <Box sx={{ display: 'flex', gap: .5, px: .8 }}>
                                        <Box sx={{ flex: 1, height: 55, display: 'flex', mb: .5 }}>
                                            <Box sx={{
                                                display: 'flex',
                                                border: 1, borderColor: '#d0d6e5',
                                                flex: 1,
                                                ...
                                                <Box sx={{
                                                    fontSize: 13, fontWeight: 600, color: '#636b74', pl: 1, pt: 2, flex: 1,
                                                }}>
                                                    Active Amc/Cmc Items
                                                </Box>
                                                <Box sx={{
                                                    width: 60, display: 'flex', justifyContent: 'center', fontSize: 20, fontWeight: 600, color: '#41729F',
                                                    alignItems: 'center',
                                                }}>
                                                    {allAmcCmcCount}
                                                </Box>
