...
import PendingApprovalAccounts from './PendingApprovalAccounts'
import CondemListForAccounts from './CondemListForAccounts'

const AccountsTab = ({ menurights }) => {
        ...
        <CssVarsProvider>
          <Box sx={{ flex: 1, display: 'flex', borderBottom: 1, borderColor: '#D0D0D0' }}>
            <TextComponent
              ...
              text="Condemnation Approvals Accounts"
            />
            <Box>
          ...
          >
            ...
            <TabPanel value={0} sx={{ p: 0, flexGrow: 1 }}>
              <Box sx={{ flexGrow: 1 }}>
                <PendingApprovalAccounts empId={empId} menurights={menurights} />
              </Box>
            </TabPanel>
            <TabPanel value={1} sx={{ p: 0, flexGrow: 1 }}>
              <Box sx={{ flexGrow: 1 }}>
                <CondemListForAccounts empId={empId} menurights={menurights} />
              </Box>
            </TabPanel>
          </Tabs>
        </CssVarsProvider>
