...
import PendingApprovalGmOper from './PendingApprovalGmOper'
import CondemListForGmOpert from './CondemListForGmOpert'

const GmOprTab = ({ menurights }) => {
                ...
                <CssVarsProvider>
                    <Box sx={{ flex: 1, display: 'flex', borderBottom: 1, borderColor: '#D0D0D0' }}>
                        <TextComponent
                            ...
                            text="Condemnation Approvals GM Operations"
                        />
                        <Box>
                            <CusIconButton
                                size="sm"
                    ...
                    >
                        ...
                        <TabPanel value={0} sx={{ p: 0, flexGrow: 1, }}>
                            <Box sx={{ flexGrow: 1, }}>
                                <PendingApprovalGmOper empId={empId} menurights={menurights} />
                            </Box>
                        </TabPanel>
                        <TabPanel value={1} sx={{ p: 0, flexGrow: 1, }}>
                            <Box sx={{ flexGrow: 1, }}>
                                <CondemListForGmOpert empId={empId} menurights={menurights} />
                            </Box>
                        </TabPanel>
