...
import PendingApprovalMaterialMang from './PendingApprovalMaterialMang'
import CondemListforMatrlMang from './CondemListforMatrlMang'

const MaterialManagementTab = ({ menurights }) => {
        ...
        <CssVarsProvider>
          <Box sx={{ flex: 1, display: 'flex', borderBottom: 1, borderColor: '#D0D0D0' }}>
            <TextComponent
              ...
              text="Condemnation Approvals Materials Management"
            />
            <Box>
          ...
          >
            ...
            <TabPanel value={0} sx={{ p: 0, flexGrow: 1 }}>
              <Box sx={{ flexGrow: 1 }}>
                <PendingApprovalMaterialMang empId={empId} menurights={menurights} />
              </Box>
            </TabPanel>
            <TabPanel value={1} sx={{ p: 0, flexGrow: 1 }}>
              <Box sx={{ flexGrow: 1 }}>
                <CondemListforMatrlMang empId={empId} menurights={menurights} />
              </Box>
            </TabPanel>
          </Tabs>
        </CssVarsProvider>
