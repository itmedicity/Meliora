...
const AllPendingsMaterialMange = ({ AllDeptCondemPendingMaterials, viewForm, editForm }) => {
    return (
        <Box>
            <CssVarsProvider>
                {AllDeptCondemPendingMaterials && AllDeptCondemPendingMaterials.length > 0 ? (
                    <Table stickyHeader size='sm'
                        ...
                        <tbody >
                            {AllDeptCondemPendingMaterials
                                ?.slice()
                                .sort((a, b) => a.condem_status - b.condem_status)
                                .map((val, index) => (
                                    <tr key={index}>
                                        <td style={{ textAlign: 'center', }}>{index + 1}</td>
                                        <td >{val.condem_status <= 7 ?
                                            <Box sx={{
