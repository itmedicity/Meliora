...
import PendingApprovGenStore from './PendingApprovGenStore'
import CondemListforGenstore from './CondemListforGenstore'

const GenStoreTab = ({ menurights }) => {
        ...
        <CssVarsProvider>
          <Box sx={{ flex: 1, display: 'flex', borderBottom: 1, borderColor: '#D0D0D0' }}>
            <TextComponent
              ...
              text="Condemnation Approvals General Store"
            />
            <Box>
          ...
          >
            ...
            <TabPanel value={0} sx={{ p: 0, flexGrow: 1 }}>
              <Box sx={{ flexGrow: 1 }}>
                <PendingApprovGenStore empId={empId} menurights={menurights} />
              </Box>
            </TabPanel>
            <TabPanel value={1} sx={{ p: 0, flexGrow: 1 }}>
              <Box sx={{ flexGrow: 1 }}>
                <CondemListforGenstore empId={empId} menurights={menurights} />
              </Box>
            </TabPanel>
          </Tabs>
        </CssVarsProvider>
