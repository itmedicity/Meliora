...
const InchargePendings = ({ condemInchargePending, editForm, viewForm }) => {

    return (
        <Box>
            <CssVarsProvider>
                {condemInchargePending && condemInchargePending.length > 0 ? (
...
export default memo(InchargePendings)