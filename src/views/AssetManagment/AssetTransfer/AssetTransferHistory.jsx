    ...
    return (
        <Box>
            <Box sx={{ border: 1, flex: 1, borderColor: 'lightgray', mx: 1, mt: 1, p: 1, }}>
                <Box sx={{
                    flex: 1, pt: 1,
                    display: 'flex', gap: 1, margin: 'auto'
                }}>
                    <Box sx={{ flex: 1, }}>
                        <TextComponent
                            text={"From Date"}
                            sx={{ color: 'black', fontWeight: 500, pl: .5, fontsize: 20, textalign: 'center' }}>
                        </TextComponent>
                        <TextFieldCustom
                            type="date"
                            size="sm"
                    ...
                    <Box sx={{ flex: 1, }}>
                        ...
                        {selectedDept !== 0 ?
                            ...
                            <AssetCustodianDepartment
                                custoDian={custoDian} setCustodian={setCustodian}
                                setcustodianAllDetails={setcustodianAllDetails} custodianAllDetails={custodianAllDetails}
                            />}
