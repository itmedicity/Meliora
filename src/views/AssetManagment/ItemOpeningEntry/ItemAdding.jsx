...
const ItemAdding = ({ selectData, rackno, roomNo, count, setCount, subRoomNo, itemCount, setitemCount, getItemcount, setgetItemcount }) => {
    ...
    return (
        <Box>
            ...
            <Box sx={{ display: 'flex', flex: 1, }} >
                < ItemCountWiseMap
                    getPostData={getPostData} type={type} getPostDataSpare={getPostDataSpare} rend={rend} setrend={setrend} itemCount={itemCount}
                    getItemcount={getItemcount} disArry={disArry} setDisArry={setDisArry}
                />
            </Box>
        </Box>
    )
