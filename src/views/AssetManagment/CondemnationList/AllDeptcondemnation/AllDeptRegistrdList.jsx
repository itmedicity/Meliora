...
const AllDeptRegistrdList = ({ SatusFrom, SatusTo, viewForm }) => {
  ...
  const AllDeptCondemnation = useMemo(
    () => (AllDeptCondemList ? AllDeptCondemList.filter(row => row.hod_approve_status !== 2) : []),
    [AllDeptCondemList]
  )
...
export default memo(AllDeptRegistrdList)
