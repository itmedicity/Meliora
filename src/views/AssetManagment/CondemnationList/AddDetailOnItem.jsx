          ...
          <Box sx={{ border: 0.1, borderColor: '#E8E6E5', m: 1, height: '100%' }}>
            <Box sx={{ flex: 1, display: 'flex', ml: 1 }}>
              <Box sx={{ flex: 1 }}>
                <TextComponent
                  ...
                  sx={{ fontWeight: 600, color: '#6A5546', pl: 0.8, pt: 1, fontSize: 18 }}
                />
                <TextComponent
                  text={'Information Technpology'}
                  sx={{ fontWeight: 500, color: 'black', pl: 0.8, fontSize: 13 }}
                />
              </Box>
              <Box sx={{ pr: 1, pt: 1 }}>
                <CancelIcon
            ...
            <Box sx={{ border: 0.1, borderColor: '#E8E6E5', m: 1 }}>
              <Box sx={{ flex: 1, display: 'flex' }}>
                <TextComponent
                  text={'Item No.'}
                  sx={{ fontWeight: 500, color: 'black', pl: 0.8, pt: 1, fontSize: 14, width: 90 }}
                />
                <TextComponent
                  text={
                    spare_asset_no
            ...
            <Box sx={{ flex: 1, textAlign: 'right', py: 1, m: 1 }}>
              ...
              <Button variant="outlined" sx={buttonStyle} onClick={CloseAddModal}>
                Cancel
              </Button>
            </Box>
          </Box>
