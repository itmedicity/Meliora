...
import PendingCondemListOld from './PendingCondemListOld';
import { useNavigate } from 'react-router-dom';
import { useSelector } from 'react-redux';
import { taskColor } from 'src/color/Color';


const CondemnationAssetOld = () => {
            ...
            <CssVarsProvider>
                ...
                >
                    ...
                    <TabPanel value={0} sx={{ p: 0, flexGrow: 1, }}>
                        <Box sx={{ flexGrow: 1, }}>
                            <PendingCondemListOld empdept={empdept} empId={empId} />
                        </Box>
                    </TabPanel>
...
export default memo(CondemnationAssetOld)