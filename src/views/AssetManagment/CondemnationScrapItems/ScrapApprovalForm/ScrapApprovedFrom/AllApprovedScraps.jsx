...
const AllApprovedScraps = ({ isLoading, AllScrapsApproved, EmployeeScrapLevelForm, id }) => {
        ...
        <Box sx={{ px: 1, pt: 2 }}>
            ...
            {isLoading ? (
                ...
                <Table
                    ...
                    <tbody>
                        {AllScrapsApproved?.map((val, index) => {
...
export default AllApprovedScraps