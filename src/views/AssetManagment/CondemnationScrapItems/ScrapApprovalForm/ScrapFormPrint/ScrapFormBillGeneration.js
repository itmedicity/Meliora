...
// Helper: Convert imported image to Base64 string
...
export const ScrapFormBillGeneration = async (scrapDetails) => {
        ...
        content: [
                ...
                table: {
                    ...
                    body: [
                        [
                            ...
                            { text: `${scrap_condemn_Form_no}/${scrap_condemn_Form_slno}`, fontSize: 10, bold: true },
                            { text: 'Request Date', fontSize: 10 },
                            {
                        ...
                        [
                            { text: 'Scrap Location', fontSize: 10 },
                            { text: yard_names, colSpan: 3, fontSize: 10 },
                            '',
                            '',
                        ],
                    ]
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            ...
                            { text: 'Items', fontSize: 10, bold: true },
                            { text: 'Quantity', fontSize: 10, bold: true },
                            { text: 'Rate', fontSize: 10, bold: true }
                        ],
                        [
                            { colSpan: 3, text: 'Total Rate', fontSize: 10 },
                            '',
                            '',
                            {
                                fontSize: 10,
            ...
            },
            {
                ...
                table: {
                    ...
                    body: [
                        [
                            { colSpan: 4, text: 'Vendor Details', alignment: 'center', fillColor: '#eeeeee', fontSize: 11 },
                            '',
                            '',
                            '',
                        ],
                        [
                            { text: 'Vendor', fontSize: 10 },
                            { text: it_supplier_name, fontSize: 10, bold: true },
                            { text: 'Recipient Name', fontSize: 10 },
                            { text: recipient_name, fontSize: 10, bold: true }
                        ],
                        [
                            { text: 'Contact Number', fontSize: 10 },
                            { text: recipient_contact_number, fontSize: 10, bold: true },
                            { text: 'Vehicle Number', fontSize: 10 },
                            { text: recipient_vehicle_no, fontSize: 10, bold: true }
                        ],
                    ]
                }
            },
            {
                ...
                table: {
                    ...
                    body: [
                        [
                            { colSpan: 4, text: 'Payment Details', alignment: 'center', fillColor: '#eeeeee', fontSize: 11 },
                            '',
                            '',
                            '',
                        ],
                        [
                            { text: 'Mode of Payment', fontSize: 10 },
                            { text: payment_mode, fontSize: 10, bold: true },
                            { text: 'Payment Date', fontSize: 10 },
                            {
                        ...
                        [
                            { text: 'Acknowledge', fontSize: 10 },
                            { text: payemnt_acknowledge_by, fontSize: 10, bold: true },
                            { text: 'Payed Amount', fontSize: 10 },
                            {
                                fontSize: 10,
            ...
            },
            {
                ...
                table: {
                    ...
                    body: [
                        [
                            { colSpan: 4, text: 'Gate Pass Details', alignment: 'center', fillColor: '#eeeeee', fontSize: 11 },
                            '',
                            '',
                            '',
                        ],
                        [
                            { text: 'Gate Pass No.', fontSize: 10 },
                            { text: `GP-${String(gate_pass_request_no).padStart(6, '0')}`, fontSize: 10, bold: true },
                            { text: 'Gate Pass Req Date', fontSize: 10 },
                            {
                        ...
                        [
                            { text: 'Acknowledge', fontSize: 10 },
                            { text: gate_pass_ackowledge, fontSize: 10, bold: true },
                            { text: 'Gate Pass', fontSize: 10 },
                            { text: 'sfdf', fontSize: 10, bold: true }
                        ],
                    ]
                }
            },
...
// export const ScrapFormBillGeneration = (scrapDetails) => {
//     const {
//         amount_collected,
//         form_submit_date,
//         gate_pass_generated_date,
