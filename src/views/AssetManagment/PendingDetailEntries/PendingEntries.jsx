            ...
            {combinedList.length !== 0 ?
                <Box sx={{ overflow: 'auto', p: 1, width: '100%' }}>
                    <Box sx={{ minWidth: 1200, }}>
                        <Box sx={{
                            height: 40, display: 'flex', borderBottom: 1, borderTop: 1, borderColor: 'lightgray', pt: 1,
                            bgcolor: 'white', gap: 1.9
                        }}>
                            <Box sx={{ flex: 1, fontWeight: 600, color: 'black', fontSize: 14 }}>Inactive</Box>
                            <Box sx={{ flex: .8, pl: 1.7, fontWeight: 600, color: 'black', fontSize: 12 }}>#</Box>
                                    ...
                                    itemContent={(index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <Box sx={{ flex: .8, pl: 1.7, color: '#444444', fontSize: 14 }}>
                                                    {index + 1}
                                                </Box>

                                                <Box sx={{ flex: 1.5, color: '#444444', fontSize: 14, pl: .4 }}>
