...
const AllDeptPendingListCondem = ({ AllDeptPendingDatas, editForm, viewForm }) => {
    return (
        <Box>
            <CssVarsProvider>
                {AllDeptPendingDatas && AllDeptPendingDatas.length > 0 ? (
...
export default AllDeptPendingListCondem