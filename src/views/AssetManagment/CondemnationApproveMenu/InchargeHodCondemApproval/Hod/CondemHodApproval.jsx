...
import PendingApprovalHod from './PendingApprovalHod';
import SubmittedByHod from './SubmittedByHod';
import { useNavigate } from 'react-router-dom';
import { taskColor } from 'src/color/Color';


const CondemHodApproval = () => {
            ...
            <CssVarsProvider>
                <Box sx={{ flex: 1, display: 'flex', borderBottom: 1, borderColor: '#D0D0D0' }}>
                    <TextComponent
                        ...
                        text={`Condemnation Hod Approval`}
                    />
                    <Box>
                        <CusIconButton
                            size="sm"
                ...
                >
                    ...
                    <TabPanel value={0} sx={{ p: 0, flexGrow: 1, }}>
                        <Box sx={{ flexGrow: 1, }}>
                            <PendingApprovalHod empid={empid} empdept={empdept} />
                        </Box>
                    </TabPanel>
                    <TabPanel value={1} sx={{ p: 0, flexGrow: 1, }}>
                        <Box sx={{ flexGrow: 1, }}>
                            <SubmittedByHod empid={empid} empdept={empdept} />
                        </Box>
                    </TabPanel>
                </Tabs>
            </CssVarsProvider>
...
export default CondemHodApproval