...
const HodCondemApprovalModal = ({ modalApproveOpen, setmodalApproveOpen, setmodalApproveFlag, empId, formDetails, setformDetails, queryClient }) => {

    const { condem_mast_slno, condem_form_prefix, condem_form_no, reg_date, inch_emp, inch_level_state, inch_review_date, inch_review, req_dpt_name, } = formDetails
        ...
        (e) => {
            ...
            const FormUpdate = async (ApproveData) => {
                ...
                if (success === 2) {
                    ...
                    queryClient.invalidateQueries('CondemnHodPendingApproval')
                    CloseModal()
                } else {
                    infoNotify(message)
                }
...
export default memo(HodCondemApprovalModal)