...
import EditInchargeCondemDetails from './EditInchargeCondemDetails';
...
const InchargeApprovedCondemn = ({ empdept, empid }) => {
    ...
    const { data: InchargePendingApprovalList = [], isLoading } = useQuery(['CondemnInchargeApproved'], async () => {
        const result = await axioslogin.post('AssetCondemnation/getCondemnInchargeApprovalList', postDept);
...
export default InchargeApprovedCondemn