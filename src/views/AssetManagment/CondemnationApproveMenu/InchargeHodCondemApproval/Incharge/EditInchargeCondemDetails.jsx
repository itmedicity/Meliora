...
const EditInchargeCondemDetails = ({ modalApproveOpen, setmodalApproveOpen, setmodalApproveFlag, empId, formDetails, setformDetails, queryClient }) => {
    ...
    const { condem_mast_slno, condem_form_prefix, condem_form_no, reg_date, inch_level_state, inch_review, inch_review_date, inch_emp, req_dpt_name, } = formDetails
    ...
    const [remarks, setremarks] = useState(inch_review || '')
        ...
        (e) => {
            ...
            const FormUpdate = async (ApproveData) => {
                ...
                if (success === 2) {
                    ...
                    queryClient.invalidateQueries('CondemnInchargeApproved')
                    CloseModal()
                } else {
                    infoNotify(message)
                }
...
export default memo(EditInchargeCondemDetails)